      ...
      <div class="row">
          <div class="col-1-10 ">
            <div class="logo">
              ...
              <img src="<?php echo $_SERVER["DOCUMENT_ROOT"].'/gapensi/assets/media/logos/LOGO GAPENSI.png';?>" alt="generic business logo" height="130" width="110"/>
          ...
          <div class="col-1-52">
            <div class="berita_acara">
              CEKLIST KELENGKAPAN
                <br>
              DATA BADAN USAHA JASA PELAKSANA KONSTRUKSI
              <br>
              OLEH ASOSIASI BADAN USAHA
