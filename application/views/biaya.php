			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-muted">Biaya Sertifikasi</a>
						</li>
    ...
    <div class="container">
			...
			<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label">Data Biaya Sertifikasi</h3>
					</div>
					<div class="card-toolbar">
						<a data-toggle="modal" disabled data-target="#modal_delete" id="delete_data" class="btn btn-light-danger font-weight-bolder mr-2">
						<i class="la la-trash"></i>Delete Data</a>

						<a data-toggle="modal" data-target="#modal_edssit" id="edit" class="btn btn-light-dark font-weight-bolder mr-2">
						<i class="la la-edit"></i>Edit Data</a>

						<a data-toggle="modal" data-target="#msodal_input" class="btn btn-danger font-weight-bolder">
					...
					<table class="table table-separate table-head-custom collapsed" id="kt_datatable2">
						...
						<tbody>
							...
							<tr>
								...
								<td>Rp.<?= number_format(($row['biaya']*1000), 2, '.', ',');?></td>
