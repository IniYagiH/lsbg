							...
							<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
								...
								<div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
									...
									<ul class="menu-nav">
										...
										<?php endif; ?>
										<?php if ($this->session->userdata('id_user') == 'admin_pusat10' or $this->session->userdata('id_user') == 'admin_pusat8' or $this->session->userdata('id_user') == 'admin_pusat9' or $this->session->userdata('id_user') == 'SBU_LEON' or $this->session->userdata('id_user') == 'SBU_ROLLAND' or $this->session->userdata('id_user') == 'adminx' or $this->ion_auth->pelaksana()) : ?>
											<li class="menu-item menu-item-submenu menu-item-rel" data-menu-toggle="hover" aria-haspopup="true">
												<a href="javascript:;" class="menu-link menu-toggle">
													<span class="menu-text">Survailen</span>
														...
														<?php if ($this->session->userdata('id_user') == 'admin_pusat10' or $this->session->userdata('id_user') == 'SBU_LEON' or $this->session->userdata('id_user') == 'SBU_ROLLAND' or $this->session->userdata('id_user') == 'adminx') : ?>
															...
															<li class="menu-item" aria-haspopup="true">
																<a href="<?= base_url('survailen-insidental'); ?>" class="menu-link">
																	...
																	<span class="menu-text">Daftar Permohonan Insidental </span>
																</a>
															</li>
