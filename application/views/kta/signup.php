							...
							<div class="wizard-steps">
								...
								<div class="wizard-step" data-wizard-type="step">
									<div class="wizard-wrapper">
										...
										<div class="wizard-label">
											<h3 class="wizard-title">Upload File</h3>
											<div class="wizard-desc">Upload Photo PJBU</div>
										</div>
									</div>
								</div>
				...
				<div class="login-content flex-column-fluid d-flex flex-column p-10">
					...
					<div class="d-flex flex-row-fluid flex-center">
						...
						<div class="login-form login-form-signup">
							<!--begin::Form-->
							<?php echo form_open_multipart('kta/insert/', 'novalidate="novalidate"" id="kt_login_signup_form"');?>
								...
								<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
									...
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Nama Badan Usaha</label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="nama_bu" placeholder="Nama Badan Usaha" value="" />
									</div>
									<!--end::Form Group-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">NPWP</label>
										<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="npwp" placeholder="NPWP" value="" />
									</div>
									<!--end::Form Group-->
									<!--begin::Form Group-->
									<div class="form-group">
										<label class="font-size-h6 font-weight-bolder text-dark">Email</label>
										<input type="tel" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="email" placeholder="Email" />
									</div>
                  ...
                  <div class="form-group">
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="row">
										<div class="col-xl-12">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="alamat" placeholder="Alamat Badan Usaha" />
											</div>
											<!--end::Input-->
										</div>
									...
									<div class="row">
										<div class="col-xl-6">
											<!--begin::Input-->
											<div class="form-group">
												<label class="font-size-h6 font-weight-bolder text-dark">Propinsi</label>

                        <select name="propinsi" onchange="getval(this)" id="propinsi"class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" required="required">
                        ...
                        <select name="kabupaten"   id="kabupaten" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" required="required">
                            <option value="">Pilih Kabupaten</option>
									...
									<div class="row">
										<div class="col-xl-6">
											<!--begin::Input-->
											<div class="form-group">
												<label class="font-size-h6 font-weight-bolder text-dark">Penanggung Jawab</label>
												<input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="pjbu" placeholder="Nama PJBU"  />
										...
										<div class="col-xl-6">
											<!--begin::Select-->
											<div class="form-group">
												<label class="font-size-h6 font-weight-bolder text-dark">Kualifikasi</label>
                        <select name="kualifikasi"   id="kualifikasi" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" required="required">
                            ...
                            <option value="K">Kecil</option>
								...
								<div class="pb-5" data-wizard-type="step-content">
									<!--begin::Title-->
									<div class="pt-lg-0 pt-5 pb-15">
										<h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Upload File</h3>
										<div class="text-muted font-weight-bold font-size-h4">Upload Foto Penanggung Jawab</div>
									</div>
									<!--end::Title-->
									<!--begin::Form Group-->
									<div class="form-group">
                      ...
                      <span class="form-text text-muted">Allowed file types: png, jpg, jpeg.</span>
								...
								<div class="pb-5" data-wizard-type="step-content">
									...
									<div class="text-dark-50 font-weight-bold line-height-lg mb-8">
										<div>Formulir Pendaftaran anda akan dikirim untuk ditinjau</div>
										<div>Setelah data lengkap anda akan menerima Username Password yang dikirimkan ke Email anda untuk masuk kedalam sistem dan melengkapi prosedur yang telah ditetapkan</div>
									</div>
									<!--end::Section-->
								</div>
								<!--end: Wizard Step 4-->
...
function getval(sel)
{
	...
	$.ajax({
			url : "<?php echo base_url('kta/kabupaten'); ?>",
			type : "POST",
