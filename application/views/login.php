	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
						...
						<div class="login-signin">
							...
							<form class="form" id="kt_login_signin_form">
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Username / NIB" id="username" name="username" autocomplete="off" />
								</div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="password" placeholder="Password" id="password" autocomplete="off" name="password" />
								</div>
								<div class="form-group d-flex flex-wrap justify-content-between align-items-center">
									...
									<a href="<?=base_url('registrasi');?>" class="text-dark text-hover-danger">Registrasi Akun Mitra</a>
								</div>
								<button id="kt_login_signin_submit" class="btn btn-danger font-weight-bold px-9 py-4 my-3 mx-4">Sign In</button>
							</form>
						<!--	<div class="mt-10">
            ...
            <input type="hidden" id="base_url" value="<?=base_url('login');?>" />
              ...
              <?php echo form_open_multipart('login/signup/', 'class="form text-center" id="kt_login_signup_form"');?>
              <div class="form-group mb-5">
                <input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="NIB" id="nib" name="nib"/>
              </div>
                <div class="form-group mb-5">
								...
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" placeholder="Password" id="password_2" name="password" />
								</div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="password"  placeholder="Re-type Password" id="password2" />
								</div>
                <div class="form-group mb-5">
                  <input class="file-nib" id="file_nib" name="file_nib" type="file"  data-preview-file-type="text">
                  <span class="help-block">
                    File NIB: pdf Max file size 20Mb
                  </span>
