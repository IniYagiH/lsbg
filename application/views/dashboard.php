          ...
          <div class="card card-custom card-stretch">
            ...
            <div class="card-body px-5">
              ...
              <div class="px-4 mt-4 mb-10">
                <a href="#" class="btn btn-block btn-dark font-weight-bold text-uppercase py-4 px-6 text-center" data-toggle="modal" data-target="#kt_inbox_compose">New Message</a>
              </div>
              <!--end::Compose-->
              <!--begin::Navigations-->
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                        ...
                        <?php elseif($row['ID_UPLOAD']==49):?>
                          ...
                          <?php elseif($row['ID_UPLOAD']==99):?>
                            <a style="color: #363636" href="<?php echo base_url('inbox/dukcapil/').encrypt_url($row['ID_RECORD']) ;?>">
                          <?php elseif($row['ID_UPLOAD']==98):?>
                            <a style="color: #363636" href="<?php echo base_url('inbox/dukcapil_revisi/').encrypt_url($row['ID_RECORD']) ;?>">
                        <?php endif ;?>
                        ...
                        <span class="label label-dark label-inline mr-2">
                          ...
                          }elseif($row['ID_UPLOAD']==20 OR $row['ID_UPLOAD']==21){
                            echo "Neraca";
                          }elseif($row['ID_UPLOAD']==7){
                            echo "Akte Pendirian";
                          }elseif($row['ID_UPLOAD']==8){
                            echo "Akte Perubahan";
                          ...
                          elseif($row['ID_UPLOAD']==99 OR $row['ID_UPLOAD']==98){
                            echo "DUKCAPIL";
                          } ;?>
                          </span>
