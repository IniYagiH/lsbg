        ...
        <div align="center">
                  ...
                  <table cellspacing="0">
                    <tr>
                      <td>
                        <table class="soapbox">
                          <tr>
                            <td class="soapbox-title">Penilaian Survailen Insidental Badan Usaha</td>
                          </tr>
                        </table>
                        <table class="body">
                          <tr>
                              ...
                              <table class="body-text">
                                <tr>
                                  <td class="body-text-cell">
                                    Kami ingin memberitahukan bahwa kami sedang melakukan program survailen insidental terhadap badan usaha pemilik Sertifikat Badan Usaha (SBU). Surveilans ini bertujuan untuk memperoleh pemahaman yang lebih mendalam tentang status sertifikasi badan usaha dan memastikan kepatuhan terhadap standar yang berlaku
                                    ...
                                    <br>
                                    <br>
                                    Silakan mengakses dokumen perbaikan survailen insidental melalui tautan berikut :

                                    </td>
                                </tr>
                              </table>
                              <div><!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?= html_escape($document_url); ?>" style="height:38px;v-text-anchor:middle;width:230px;" arcsize="11%" strokecolor="#407429" fill="t">
                                  <v:fill type="tile" src="https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7" color="#41CC00" />
                                  <w:anchorlock/>
                                  <center style="color:#ffffff;font-family:sans-serif;font-size:17px;font-weight:bold;">Lihat Hasil Survailen</center>
                                </v:roundrect>
                              <![endif]--><a href="<?= html_escape($document_url); ?>"
                              style="background-color:#E52121;border:1px solid #E52121;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;line-height:38px;text-align:center;text-decoration:none;width:230px;-webkit-text-size-adjust:none;mso-hide:all;">Lihat Hasil Survailen</a></div>
                              <table class="body-signature-block">
                                <tr>
                                  <td class="body-signature-cell">
                                    <p>Tombol di atas berisikan hasil survailen insidental badan usaha anda. Jika Anda mengalami kendala atau memiliki pertanyaan terkait pengisian formulir, jangan ragu untuk menghubungi kami.
          ...
          <div class="footer" style="clear: both; Margin-top: 10px; text-align: center; width: 100%; ">
            <table bgcolor="#e5e5e5" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; ">
              ...
              <div align="center" style="line-height:10px"><img alt="Image" src="<?= html_escape(base_url('assets/media/logos/Logo_gapeknas.png')); ?>" style=" border: 0; width: 150px; max-width: 3000px;" title="Image" width="80"/></div>
              </td>
              </tr>
              <tr>
