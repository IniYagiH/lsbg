    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex flex-column">
          <!--begin::Title-->
          <h2 class="text-white font-weight-bold my-2 mr-5">Akte Perubahan</h2>
          <!--end::Title-->
          <!--begin::Breadcrumb-->
          <div class="d-flex align-items-center font-weight-bold my-2">
            ...
            <!--begin::Item-->
            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
            <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Akte Perubahan</a>
            <!--end::Item-->
          </div>
          <!--end::Breadcrumb-->
        </div>
  ...
  <div class="d-flex flex-column-fluid">
    ...
    <div class="container">
			<div class="card card-custom card-sticky">
				...
				<div class="card-body">
					<div class="card-title">
						...
						<h3 class="card-label">Update Akte Pendirian</h3>
      ...
      <div class="card card-custom gutter-b">
        ...
        <?php echo form_open_multipart('akte/update_perubahan/', 'class="form-horizontal form-validate-jquery" id="form-upload-1"');?>
          <div class="card-body">

          <div class="form-group row">
            <div class="col-lg-6">
                <label class="control-label">Nomor Akte <span class="text-danger">*</span></label>
								<input <?php if(!empty($akte_pendirian)) :?>value='<?php echo $akte_pendirian[0]['Nomer']; ?>'  <?php endif ;?> type="text"  id="nomor_akte" name="nomor_akte" required="required" class="form-control" >
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <label class="control-label">Tanggal Akte <span class="text-danger">*</span></label>
								<input type="text" <?php if(!empty($akte_pendirian)) :?>value='<?php echo $akte_pendirian[0]['Tanggal']; ?>'  <?php endif ;?> name="tgl_akte" class="form-control" id="anytime-month-numeric" >
            ...
            <div class="col-lg-6">
                <label class="control-label">Propinsi Notaris <span class="text-danger"></span></label>
								<select name="propinsi" onchange="getval(this)" id="propinsi"class="form-control" required="required">
									...
									<option <?php if($row2['ID_Propinsi']==$akte_pendirian[0]['propinsi']):?>selected="selected"<?php endif ;?> value="<?php echo $row2['ID_Propinsi'] ;?>"> - <?php echo $row2['Nama'] ;?></option>
									<?php endforeach ;?>
								</select>
							</div>
            <div class="col-lg-6">
                <label class="control-label">Kabupaten/Kota <span class="text-danger">*</span></label>
								<select name="kabupaten"  id="kabupaten" class="form-control" required="required">
										...
										<?php foreach ($kabupaten as $row_kab) :?>
											<option <?php if($row_kab['ID_Kabupaten']==$akte_pendirian[0]['Kabupaten']):?>selected="selected"<?php endif ;?> value="<?php echo $row_kab['ID_Kabupaten'] ;?>"> - <?php echo $row_kab['Nama'] ;?></option>
										<?php endforeach ;?>
								</select>
							</div>
          </div>
            ...
            <div class="col-lg-6">
                <label class="control-label">Id Jabatan <span class="text-danger">*</span></label>
					...
					<input type="hidden" <?php if(!empty($akte_pendirian)) :?>value='<?php echo $id; ?>'  <?php endif ;?> name="id" class="form-control">
					<input type="hidden" <?php if(!empty($akte_pendirian)) :?>value='<?php echo $id2; ?>'  <?php endif ;?> name="id2" class="form-control">
		            ...
		            <div class="col-lg-6">
		                <label class="control-label">Tanggal Mentri <span class="text-danger">*</span></label>
										<input type="text"  <?php if(!empty($akte_pendirian)) :?>value='<?php echo $akte_pendirian[0]['Tgl_Pengesahan_Menteri']; ?>'  <?php endif ;?> name="tgl_mentri" class="form-control" id="anytime-month-numeric2">
		            ...
		            <div class="col-lg-6">
		                <label class="control-label">Tanggal Pengadilan Negeri <span class="text-danger">*</span></label>
										<input type="text"  <?php if(!empty($akte_pendirian)) :?>value='<?php echo $akte_pendirian[0]['Tgl_Pengesahan_PN']; ?>'  <?php endif ;?> name="tgl_pn" class="form-control" id="anytime-month-numeric4">
		            ...
		            <div class="col-lg-6">
		                <label class="control-label">Tanggal Lembar Negara <span class="text-danger">*</span></label>
										<input type="text"  <?php if(!empty($akte_pendirian)) :?>value='<?php echo $akte_pendirian[0]['Tgl_Pengesahan_LN']; ?>'  <?php endif ;?> name="tgl_ln" class="form-control" id="anytime-month-numeric3" >
