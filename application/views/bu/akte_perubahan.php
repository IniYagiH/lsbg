			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-muted">Akte Perubahan</a>
						</li>
			...
			<div class="card card-custom">
				<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label">Data Akte Perubahan</h3>
					</div>
					...
					<table class="table table-separate table-head-custom collapsed" id="kt_datatable2">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="<?=base_url('get_file/get_bu_8/'.$row['persyaratan']) ;?>" target="_blank" class="btn btn-outline-success btn-sm mr-3"><i class="flaticon-doc"></i>Lihat File</a></td>
								<td><a href="<?=base_url('get_file/get_bu_56/'.$row['persyaratan_56']) ;?>" target="_blank" class="btn btn-outline-success btn-sm mr-3"><i class="flaticon-doc"></i>Lihat File</a></td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="card card-custom gutter-b">
					...
					</div><?php echo form_open_multipart('akte/delete_perubahan/', 'class="form-horizontal form-validate-jquery"');?>
					<div class="card-body">
						...
						<div class="form-group row">
							<div class="col-lg-8">
									...
									<input type="text"   id='nomor_delete'  name="sub" readonly class="form-control">
							</div>
				...
				<div class="card card-custom gutter-b">
					<div class="card-header">
						<div class="card-title">
							...
							<h3 class="card-label">Input Akte Perubahan</h3>
						</div>
					</div>

	        <?php echo form_open_multipart('akte/insert_perubahan/', 'class="form-horizontal form-validate-jquery" id="form-upload-1"');?>
	          <div class="card-body">
	          ...
	          <div class="form-group row">
	            ...
	            <div class="col-lg-6">
	                <label class="control-label">Tanggal Akte <span class="text-danger">*</span></label>
									<input type="text" name="tgl_akte" class="form-control" id="tgl_1" value="2018-01-01">
	                ...
	                <label class="control-label">Id Jabatan <span class="text-danger">*</span></label>
			            ...
			            <div class="col-lg-6">
			                <label class="control-label">Tanggal Mentri <span class="text-danger">*</span></label>
											<input type="text" name="tgl_mentri" class="form-control" id="tgl_2" value="2018-01-01">
			            ...
			            <div class="col-lg-6">
			                <label class="control-label">Tanggal Pengadilan Negeri <span class="text-danger">*</span></label>
											<input type="text" name="tgl_pn" class="form-control" id="tgl_3" value="2018-01-01">
			            ...
			            <div class="col-lg-6">
			                <label class="control-label">Tanggal Lembar Negara <span class="text-danger">*</span></label>
											<input type="text" name="tgl_ln" class="form-control" id="tgl_4" value="2018-01-01">
						...
						<div class="form-group row">
	            <div class="col-lg-6">
	                <label class="control-label">Perubahan Tentang <span class="text-danger"></span></label>
									<input type="text" id="perubahan" name="perubahan" class="form-control">

								</div>
	            <div class="col-lg-6">
									<label class="control-label">Modal Dasar <span class="text-danger"></span></label>
 								 <input type="text" id="modal" name="modal_dasar" class="form-control">
						...
						<div class="form-group row">
							<div class="col-lg-6">
								<label class="control-label">Upload Persyaratan Akte Perubahan <span class="text-danger">*</span></label>
...
<div class="modal fade" id="modal_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeXl" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		<div class="modal-content">
	        ...
	        <?php echo form_open_multipart('akte/update_perubahan/', 'class="form-horizontal form-validate-jquery" id="form-upload-2"');?>
	          <div class="card-body">
	            ...
	            <div class="col-lg-6">
	                <label class="control-label">Id Jabatan <span class="text-danger">*</span></label>
						...
						<div class="form-group row">
							<div class="col-lg-6">
									<label class="control-label">Perubahan Tentang <span class="text-danger"></span></label>
									<input type="text" id="perubahan_edit" name="perubahan" class="form-control">

								</div>
							<div class="col-lg-6">
									<label class="control-label">Modal Dasar <span class="text-danger"></span></label>
								 <input type="text" id="modal_edit" name="modal_dasar" class="form-control">
...
$("#delete_data").click(function () {
	...
	if(counterx==0){
		...
		$(".modal-body #nomor_delete").val(coba2);
	}
    ...
    counter=0;
		...
		if(counter==2){
			...
			$.ajax({
					url : "<?php echo base_url('akte/cek_perubahan'); ?>",
					type : "POST",
					data : {id : sub,},
					success : function(data) {
						...
						$("#perubahan_edit").val(record[0].perubahan);
						$("#modal_edit").val(record[0].modal_dasar);
			...
			if(n1!='' || n2!='' || n3!='' || n4!=''){
										...
										if (submitCounter < 2) {
												...
												$.ajax({
													...
													success: function (data) {
														if (data.result == '1') {
															window.location.replace("<?php echo base_url('akte/perubahan');?>");
														}
														else {
															window.location.replace("<?php echo base_url('akte/perubahan');?>");
