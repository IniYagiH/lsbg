                ...
                <div class="card card-custom card-stretch">
                  ...
                  <div class="card-header align-items-center flex-wrap justify-content-between py-5 h-auto">
                    ...
                    <div class="d-flex align-items-center my-2">
                      <a href="<?= base_url('dashboard_bu') ;?>" class="btn btn-clean btn-icon btn-sm mr-6" data-inbox="back">
                  ...
                  <div class="card-body p-0">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap card-spacer-x py-5">
                      ...
                      <div class="d-flex align-items-center mr-2 py-2">
                        <div class="font-weight-bold font-size-h3 mr-3">Pemberitahuan</div>
                        ...
                        <div class="d-flex card-spacer-x py-6 flex-column flex-md-row flex-lg-column flex-xxl-row justify-content-between">
                          <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column flex-grow-1 flex-wrap mr-2">
                              <div class="d-flex">
                                <a href="#" class="font-size-lg font-weight-bolder text-dark-75 text-hover-dark mr-2">LSBU SKI</a>
                                <div class="font-weight-bold text-muted">
                                <span class="label label-success label-dot mr-2"></span>
                                <?php
                                $x = new DateTime($message[0]['Log']);
                                $y = new DateTime();
                              ...
                              <div class="d-flex flex-column">
                                <div class="toggle-off-item">
                                  <span class="font-weight-bold text-muted cursor-pointer" data-toggle="dropdown">to <?=$biodata[0]['nama'];?>
            ...
            <form id="kt_inbox_compose_form">
              ...
              <div class="d-block">
                ...
                <div class="d-flex align-items-center border-bottom inbox-to px-8 min-h-45px">
                  ...
                  <div class="ml-2">
                    <span class="text-muted font-weight-bold cursor-pointer text-hover-dark mr-2" data-inbox="cc-show">Cc</span>
                    <span class="text-muted font-weight-bold cursor-pointer text-hover-dark" data-inbox="bcc-show">Bcc</span>
                  </div>
                </div>
                <!--end::To-->
                <!--begin::CC-->
                  ...
                  <div class="dropzone-items">
                    <div class="dropzone-item" style="display:none">
                      ...
                      <div class="dropzone-progress">
                        <div class="progress">
                          <div class="progress-bar bg-dark" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0" data-dz-uploadprogress=""></div>
                        </div>
                      </div>
              ...
              <div class="d-flex align-items-center justify-content-between py-5 pl-8 pr-5 border-top">
                ...
                <div class="d-flex align-items-center mr-3">
                  ...
                  <div class="btn-group mr-4">
                    <span class="btn btn-dark font-weight-bold px-6">Send</span>
                    <span class="btn btn-dark font-weight-bold dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" role="button"></span>
