			...
			<div class="card card-custom">
				<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label">Data SMAP</h3>
					</div>
					...
					<table class="table table-separate table-head-custom collapsed" id="kt_datatable2">
						<thead>
							<tr>
								...
								<th>File Rekaman ISO 37001 </th>
								<th>File Komitmen SMAP </th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								...
								<td><a href="<?=base_url('get_file/get_bu_62/'.$row['persyaratan_62']) ;?>" target="_blank" class="btn btn-outline-success btn-sm mr-3"><i class="flaticon-doc"></i>Lihat File</a></td>
								<td><a href="<?=base_url('get_file/get_bu_63/'.$row['persyaratan_63']) ;?>" target="_blank" class="btn btn-outline-success btn-sm mr-3"><i class="flaticon-doc"></i>Lihat File</a></td>
			...
			<div class="modal-content">
		        ...
		        <?php echo form_open_multipart('administrasi/insert_smm/', 'class="form-horizontal form-validate-jquery" id="form-upload-1"');?>
							...
							<div class="form-group row">
								...
								<div class="col-lg-6">
									<label class="control-label">Upload File Komitmen SMAP <span class="text-danger">*</span></label>
									<input class="file-komitmen" name="file_komitmen" type="file" data-preview-file-type="text">
									<span class="help-block">
										Accepted formats: pdf, zip. Max file size 20Mb
									</span>
									<div class="progress" style="display:none;">
			...
			var fileToUpload = inputFile[0].files[0];
										...
										if (submitCounter < 2) {
												...
												$.ajax({
													...
													success: function (data) {
														if (data.result == '1') {
															window.location.replace("<?php echo base_url('administrasi/smap');?>");
														}
														else {
															window.location.replace("<?php echo base_url('administrasi/smap');?>");
