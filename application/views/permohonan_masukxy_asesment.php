                ...
                <td>
                  <div class="d-flex align-items-center mr-3" data-inbox="actions">
                    <label class="checkbox checkbox-outline checkbox-outline-2x checkbox-danger mr-3">
                      <input type="checkbox" name="<?= $row['id_izin'] ;?>" value="<?= $row['NIB'] ;?>" class="call-checkbox"/>
                      <span></span>
                    </label>
          ...
          success : function(data) {
            ...
            if(response.status=='1' || response.status=='2'){
              Swal.fire({
                    ...
                    text: "Proses akan mengambil data detail permohonan badan usaha perubahan!",
                    icon: "warning",
                    ...
                    if (result.value) {
                      ...
                      $.ajax({
                          url : "<?php echo base_url('sertifikasi/get_permohonan_detail2_asesment'); ?>",
                          type : "POST",
                          data : {id_izin : sel.name,
      ...
      rowcollection.each(function(index,elem){
        ...
        Swal.fire({
              ...
              if (result.value) {
                ...
                $.ajax({
                    url : "<?php echo base_url('sertifikasi/get_permohonan_coba_asesment'); ?>",
                    type : "POST",
                    data : {id_izin : coba,
                            pilihan : result.value},
                    success : function(data) {
