			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-dark">Dashboard Survailen</a>
						</li>
                  ...
                  <div class="d-flex align-items-start list-item card-spacer-x py-3" data-inbox="message">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                            ...
                            <a style="color: #363636" href="<?php echo base_url('survailen/abu/'.encrypt_url($row['NIB']).'/'.encrypt_url($row['id_sub_klasifikasi']).'/'.encrypt_url($this->session->userdata('id_user'))) ;?>">

                        <div class="symbol symbol-light-danger symbol-40 mr-3">
                          <span class="symbol-label font-weight-bolder">O</span>
                        </div>
                    ...
                    <div class="flex-grow-1 mt-2 mr-2" data-toggle="view">
                      ...
                      <div>
                        ...
                        <span class="text-muted"><?= $row['id_sub_klasifikasi'] ?></span>
                      </div>
                    ...
                    <?php
                    $x = new DateTime($row['tgl_penunjukan']);
                    $y = new DateTime();
