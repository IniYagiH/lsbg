          ...
          <div class="mb-12">
            <div class="row align-items-center">
              <div class="col-lg-12 col-xl-10">
                <div class="row align-items-center">
                  ...
                  <div class="col-md-3 my-2 my-md-0">
                    ...
                    <div class="input-icon">
                      <select name="asosiasi" id="asosiasi" class="form-control" required="required">
                        <option value="0"> SEMUA ASOSIASI</option>
                        <option value="1"> GAPEKNAS</option>
                        <option value="2"> NON-GAPEKNAS</option>
                  ...
                  <div class="col-md-3 my-2 my-md-0">
                    ...
                    <label><span class="text-danger">Limit Data</span></label>
                    <div class="input-icon">
              ...
              <div class="col-lg-2 col-xl-2 mt-5 mt-lg-0">
                ...
                <button type="button" onclick="javascript:search(this)" class="btn btn-primary mr-3" id="kt_btn_1">
                  Searching
                </button>
            ...
            <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
              ...
              <tr>
                ...
                <td><?php if($row['pilihan']=='1') :?>
                  <a type="button" id="<?=$row['NIB'];?>" name="<?=$row['tgl_permohonan'];?>" onclick="javascript:get_permohonan_detail(this)" class="pulse pulse-danger"><span class="label label-danger label-inline mr-2">Propinsi<span class="pulse-ring"></span> </span></a>
                <?php else :?>
                  <a type="button" id="<?=$row['NIB'];?>" name="<?=$row['tgl_permohonan'];?>" onclick="javascript:get_permohonan_detail(this)"class="pulse pulse-info"><span class="label label-info label-inline mr-2">Pusat<span class="pulse-ring"></span> </span></a>
                <?php endif ;?>
        ...
        <div class="card card-custom gutter-b">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-6">
                <label class="control-label">Tgl Pelaksanaan Survailen <span class="text-danger"></span></label>
                <input type="text" id="tgl_3" name="tgl_pelaksanaan" readonly class="form-control">
              </div>
...
$("#submit").click(function() {
    ...
    var tgl_pelaksanaan_value = document.querySelector('#tgl_3').value;
    var counter1 = 0;
    var counter2 = 0;
    var counter3 = 0;
    $.ajax({
      url: "<?php echo base_url('survailen/insert_penunjukan_tinjauan'); ?>",
      type: "POST",
      data: {
        ...
        nib: nib_value,
        tgl_pelaksanaan: tgl_pelaksanaan_value
      },
...
<script>
  function search(sel) {
    ...
    var tabel_2 = $('#kt_datatable2').DataTable();
    tabel_2.clear().draw();
    var tgl_1_value = document.getElementById('tgl_1').value;
    var tgl_2_value = document.getElementById('tgl_2').value;
    var propinsi_value = $("#propinsi").val();
    var kualifikasi_value = $("#kualifikasi").val();
    var asosiasi_value = $("#asosiasi").val();
    var limit_value = $("#limit").val();
    jQuery.ajax({
      url: "<?= base_url('survailen/get_search')?>",
      type: "POST",
      data: {
        tgl_1: tgl_1_value,
        tgl_2: tgl_2_value,
        propinsi: propinsi_value,
        kualifikasi: kualifikasi_value,
      ...
      success: function (data) {
        ...
        toastr["success"]("Data Ditemukan", "Notification");
        rex2 = response.record;
        $.each(rex2, function (i, optionc) {
          if(optionc.asesor1==null){
            var asesor="";
            var status_survailen='<a type="button"  class="pulse pulse-danger"><span class="label label-danger label-inline mr-2">Belum_Survailen<span class="pulse-ring"></span> </span></a>';

          }else{
            var asesor=optionc.asesor1+', '+optionc.asesor2+', '+optionc.asesor3;
            var status_survailen='<a type="button"  class="pulse pulse-info"><span class="label label-info label-inline mr-2">Penilaian_Asesor<span class="pulse-ring"></span> </span></a>';

          }
          var checkbox =
            '<div class="d-flex align-items-center mr-3" data-inbox="actions"><label class="checkbox checkbox-outline checkbox-outline-2x checkbox-danger mr-3"><input type="checkbox" name="' +
            optionc.NIB + '"class="call-checkbox" /><span></span></label></div>';
          if (optionc.pilihan == '1') {
            var pilihan =
              '<a type="button"  class="pulse pulse-danger"><span class="label label-danger label-inline mr-2">Propinsi<span class="pulse-ring"></span> </span></a>';
          } else {
            var pilihan =
              '<a type="button"  class="pulse pulse-info"><span class="label label-info label-inline mr-2">Pusat<span class="pulse-ring"></span> </span></a>';
          }
          var action =
            '<div class="dropdown dropdown-inline"><a href="javascript:;" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown"><i class="la la-cog"></i></a><div class="dropdown-menu dropdown-menu-sm dropdown-menu-right"><ul class="nav nav-hoverable flex-column"><li class="nav-item"><a class="nav-link" target="_blank" href="' +
            optionc.nib_dec +
            ...
            pilihan,
            optionc.concat_sub,
            optionc.concat_kualifikasi,
            asesor,
            status_survailen,
            optionc.nama_propinsi,
            optionc.nama_asosiasi,
            action,
