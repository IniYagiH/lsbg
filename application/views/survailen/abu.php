			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-dark">Penilaian Kesesuaian Survailen BUJK</a>
						</li>
			...
			<div class="card card-custom gutter-b">
				<div class="card-header">
					<div class="card-title">
						<h3 class="card-label">Penilaian Kesesuaian Survailen BUJK</h3>
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('survailen/cetak_penilaian/'.$id1.'/'.$id2) ;?>" target="_blank" class="btn btn-dark font-weight-bolder">
				...
				<div class="card-body">
					<div class="d-flex align-items-center flex-wrap mt-8">
						...
						<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
							<span class="mr-4">
								<i class="flaticon-bell display-3 text-muted font-weight-bold"></i>
							</span>
						...
						<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
							<span class="mr-4">
								<i class="flaticon-confetti display-3 text-muted font-weight-bold"></i>
							</span>
							<div class="d-flex flex-column text-dark-75">
						...
						<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
							<span class="mr-4">
								<i class="flaticon-pie-chart display-3 text-muted font-weight-bold"></i>
							</span>
							<div class="d-flex flex-column text-dark-75">
						...
						<div class="d-flex align-items-center flex-lg-fill mr-5 mb-2">
							...
							<div class="d-flex flex-column text-dark-75">
								<span class="font-weight-bolder font-size-sm">Kualifikasi</span>
								<span class="font-weight-bolder font-size-h5">
									<span
										class="text-dark-50 font-weight-bold"></span><?=$klasifikasi[0]['kualifikasi'] ?></span>
							</div>
						</div>
						<!--end::Item-->
						...
						<div class="example-preview">
							<ul class="nav nav-pills" id="myTab1" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="contact-tab-1" data-toggle="tab" href="#submit_final"
										...
										<span class="nav-text">Penilaian Asesor</span>
									</a>
								</li>
							...
							<div class="tab-content mt-5" id="myTabContent1">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="content-group-lg">
															...
															<p class="content-group">Upload Foto SKK/SKA/SKT PJTBU	</p>
														</div>
													</div>
								...
								<div class="tab-pane fade show" id="submit_final" role="tabpanel"
									...
									<div class="col-md-12">
										<div class="table-responsive">
										<?php echo form_open_multipart(base_url('survailen/insert_asesor'), 'method="POST"');?>
											<table class="table table-lg">
												<thead>
													<tr>
												...
												<tr>
														...
														<div class="input-group file-caption-main">
																...
																<input type="text" name="tgl_pelaksanaan"
																	class="form-control form-control-solid"
																	value="<?=$penilaian[0]['tgl_pelaksanaan']?>">
													...
													<tr>
														...
														<div class="input-group file-caption-main">
																...
																<input type="text" name="tempat_pelaksanaan"
																	class="form-control form-control-solid"
																	value="<?=$penilaian[0]['tempat_pelaksanaan']?>">
													...
													<tr>
														<td>#Ketidaksesuaian <br>(Dirulis secara jekas, terukur dan tidak mengambang)</td>
														<td>
														<div class="input-group file-caption-main">
																<span class="file-caption-icon"></span>
																<textarea name="ketidaksesuaian"
																	class="form-control form-control-solid"
													...
													<tr>
														<td>#Referensi atau Klausul SNI ISO/IEC</td>
														<td>
														<div class="input-group file-caption-main">
																<span class="file-caption-icon"></span>
																<textarea name="referensi"
																	class="form-control form-control-solid"
																	rows="5"><?=$penilaian[0]['referensi']?> </textarea>
													...
													<tr>
														...
														<div class="input-group file-caption-main">
																...
																<textarea name="rencana_perbaikan"
																	class="form-control form-control-solid"
																	rows="5"><?=$penilaian[0]['rencana_perbaikan']?> </textarea>
													...
													<tr>
														...
														<div class="input-group file-caption-main">
																<span class="file-caption-icon"></span>
																<textarea name="tgl_selesai"
																	class="form-control form-control-solid"
																	rows="5"><?=$penilaian[0]['tgl_selesai']?> </textarea>
													...
													<tr>
														...
														<div class="input-group file-caption-main">
																<span class="file-caption-icon"></span>
																<textarea name="jenis_temuan"
																	class="form-control form-control-solid"
																	rows="5"><?=$penilaian[0]['jenis_temuan']?> </textarea>
