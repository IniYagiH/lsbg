      ...
      <div class="d-flex align-items-center mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
            ...
            <li class="breadcrumb-item text-muted">
              <a href="" class="text-dark">List Penunjukan Asesor Survailen</a>
            </li>
        ...
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Permohonan Penujukan Asesor
              <span class="d-block text-muted pt-2 font-size-sm">Daftar Keseluruhan Permohonan Untuk Dilakukan Penujukan Asesor Survailen</span>
            </h3>
          </div>
              ...
              <?php if (!empty($record)) : ?>
                <?php foreach ($record as $row) : ?>
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center mr-3" data-inbox="actions">
                        <label class="checkbox checkbox-outline checkbox-outline-2x checkbox-danger mr-3">
                          <input type="checkbox" name="<?= $row['NIB']; ?>" value="<?= $row['id_izin']; ?>" class="call-checkbox" />
                          <span></span>
                        </label>
                    ...
                    <td><?=$row['asesor1'].','.$row['asesor3'].','.$row['asesor3'];?></td>
                    <td>                  <a type="button" class="pulse pulse-info"><span class="label label-info label-inline mr-2"><?=$row['perbedaan'];?> Hari<span class="pulse-ring"></span> </span></a>
</td>
                    ...
                    <td>
                      ...
                      -->
                            <li class="nav-item"><a class="nav-link" target="_blank" href="<?= base_url("survailen/tinjauan_permohonan/" . encrypt_url($row['NIB']) . '/' . encrypt_url($row['concat_sub'])); ?>"><i class="nav-icon la la-leaf"></i><span class="nav-text">Tinjau Berkas</span></a></li>
                          </ul>
                        </div>
                      </div>
                      <!--
      ...
      <div class="modal-body">
        <div class="card card-custom gutter-b">
          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-6">
                ...
                <span class="text-danger">"Asesor 1 harus Asesor LSBU, Asesor 2 & 3 Bisa ditunjuk Asesor LSBU Atau Verifikator LSBU"</span>
              </div>
                    ...
                    <td>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group file-caption-main">
                          ...
                          <div class="input-group-btn input-group-append">
                            <button type="submit" id="get_valuesx" class="btn btn-danger btn-file"><i class="glyphicon glyphicon-folder-open"></i>&nbsp; <span class="hidden-xs">Searching </span></button>
                            <button type="submit" id="get_values3" style='display:none;' class="btn btn-warning btn-file"><i class="glyphicon glyphicon-folder-open"></i>&nbsp; <span class="hidden-xs">Back </span></button>
          ...
          <div class="modal-footer">
            ...
            <a href="<?php echo base_url('survailen/surat_tugas/'); ?>" target="_blank" type="button" name="submit" class="btn btn-info btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Surat Tugas</span></a>
...
<script type="text/javascript">
  ...
  $("#submit").click(function() {
    ...
    var counter3 = 0;
    $.ajax({
      url: "<?php echo base_url('survailen/insert_penunjukan'); ?>",
      type: "POST",
      data: {
...
<script type="text/javascript">
  function getval(sel) {
    ...
    document.querySelector('#get_values3').removeAttribute('disabled');
    document.querySelector('#submit').style.display = '';
    document.querySelector('#submit2').style.display = 'none';
    document.querySelector('#submit33').style.display = 'none';
    document.querySelector('#send').style.display = 'none';
    document.querySelector('#asesor1').type = 'text';
    document.querySelector('#style1').style.display = 'none';
    document.querySelector('#style11').style.display = '';
    ...
    document.querySelector('#asesor22').removeAttribute('disabled');
    document.querySelector('#get_values2').removeAttribute('disabled');
    document.querySelector('#asesor33').removeAttribute('disabled');
    document.querySelector('#get_values3').removeAttribute('disabled');
  ...
  $("#penunjukan").click(function() {
    ...
    $(".modal-body #id_izin").val(value);
    $.ajax({
      url: "<?php echo base_url('survailen/get_kualifikasi'); ?>",
      type: "POST",
      data: {
        nib: sub,
        id_izin: value,
...
<script type="text/javascript">
  ...
  function submit() {
    ...
    jQuery.ajax({
      ...
      type: "POST",
      data: {
        tgl_permohonan: tgl_permohonan_value2
      },
      success: function(data) {
        response = jQuery.parseJSON(data);
