        ...
        <div class="card-body">
          <div class="mb-12">
            <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
              ...
              <tr>
                <td><div class="d-flex align-items-center mr-3" data-inbox="actions"><label class="checkbox checkbox-outline checkbox-outline-2x checkbox-danger mr-3"><input type="checkbox" name=" <?=$row['NIB'];?>"class="call-checkbox" /><span></span></label></div></td>
                <td>
                ...
                <td><?php if($row['pilihan']=='1') :?>
                  <a type="button" id="<?=$row['NIB'];?>" name="<?=$row['tgl_permohonan'];?>" onclick="javascript:get_permohonan_detail(this)" class="pulse pulse-info"><span class="label label-info label-inline mr-2">Sesuai<span class="pulse-ring"></span> </span></a>
                  <?php elseif($row['pilihan']=='2') :?>
                    <a type="button" id="<?=$row['NIB'];?>" name="<?=$row['tgl_permohonan'];?>" onclick="javascript:get_permohonan_detail(this)" class="pulse pulse-info"><span class="label label-info label-inline mr-2">Sudah_Perbaikan<span class="pulse-ring"></span> </span></a>

                  <?php else :?>
                  <a type="button" id="<?=$row['NIB'];?>" name="<?=$row['tgl_permohonan'];?>" onclick="javascript:get_permohonan_detail(this)"class="pulse pulse-danger"><span class="label label-danger label-inline mr-2">Perlu_Perbaikan<span class="pulse-ring"></span> </span></a>
                <?php endif ;?>
                ...
                <td><a
                    ...
                    File</a></td>
                <td><a
                    href="<?=base_url('survailen/cetak_penilaian_tinjauan/'.encrypt_url($row['NIB']));?>"
                    target="_blank" class="btn btn-outline-success btn-sm mr-3"><i class="flaticon-doc"></i>Lihat
                    File</a></td>
                    <td><a
                    href="<?=base_url('survailen/cetak_tindak_lanjut/'.encrypt_url($row['NIB']));?>"
                    target="_blank" class="btn btn-outline-success btn-sm mr-3"><i class="flaticon-doc"></i>Lihat
                    File</a></td>

                    <td><?=base_url('survailen/dokumen_survailen/'.encrypt_url($row['NIB']).'/'.encrypt_url((date('Y-m-d'))));?></td>
                    <td><?=base_url('survailen/dokumen_surat_tugas/'.encrypt_url($row['NIB']).'/'.encrypt_url((date('Y-m-d'))));?></td>
