			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-muted">List Terbit</a>
						</li>
      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Permohonan Survailen
            <span class="d-block text-muted pt-2 font-size-sm">Daftar Keseluruhan Permohonan Terbit</span></h3>
          </div>
          ...
          <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
            <thead>
              ...
              <tr>
                ...
                <th>Status</th>
                <th>Proses Permohonan Survailen</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php if($row['tgl_penilaian']!='0000-00-00' AND $row['tgl_penilaian']!=''):?>
                  <a href="<?=base_url('survailen/cetak_keputusan/'.$row['id_izin']);?>" target="_blank" class="btn btn-outline-danger btn-sm mr-3"><i class="flaticon-doc"></i>Butuh Perbaikan, Lihat Penilaian</a>
              <?php elseif($row['tgl_penunjukan']!='0000-00-00' AND $row['tgl_penunjukan']!=''):?>
                  
                  <a type="button" class="pulse pulse-danger"><span class="label label-danger label-inline mr-2">Penilaian_Permohonan<span class="pulse-ring"></span> </span></a>

                <?php elseif($row['id_izin_permohonan']!=''):?>
                  <a type="button" class="pulse pulse-info"><span class="label label-indo label-inline mr-2">Tinjauan_Permohonan<span class="pulse-ring"></span> </span></a>

                <?php else:?>
                  <a type="button" class="pulse pulse-warning"><span class="label label-warning label-inline mr-2">Belum_Mengajukan_Permohonan<span class="pulse-ring"></span> </span></a>

                  <?php endif ;?></td>
                
                    
                    <td>
                    <?php if($row['tgl_penilaian']!='0000-00-00' AND $row['tgl_penilaian']!=''):?>
                      <a href="<?=base_url('survailen/proses/'.encrypt_url($row['NIB']).'/'.encrypt_url($row['concat_sub']));?>" target="_blank" class="btn btn-outline-info btn-sm mr-3"><i class="flaticon-email-black-circular-button"></i>PerbaikiPermohonan</a>

                    <?php else:?>
                      <a href="<?=base_url('survailen/proses/'.encrypt_url($row['NIB']).'/'.encrypt_url($row['concat_sub']));?>" target="_blank" class="btn btn-outline-success btn-sm mr-3"><i class="flaticon-doc"></i>Proses</a>
                    <?php endif ;?></td>
                    </td>
