...
<!-- <section class="items">
    ...
    <section class="items">
        ...
        <div class="row">
            ...
            <div class="col-1-20">
              Nama Koordinator Manajemen Mutu
            </div>
            <div class="col-1-40">
        ...
        <div class="row">
            ...
            <div class="col-1-40">
              : <?=$penilaian[0]['tempat_pelaksanaan'];?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-1-20">
            Nama Tim Survailen yg bertugas           
            </div>
            <div class="col-1-40">
              : <br>a. <?=$asesor[0]['Nama'];?><br>
              b. <?=$asesor[1]['Nama'];?><br>
              c. <?=$asesor[2]['Nama'];?><br>
            </div>
    ...
    <section class="items">
      <div class="row">
        ...
        <div class="col-1-20-table">
            <div class="center">
              Ketidaksesuaian(Ditulis secara jelas, terukur dan tidak mengambang)
            </div>
      ...
      <div class="row">
        ...
        <?=$penilaian[0]['rencana_perbaikan'];?>
        </div>
        <div class="col-1-5-table">
        <?=$penilaian[0]['tgl_selesai'];?>
          
        </div>
        <div class="col-1-5-table">
        <?=$penilaian[0]['jenis_temuan'];?>
          
        </div>
        <div class="col-1-5-table">
        <?if($penilaian[0]['hasil_akhir']=='0'){
          echo "Tidak Sesuai";
        }else{
          echo "Sesuai";
        };?>
    ...
    <div class="center-pds">
      <br>
      <?php echo 'Jakarta' . ', ' . $day . ' ' . $bulan . ' ' . $tahun; ?>
    <br>
    <br>
    </div>
    <section class="items">
      ...
      <div class="row">
          ...
          <?php
                  // $path = base_url('assets/sertifikat/qrcodex/'.$qr_sps); sementara karena masalah server GCP
                  $path = base_url('assets/media/riyan.png');
                  $type = pathinfo($path, PATHINFO_EXTENSION);
                  $ch = curl_init();
