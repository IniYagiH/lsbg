								...
								<div class="tab-pane fade" id="submit_final" role="tabpanel"
									...
									<div class="col-md-12">
										<div class="table-responsive">
											<?php echo form_open_multipart(base_url('survailen/insert_penilaian_perbaikan'), 'method="POST"');?>
														...
														<td>
															<div class="input-group file-caption-main">
																...
																<textarea name="ketidaksesuaian" id="ketidaksesuaian"
																	class="form-control form-control-solid"
																	rows="5"> <?=$penilaian_perbaikan[0]['ketidaksesuaian']?></textarea>
														...
														<td>
															<div class="input-group file-caption-main">
																<select name="hasil_akhir"
																	class="form-control h-auto form-control-solid py-4 px-8"
																	required="required">
																	<option value="1">Sesuai & Setujui Perubahan Non-asesment</option>
																	<option value="0">Perlu Perbaikan & Tolak Perubahan Non-asesment</option>
