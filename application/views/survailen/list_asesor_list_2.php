          ...
          <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?=$row['id_izin'];?></td>
               <td><?=$row['jenis_temuan'];?></td>
               <td><?=$row['rencana_perbaikan'];?></td>
               <td><?=$row['tempat_pelaksanaan'];?></td>
         
                <td><?=base_url('survailen/dokumen_survailen/'.encrypt_url($row['NIB']).'/'.encrypt_url($row['tgl_permohonan']))?></td>
                <td><?=base_url('survailen/dokumen_surat_tugas/'.encrypt_url($row['NIB']).'/'.encrypt_url($row['tgl_permohonan']))?></td>
