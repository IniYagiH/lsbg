...
<hr>
  <section class="items">
    <div class="center">
      FORMULIR REKOMENDASI HASIL PENILAIAN PENJUALAN TAHUNAN (FTP03)
...
<section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-10-table" style="background-color: #fdeac6;"><div class="center">Hasil Penilaian Penjualan tahunan (Rp)</div></div>
    <div class="col-1-10-table" style="background-color: #fdeac6;"><div class="center">Persyaratan Penjualan Tahunan (Rp)</div></div>
  ...
  <div class="row">
    ...
    <div class="col-1-10-table"><div class="center"><?=$penilaian_ftp03[0]['hasil'];?></div></div>
    <div class="col-1-10-table"><div class="center"><?=$penilaian_ftp03[0]['persyaratan'];?></div></div>
    <div class="col-1-10-table"><div class="center"><?php if($penilaian_ftp03[0]['rekomendasi']=='1'){echo "SESUAI";}else{echo "TIDAK SESUAI";} ;?></div></div>
  </div>
</section>

<!-- Lembaga Sertifikasi dan Catatan -->
  <section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-60-table" style="border: 1px solid black;">
      <div class="left">
        <strong><?=$catatan_ftp03[0]['catatan'];?></strong>
      </div>
    </div>
