...
<section class="items">
    ...
    <section class="items">
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
          Lamp. PP No. 05 Thn. 2021 dan Lamp 1A Permen PUPR
No. 6 Thn 2021
  <?= $data_comment80 ;?>
      ...
      <?php foreach($klasifikasi as $row_klasifikasi):?>
        ...
        <div class="row">
            ...
            <div class="col-1-40-table">
              Sifat : <?= $row_klasifikasi['nama_sifat'] ;?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-1-40-table">
              Jenis Usaha : <?= $row_klasifikasi['jenis_usaha'] ;?>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
        Permen 6 tahun 2021 dan Permen No. 8 Tahun 2022 <?=$data_comment85;?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
        Permen 6 tahun 2021 dan Permen No. 8 Tahun 2022  <?=$data_comment88;?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
            ...
            Jenjang SKK : <?= $row_pjtbu['jenjang_skk'] ;?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
            ...
            Sub Klasifikasi : <?= $row_pjtbu['sub_klasifikasi'] ;?>
  ...
  <?php endforeach ?>
    <div class="row">
        ...
        <div class="col-1-40-table">
        Permen 6 tahun 2021 dan Permen No. 8 Tahun 2022  <?=$data_comment77;?>
  ...
  <?php endforeach; ?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
        PP 5 Thn 2021 Pasal 85, 86 & 90 dan Lamp Permen
PUPR No. 6 Thn 2021
 <?= $data_comment82 ;?>
    ...
    <?php foreach ($penjualan_tahunan as $row_pengalaman):?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Jabatan Pemberi Tugas  : <?= $row_pengalaman['jabatan_pemberi_tugas']; ?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
        PP No 5 tahun 2021 Pasal 85 & 95 dan Lampiran 1A
        PERMEN PUPR No 6 tahun 2021 <?= $data_comment89 ;?>
    ...
    <?php foreach($peralatan as $row_peralatan) :?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Lokasi sekarang : <?= $row_peralatan['lokasi']; ?>
    ...
    <section class="items">
      ...
      <div class="row">
        <div class="col-1-15-table">
      <?php $reck=$this->Bu_model->get_user($user[0]['user_status_1']) ;?>
          <br>
          <img src="<?= base_url('assets/assets2/').$user[0]['user_status_1'].'.png' ;?>" style="border: 1px; max-height: 190px; max-width: 160px; ">
          <br>
          <?= $reck[0]['Nama'] ?>
          <br>
          (...................................)
