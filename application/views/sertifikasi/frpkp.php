...
<hr>
  <section class="items">
    <div class="center">
FORMULIR REKOMENDASI HASIL PENILAIAN KESESUAIAN KEMAMPUAN
BADAN USAHA JASA KONSTRUKSI<br>
(FRPKP)
    </div>
  </section>
    <section class="items">
...
<section class="items">
  <!-- Header Baris 1 -->
    ...
    <div class="row">
        ...
        <div class="col-1-10-table"style="background-color: #f7fbffff;"><div class="center"><?php if($penilaian_frpkp[0]['penjualan_tahunan']=='1'){
          echo "MEMENUHI";
        }else{
          echo "TIDAK MEMENUHI";
        } ;?></div></div>
      ...
      <div class="row">
        ...
        <div class="col-1-30-table" ><div class="left">Nilai Penjualan Tahunan : <b><?=$penilaian_frpkp[0]['nilai_penjualan_tahunan'];?></b></div></div>
       ...
       <div class="row">
        ...
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"><?php if($penilaian_frpkp[0]['aset']=='1'){
          echo "MEMENUHI";
        }else{
          echo "TIDAK MEMENUHI";
        } ;?></div></div>
      ...
      <div class="row">
        ...
        <div class="col-1-30-table" ><div class="left">Nilai Kemampuan Keuangan : <b><?=$penilaian_frpkp[0]['nilai_kemampuan_keuangan'];?></b></div></div>
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
      </div>
      <div class="row">
        ...
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"><?php if($penilaian_frpkp[0]['tk']=='1'){
          echo "MEMENUHI";
        }else{
          echo "TIDAK MEMENUHI";
        } ;?></div></div>
       ...
       <div class="row">
        ...
        <div class="col-1-30-table"><div class="left"><b><?=$penilaian_frpkp[0]['sub_klas_pjtbu'];?></b></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
      </div>
       <div class="row">
        <div class="col-1-5-table"><div class="left"></div></div>
        <div class="col-1-30-table" ><div class="left">Jenjang : <b><?=$pjtbu[0]['jenjang_skk'];?></b></div></div>
        <div class="col-1-30-table"><div class="left"><b><?=$penilaian_frpkp[0]['jenjang_pjtbu'];?></b></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
      </div>
      <div class="row">
       ...
       <div class="row">
        ...
        <div class="col-1-30-table"><div class="left"><b><?=$penilaian_frpkp[0]['sub_klas_pjskbu'];?></b></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
      </div>
      <div class="row">
        <div class="col-1-5-table"><div class="left"></div></div>
        <div class="col-1-30-table" ><div class="left">Jenjang : <b><?=$pjskbu[0]['jenjang_skk'];?></b></div></div>
        <div class="col-1-30-table"><div class="left"><b><?=$penilaian_frpkp[0]['jenjang_pjskbu'];?></b></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
      </div>
       <div class="row">
        ...
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"><?php if($penilaian_frpkp[0]['peralatan']=='1'){
          echo "MEMENUHI";
        }else{
          echo "TIDAK MEMENUHI";
        } ;?></div></div>
     ...
     <div class="row">
        <div class="col-1-5-table"><div class="center">B.</div></div>
        <div class="col-1-30-table" ><div class="left">Komitemen: <b><?=$penilaian_frpkp[0]['komitmen_sewa'];?></b></div></div>
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
      </div>
       <div class="row">
        ...
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"><?php if($penilaian_frpkp[0]['smap']=='1'){
          echo "MEMENUHI";
        }else{
          echo "TIDAK MEMENUHI";
        } ;?></div></div>
      ...
      <div class="row">
        ...
        a. Nomor Sertifikat: <b><?=$penilaian_frpkp[0]['no_sertifikat_smap'];?></b><br>b. Penerbit: <b><?=$penilaian_frpkp[0]['penerbit_smap'];?></b>
      </div></div>
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
      </div>
      <div class="row">
        ...
        a. Nilai Penerapan SMAP dari PANCEK: <b><?=$penilaian_frpkp[0]['nilai_pancek'];?></b><br>b.  Pemenuhan Dokumen SMAP: <b><?=$penilaian_frpkp[0]['pemenuhan_dokumen_smap'];?></b>
      </div></div>
...
Dokumen SMAP<br>
- Akan memenuhi dokumen SMAP paling lambat <?=$penilaian_frpkp[0]['tahun_smap'];?></div></div>
 ...
 <section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-60-table" style="border: 1px solid black;">
      <div class="left">
        <strong><?=$penilaian_frpkp[0]['comment'];?></strong>
      </div>
    </div>
