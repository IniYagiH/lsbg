          ...
          <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
            <thead>
              ...
              <tr>
                ...
                <th>Laporan Tinjauan Penilaian</th>
                <th>Risalah Rapat Tinjauan Hasil Penilaian dan Keputusan Sertifikasi</th>
                  ...
                  success : function(data) {
                    ...
                    if(response.result==1){
                      ...
                      Swal.fire({
                          ...
                          icon: "error",
                          title: "Belum 1 hari sejak verifikasi pembayaran !",
                          showConfirmButton: false,
                          timer: 3000
                      });
                    }
...
function get_qr(sel) {
  ...
  var tgl_permohonan_value=sel.name;
