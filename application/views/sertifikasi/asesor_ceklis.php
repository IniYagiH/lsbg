...
<section class="items">
    ...
    <section class="items">
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Modal Dasar : Rp. <?= number_format(($row_akte['modaldasar']), 2, '.', ',');?>
          </div>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Modal Disetor : Rp. <?= number_format(($row_akte['modalsetor']), 2, '.', ',');?>
          </div>
    ...
    <?php foreach($pemegang_saham as $row_saham) :?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Nilai per lembaar saham : Rp. <?= number_format(($row_saham['nilai_perlembar']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Nilai total saham : Rp. <?= number_format(($row_saham['nilai_perlembar']*$row_saham['jumlah_lembar']), 2, '.', ',');?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
          Modal Dasar : Rp. <?= number_format(($neraca_asesor[0]['modal_dasar']), 2, '.', ',');?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
          Modal Disetor : Rp. <?= number_format(($neraca_asesor[0]['modal_disetor']), 2, '.', ',');?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
          Presentase : <?=$neraca_asesor[0]['presentase'];?> %
    ...
    <?php foreach ($neraca as $row_neraca):?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Aktiva Lancar : Rp. <?= number_format(($row_neraca['aktiva_lancar']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Aktiva Tidak Lancar : Rp. <?= number_format(($row_neraca['aktiva_tdk_lancar']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Aktiva Lain-lain : Rp. <?= number_format(($row_neraca['aktiva_lain_lain']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Kewajiban lancar : Rp. <?= number_format(($row_neraca['kewajiban_lancar']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Kewajiban tidak lancar : Rp. <?= number_format(($row_neraca['kewajiban_tdk_lancar']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Ekuitas : Rp. <?= number_format(($row_neraca['total_ekuitas']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Total Modal : Rp. <?= number_format(($row_neraca['total_modal']), 2, '.', ',');?>
          </div>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Total Kewajiban : Rp. <?= number_format(($row_neraca['total_kewajiban']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Total Kewajiban Ekuitas : Rp. <?= number_format(($row_neraca['total_kewajiban_ekuitas']), 2, '.', ',');?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Total Aset : Rp. <?= number_format(($row_neraca['total_aset']), 2, '.', ',');?>
    ...
    <?php foreach ($penjualan_tahunan as $row_pengalaman):?>
      ...
      <div class="row">
          ...
          <div class="col-1-40-table">
            Nilai Kontrak : Rp. <?= number_format(($row_pengalaman['nilai_kontrak']), 2, '.', ',');?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
            ...
            Nomor Dokumen : <?=$smap_asesor[0]['dokumen'];?>
    ...
    <div class="row">
        ...
        <div class="col-1-40-table">
            ...
            Nomor Surat Pernyataan : <?=$smap_asesor[0]['pernyataan'];?>
    ...
    <hr>
    <div class="center">
      RESUMA PENILAIAN DAN REKOMENDASI
