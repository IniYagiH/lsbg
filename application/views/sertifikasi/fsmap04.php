...
<hr>
  <section class="items">
    <div class="center">
FORMULIR VERIFIKASI DAN VALIDASI SURAT PERNYATAAN MEMENUHI DOKUMEN SMAP BADAN USAHA JASA KONSTRUKSI <br>(FSMAP 04)    </div>
...
<section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-30-table" rowspan="2"><div class="center">Item</div></div>
    <div class="col-1-30-table" colspan="6"><div class="center">Dokumen</div></div>
    <div class="col-1-30-table" colspan="2"><div class="center"></div></div>
  </div>
    <div class="row">
    ...
    <div class="col-1-10-table" colspan="2"><div class="center">Kelengkapan</div></div>
     <div class="col-1-10-table" colspan="2"><div class="center">Verifikasi</div></div>
      ...
      <div class="col-1-10-table" colspan="1"><div class="center">Keterangan</div></div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-1-5-table"><div class="center">Rekomendasi</div></div>
  </div>
  <div class="row">
  ...
  <div class="row">
    <div class="col-1-5-table"><div class="center">1.</div></div>
    <div class="col-1-30-table">Yang menandatangani :<?=${"data_item_1"};?></div>
  ...
  <div class="row">
    ...
    <div class="col-1-30-table">Tanggal : <?=${"data_item_2"};?></div>
  ...
  <div class="row">
    <div class="col-1-5-table"><div class="center">3.</div></div>
    <div class="col-1-30-table">Isi pernyataan :<?=${"data_item_3"};?></div>
   ...
   <div class="row">
    <div class="col-1-5-table"><div class="center">4.</div></div>
    <div class="col-1-30-table">Bermeterai : <?=${"data_item_4"};?></div>
...
<section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-60-table" style="border: 1px solid black;">
      <div class="left">
        <strong><?=$catatan_fsmap04[0]['catatan'];?></strong>
      </div>
    </div>
