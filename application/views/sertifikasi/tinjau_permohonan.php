					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="alert alert-custom alert-outline-dark fade show mb-5" role="alert">
							    ...
							    <div class="alert-text">Data sub klasifikasi baru telah masuk ke dalam permohonan : <?php foreach($notif as $row_notif){echo $row_notif['id_sub_klasifikasi'].", ";} ;?></div>
											...
											<div class="card">
													<div class="card-header">
															<div class="card-title collapsed" data-toggle="collapse" data-target="#data-pjskbu-<?php echo $counter_pjskbu ;?>">
																<?= $row_pjskbu['sub_klasifikasi'].' - '.$row_pjskbu['nama'] ?>
															</div>
													</div>
