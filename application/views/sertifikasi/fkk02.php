...
<body>
  ...
  <section class="items">
    <div class="center">
      FORMULIR PENILAIAN KEMAMPUAN KEUANGAN BADAN USAHA BERSIFAT SPESIALIS
      <br> (FKK 02)
    </div>
  ...
  <section class="items">
    ...
    <div class="row">
      <div class="col-1-40-table" colspan="6">
        <div class="center"><strong>BADAN USAHA BERSIFAT SPESIALIS</strong></div>
      </div>
    </div>

    <!-- Baris Modal Perusahaan -->
    <div class="row">
      <div class="col-1-10-table" rowspan="2">
        <div class="center">Modal Perusahaan</div>
      </div>
      <div class="col-1-10-table" colspan="2">
        <div class="center">Dasar</div>
      </div>
      <div class="col-1-10-table" colspan="2">
        <div class="center">Disetor</div>
      </div>
      <div class="col-1-10-table" rowspan="2">
    ...
    <div class="row">
      <div class="col-1-10-table">
        <div class="center">Pemilik Saham</div>
      </div>
      <div class="col-1-10-table">
        <div class="center">Jumlah</div>
      </div>
      <div class="col-1-10-table">
        <div class="center">Nilai (Rp)</div>
      </div>
      <div class="col-1-10-table">
        <div class="center">Total (Rp)</div>
      </div>
      <div class="col-1-10-table">
        <div class="center">%</div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-1-30-table" colspan="3">
    ...
    <!-- Total Ekuitas -->
    <div class="row">
      <div class="col-1-10-table"><strong>Total Aset</strong></div>
      <div class="col-1-30-table" colspan="2"><strong><?= ${"data_aset" . $id_sahamx} ?></strong></div>
  ...
  <section class="items">
    ...
    <div class="row">
      ...
      <div class="col-1-60-table" style="border: 1px solid black;">
        <div class="left">
          <strong><?= $catatan_fkk02[0]['catatan']; ?></strong>
        </div>
      </div>
