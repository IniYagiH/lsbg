			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('sertifikasi/fkk04/'.$nib_dec.'/'.$tgl_dec.'/'.$user_dec) ;?>"
							target="_blank" style="margin:5px;" class="btn btn-warning font-weight-bolder">
							<i class="flaticon2-chart"></i>FKK04</a>
    ...
    <style media="print">
        ...
        .col-1-30 {
            width: 30%;
							...
							<?php echo form_open_multipart(base_url('sertifikasi/insert_penilaian_fkk04'), 'method="POST"');?>
...
<section class="items">
	 ...
	 <div class="row">
    <div class="col-1-60-table" colspan="4">
      <div class="center"><strong>HASIL PENILAIAN KELAYAKAN BADAN USAHA</strong></div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-1-40-table" style="background-color: #fdeac6;">
      <div class="center">Hasil Penilaian Kemampuan Keuangan (Rp)</div>
    </div>
    <div class="col-1-20-table" style="background-color: #fdeac6;">
      <div class="center">Persyaratan Kemampuan Keuangan (Rp)</div>
    </div>
    <div class="col-1-20-table">
      <div class="center">REKOMENDASI</div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-1-40-table"><div class="center">2</div></div>
    <div class="col-1-20-table"><div class="center">3</div></div>
    <div class="col-1-20-table"><div class="center">4</div></div>
  </div>
    <div class="row">
    <div class="col-1-5-table"><div class="center">
    ...
    <div class="col-1-40-table"><div class="center">
					<input type="text" <?php if(empty($penilaian_fkk04)) :?> value="Total Ekuitas : <?=number_format($neraca[0]['total_ekuitas'],0,",",".") ;?> Total Aset : <?=number_format($neraca[1]['total_aset'],0,",",".") ;?> "  <?php else :?>value="<?=$penilaian_fkk04[0]['hasil'];?>"<?php endif ;?> name="hasil" class="form-control" placeholder="Total Ekuitas...">

	</div></div>
    <div class="col-1-20-table"><div class="center">
					<input type="text" value="<?=$penilaian_fkk04[0]['persyaratan'];?>" name="persyaratan" class="form-control" placeholder="Comment...">

	</div></div>
    <div class="col-1-20-table"><div class="center">
	       <select class="form-control" name="rekomendasi" required="required">
                    <option value="1" <?php if($penilaian_fkk04[0]['rekomendasi']=='1') :?>selected<?php endif ;?>>SESUAI</option>
					<option value="0"<?php if($penilaian_fkk04[0]['rekomendasi']=='0') :?>selected<?php endif ;?>>TIDAK SESUAI</option>
            </select>
...
<section class="items">
  ...
  <div class="row">
	<div class="input-group file-caption-main">
		<span class="file-caption-icon"></span>
		<textarea id="comment_res" name="catatan_fkk04"class="form-control form-control-solid" rows="5"placeholder="Catatan resuma...">
			<?php if(!empty($catatan_fkk04)) :?>
			<?=$catatan_fkk04[0]['catatan'] ;?>
			<?php else :?>
			Catatan :

Berdasarkan ketentuan SK dirjen No. 37 Tahun 2025, pemenuhan Kemampuan Keuangan Badan Usaha <?=$biodata[0]['nama'];?>  pada: Subklasifikasi  <?=$klasifikasi[0]['deskripsi_subklasifikasi'];?> Kode Subklasifikasi     <?=$klasifikasi[0]['id_sub_klasifikasi'];?>  Kualifikasi <?=$klasifikasi[0]['kualifikasi'];?>, dinyatakan  SESUAI / TIDAK SESUAI  (hapus yang tidak diperlukan)
			<?php endif ;?>
      </textarea>
...
<br>
								<br>
								<button type="submit" name="submit" style="float: right" class="open-delete btn btn-primary btn-labeled btn-rounded"><b><i class="icon-paperplane"></i></b> Submit Penilaian FKK04</button>
