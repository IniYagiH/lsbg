...
<body>
  ...
  <div class="center-pds">
    ...
    <br>
    <br>
    SURAT TUGAS TINJAUAN HASIL EVALUASI<p>
      <br>
      Nomor : <?= $no_surat ;?>
  </div>
...
-->
  ...
  <section class="items">
    ...
    <div class="row">
      <div class="col-1-10">
        Nama Tinjauan Hasil Evaluasi
      </div>
      <?php $user=$this->Bu_model->get_user($id_user) ;?>
      <div class="col-1-10">
  ...
  <section class="items">
    <div class="row">
      <div class="col-1-20">
        untuk melaksanakan Tinjauan Hasil Evaluasi terhadap dokumen permohoman badan usaha jasa konstruksi sebagai
        berikut :<p>
      </div>
    </div>
  </section>
