			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('sertifikasi/fsmap01/'.$nib_dec.'/'.$tgl_dec.'/'.$user_dec) ;?>"
							target="_blank" style="margin:5px;" class="btn btn-primary font-weight-bolder">
							<i class="flaticon-customer"></i>FSMAP01</a>
...
<div class="tab-pane fade show" id="smap" role="tabpanel" aria-labelledby="home-tab-1">
								...
								<?php echo form_open_multipart(base_url('sertifikasi/insert_penilaian_fsmap01'), 'method="POST"');?>
    ...
    <table style="width:100%; border-collapse:collapse; font-family:Arial, sans-serif; font-size:13px;" border="1">
        ...
        <tr>
            ...
            <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="keterangan1" required="required">
        ...
        <tr>
            ...
            <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="keterangan2" required="required">
															<option value="1">SESUAI</option>
															<option value="0">TIDAK SESUAI</option>
														</select>
        ...
        <tr>
            ...
            <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="keterangan3" required="required">
															<option value="1">SESUAI</option>
															<option value="0">TIDAK SESUAI</option>
														</select>
        ...
        <tr>
          ...
          <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="keterangan4" required="required">
															<option value="1">SESUAI</option>
															<option value="0">TIDAK SESUAI</option>
														</select>
		...
		<input type="hidden" value="<?php echo $user_dec ;?>" name="id3">
									...
									<div class="row">
										...
										<div class="input-group file-caption-main">
											<span class="file-caption-icon"></span>
											<textarea id="comment_res" name="catatan_fsmap01"
												class="form-control form-control-solid" rows="5"
												placeholder="Catatan resuma...">
												<?php if(!empty($catatan_fsmap01)) :?>
												<?=$catatan_fsmap01[0]['catatan'];?>	
												<?php else :?>
													Catatan:
													1. Berdasarkan Ketentuan Keputusan DJBK No. …………………… (diisi peraturan yang berlaku)
													2. Kesesuaian Jenis dokumen yang diupload dengan pilihan pemenuhan yang dipilih (ya / tidak) (hapus yang tidak
													diperlukan)
													3. Hasil CEK KELENGKAPAN, VERIFIKASI DAN VALIDASI
													Dokumen permohonan BUJK "nama_badan_usaha" : SESUAI / TIDAK SESUAI (hapus yang tidak diperlukan
												<?php endif ;?>
											</textarea>
