...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
  ...
  <div class="d-flex flex-column-fluid">
					...
					<div class="example mb-10">
						...
						<div class="example-preview">
							<ul class="nav nav-pills" id="myTab1" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link" id="contact-tab-1" data-toggle="tab" href="#smm" aria-controls="contact">
										<span class="nav-icon">
											<i class="flaticon2-rocket-1"></i>
										</span>
										<span class="nav-text">SMM</span>
									</a>
								</li>
								<li class="nav-item">
							...
							<?php if(!empty($cek)) :?>
							<?php echo form_open_multipart(base_url('sertifikasi/insert_verifikasi'), 'method="POST"');?>
						<?php endif ;?>
												...
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a <?php if($biodata[0]['sptjm']!='') :?>href="<?= $biodata[0]['sptjm'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_11"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get23()" id="get_23"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																	</div>
																	</div>
																</div>
														</div>
							...
							<?php endif ;?>
								...
								<div class="tab-pane fade show" id="upload" role="tabpanel" aria-labelledby="home-tab-1">

										<div class="col-md-12">
											<div class="panel panel-flat panel-collapsed">
												<div class="panel-heading">
													<h5 class="panel-title">Upload Invoice</h5>
													<div class="heading-elements">
													...
													<div class="row justify-content-center border-top py-8 px-8 py-md-28 px-md-0">
															...
															<div class="col-md-4">
																...
																<div class="card card-custom gutter-b" style="height: 150px">
																	...
																	<div class="card-body d-flex align-items-center justify-content-between flex-wrap">
																		<div class="mr-2">
																			<h3 class="font-weight-bolder">Print Invoice</h3>
																			<div class="text-dark-50 font-size-lg mt-2">Untuk diberikan materai dan ditandatangani secara elektronik</div>
																		</div>
																		<a type="button" href="<?= base_url('sertifikasi/print_invoice/'.$nib_dec."/".$tgl_dec) ;?>" target="_blank" class="btn btn-dark font-weight-bolder my-1">Print Invoice</a>
																	</div>
																	<!--end::Body-->
																</div>
																<!--end::Mixed Widget 10-->
															...
															<div class="col-md-4">
																...
																<div class="card card-custom gutter-b" style="height: 150px">
																	...
																	<div class="card-body d-flex align-items-center justify-content-between flex-wrap">
																		<div class="mr-2">
																			<h3 class="font-weight-bolder">Upload Invoice</h3>
																			<div class="text-dark-50 font-size-lg mt-2">Upload invoice yang telah di tandatangani secara elektronik</div>
																		</div>
																		<button data-toggle="modal" data-target="#modal_upload" type="button" class="btn btn-warning font-weight-bolder my-1">Upload Invoice</button>
																	</div>
																	<!--end::Body-->
																</div>
																<!--end::Mixed Widget 10-->
															...
															<div class="col-md-4">
																...
																<div class="card card-custom gutter-b" style="height: 150px">
																	...
																	<div class="card-body d-flex align-items-center justify-content-between flex-wrap">
																		<div class="mr-2">
																			<h3 class="font-weight-bolder">Check</h3>
																			<div class="text-dark-50 font-size-lg mt-2">Checking untuk memastikan invoice telah ter-upload</div>
																		</div>
																		<a href="<?=base_url("get_file/get_invoice/".$nib_dec.'/'.$tgl_dec);?>" target="_blank" type="button" class="btn btn-dark font-weight-bolder my-1">Check Upload Invoice</a>
																	</div>
																	<!--end::Body-->
																</div>
																<!--end::Mixed Widget 10-->
	...
	function submit(sel) {
			...
			Swal.fire({
						title: "Anda ingin mem-verifikasi final permohonan ?",
						text: "Proses akan menyatakan permohonan lengkap, akan mengirim email pemberitahuan kepada pemohon dan mengirim status lolos verifikasi ke oss!",
						icon: "warning",
						showCancelButton: true,
						confirmButtonText: "YA !",
						cancelButtonText: "No, Batalkan!",
