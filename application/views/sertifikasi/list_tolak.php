...
<div class="modal fade" id="modal_tolak" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="card card-custom gutter-b">
					...
					<?php echo form_open_multipart('sertifikasi/post_status_90/', 'class="form-horizontal form-validate-jquery" id="form-upload-1"');?>
...
function refresh() {
    ...
    function tolak_permohonan(sel) {
      ...
      document.getElementById('comment_tolak').value+="Permohonan SBU Bapak/Ibu dengan NIB : "+nib_value+' Belum bisa diproses dan kami kembalikan ';
  													...
  													$.ajax({
  														...
  														success: function (data) {
  															if (data.result == '1') {
  																...
  																window.location.replace("<?php echo base_url('sertifikasi/list_tolak');?>");
  															}
  															else {
