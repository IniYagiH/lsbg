			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('sertifikasi/ftp03/'.$nib_dec.'/'.$tgl_dec.'/'.$user_dec) ;?>"
											...
											<table class="table table-lg">
												...
												<tbody>
													<tr>
														...
														<td><span class="text-dark"><?php echo $biodata[0]['nama'] ;?></span>
														</td>
													</tr>
													<tr>
														<td>NIB</td>
...
<?php echo form_open_multipart(base_url('sertifikasi/insert_penilaian_ftp03'), 'method="POST"');?>
...
<section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-20-table" style="background-color: #fdeac6;">
      <div class="center">Hasil Penilaian Penjualan tahunan (Rp)</div>
    </div>
    <div class="col-1-20-table" style="background-color: #fdeac6;">
      <div class="center">Persyaratan Penjualan Tahunan (Rp)</div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-1-20-table"><div class="center">
		<input type="text" value="<?=$penilaian_ftp03[0]['hasil'];?>" name="hasil" class="form-control" placeholder="Comment...">

	</div></div>
    <div class="col-1-20-table"><div class="center">
		<input type="text" value="<?=$penilaian_ftp03[0]['persyaratan'];?>" name="persyaratan" class="form-control" placeholder="Comment...">

	</div></div>
    <div class="col-1-20-table"><div class="center">
	     <select class="form-control" name="rekomendasi" required="required">
                    <option value="1" <?php if($penilaian_ftp03[0]['rekomendasi']=='1') :?>selected<?php endif ;?>>SESUAI</option>
					<option value="0"<?php if($penilaian_ftp03[0]['rekomendasi']=='0') :?>selected<?php endif ;?>>TIDAK SESUAI</option>
            </select>
...
<section class="items">
  ...
  <div class="row">
	<div class="input-group file-caption-main">
		<span class="file-caption-icon"></span>
		<textarea id="comment_res" name="catatan_ftp03"class="form-control form-control-solid" rows="5"placeholder="Catatan resuma...">
			<?php if(!empty($catatan_ftp03)) :?>
			<?=$catatan_ftp03[0]['catatan'];?>
			<?php else :?>
				Catatan :

Berdasarkan ketentuan SK dirjen No. ................, pemenuhan penjualan tahunan Badan Usaha <?=$biodata[0]['nama'];?> pada: Subklasifikasi <?=$klasifikasi[0]['deskripsi_subklasifikasi'];?>, Kode Subklasifikasi <?=$klasifikasi[0]['id_sub_klasifikasi'];?>  Kualifikasi <?=$klasifikasi[0]['kualifikasi'];?>, dinyatakan  SESUAI / TIDAK SESUAI  (hapus yang tidak diperlukan)
  ...
  <br>
								<br>
								<button type="submit" name="submit" style="float: right" class="open-delete btn btn-primary btn-labeled btn-rounded"><b><i class="icon-paperplane"></i></b> Submit Penilaian FTP03</button>
