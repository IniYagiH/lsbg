		...
		<div class="container">
			<div class="card card-custom gutter-b">
				...
				<div class="card-body">
						...
						<div class="col-md-6">
							...
							<div class="input-group file-caption-main">
								...
								<input type="text" name="copy" id="copy"
									value="<?= base_url('sertifikasi/biaya_sertifikasi/'.$nib_dec."/".$tgl_dec) ;?>"
									class="form-control" readonly>


								<div class="input-group-btn input-group-append">
									<button type="button" onclick="copy()"
										class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333"
										data-style="zoom-in"><span class="ladda-label">Copy Link
											...
											<div class="panel-body">
												...
												<div class="row">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked"
																	id="checkbox_23" value="1"
																	onclick="javascript:checkbox23()"
																	name="checkbox_23" />
																<span></span>
															</label>
														</span>
													...
													<div class="col-md-8">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get23()"
																	id="get_23" disabled="disabled"
												...
												<div class="row">
													<div class="col-md-3">
														<div class="content-group-lg">
															<h6 class="text-semibold">#1</h6>
															<p class="content-group">File Surat Pernyataan Tanggung
																Jawab Mutlak</p>
														</div>
													</div>
												...
												<div class="row">
													...
													<div class="col-md-2">
														<br>
														<a <?php if($row['sptjm']!='') :?>href="<?= $row['sptjm'] ;?>"
															...
															<?php if($row['id_sub_klasifikasi']=='') :?> Softcopy
															<?php else :?><?=$row['id_sub_klasifikasi'] ;?><?php endif ;?></a>
													</div>
													<?php endforeach ;?>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_80" value="1"
														name="checkbox_80" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_80" name="comment_80"
													class="form-control" placeholder="Comment...">


												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get80()" id="get_80"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-1">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked" id="checkbox_4"
													...
													<div class="col-md-6">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get4()"
																	id="get_4" disabled="disabled"
																	class="btn btn-dark btn-ladda btn-ladda-spinner"
																	data-spinner-color="#333" data-style="zoom-in"><span
																		class="ladda-label">Submit</span></button>
															</div>
												...
												<div class="row">
													...
													<div class="col-md-1">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked"
																	id="checkbox_30" value="1"
																	onclick="javascript:checkbox30()"
																	name="checkbox_30" />
																<span></span>
															</label>
														</span>
													...
													<div class="col-md-6">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get30()"
																	id="get_30" disabled="disabled"
																	class="btn btn-dark btn-ladda btn-ladda-spinner"
																	data-spinner-color="#333" data-style="zoom-in"><span
																		class="ladda-label">Submit</span></button>
															</div>
												...
												<div class="row">
													...
													<div class="col-md-1">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked"
																	id="checkbox_31" value="1"
																	onclick="javascript:checkbox31()"
																	name="checkbox_31" />
																<span></span>
															</label>
														</span>
													...
													<div class="col-md-2">
														...
														<a <?php if($smm[0]['sertifikat_iso']!='') :?>href="<?= $smm[0]['sertifikat_iso'] ;?>"
															<?php else :?>href="<?= base_url('not_found') ;?>"
															<?php endif ;?> target="_blank" type="button"
															name="btn_cek_31" style="float: right"
															class="open-delete btn btn-dark btn-labeled btn-rounded"><b><i
																	class="icon-file-check"></i></b> Softcopy</a>
													</div>
													<div class="col-md-6">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get31()"
																	id="get_31" disabled="disabled"
																	class="btn btn-dark btn-ladda btn-ladda-spinner"
																	data-spinner-color="#333" data-style="zoom-in"><span
																		class="ladda-label">Submit</span></button>
															</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_79" value="1"
														name="checkbox_79" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_79" name="comment_79"
													class="form-control" placeholder="Comment...">


												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get79()" id="get_79"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_78" value="1"
														name="checkbox_smap" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_78" name="comment_78"
													class="form-control" placeholder="Comment...">


												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get78()" id="get_78"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
                                        ...
                                        <div class="col-md-6">
                                         <?php foreach($klasifikasi as $row) :?>
                                            ...
                                            <div class="accordion accordion-toggle-arrow" id="accordionExample1">
                                                ...
                                                <?php $record_smap=$this->Bu_model->smap_opr_izin_perubahan($row['id_izin']) ;?>
                                                <?php $counter_pengalaman+=1 ;?>
                                                <?php if(!empty($record_smap)) :?>
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="card-title collapsed" data-toggle="collapse"
                                                            data-target="#data-smap-<?php echo $counter_pengalaman ;?>">
                                                            ...
                                                            <div class="table-responsive">
                                                                ...
                                                                <table class="table table-lg">
                                                                    ...
                                                                    <tbody>
                                                                        				<tr>
                                                                            <td>File SMAP </td>
                                                                            <td><a href="<?=$record_smap[0]['file_surat_pernyataan'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
                </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Nomor Sertifikat</td>
                                                                            <td><span
                                                                                    class="text-dark"><?php echo $record_smap[0]['nomor_sertifikat'] ;?></span>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td>Tipe Dokumen SMAP</td>
                                                                            <td><span
                                                                                    class="text-dark"><?php echo $record_smap[0]['persyaratan_smap'] ;?></span>
                                                                            </td>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_81" value="1"
														name="checkbox_81" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_81" name="comment_81"
													class="form-control" placeholder="Comment...">

												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get81()" id="get_81"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
									...
									<div class="row">
										...
										<div class="col-md-4">
											...
											<div class="form-group">
												...
												<select name="nama_paket" id="nomor_kontrak_pengalaman"
													class="form-control">
													<?php foreach ($penjualan_tahunan as $row_pengalaman2) :?>
													<option value="<?php echo $row_pengalaman2['nomor_kontrak'] ;?>">
														<?php echo $row_pengalaman2['nomor_kontrak'] ;?></option>
													<?php endforeach ;?>
												</select>
												<footer class="blockquote-footer">
													Pilih Nomor Kontrak
										...
										<div class="col-md-3">
											...
											<div class="form-group">
												...
												<select name="id_sub_pengalaman" id="id_sub_pengalaman"
													class="form-control">
													<?php foreach ($penjualan_tahunan as $row_pengalaman2) :?>
													<option
														value="<?php echo $row_pengalaman2['id_sub_klasifikasi'] ;?>">
														<?php echo $row_pengalaman2['id_sub_klasifikasi'] ;?></option>
													<?php endforeach ;?>
												</select>
												<footer class="blockquote-footer">
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_24" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get24()" id="get_24"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_25" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get25()" id="get_25"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_26" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get26()" id="get_26"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_82" value="1"
														name="checkbox_82" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_82" name="comment_82"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get82()" id="get_82"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-7">
														...
														<div class="form-group">
															...
															<select name="tahun" id="no_akte_pilihan"
																class="form-control">
																<?php foreach ($akte as $row_akte) :?>
																<option value="<?php echo $row_akte['no'] ;?>">
																	<?php echo $row_akte['no'] ;?></option>
																<?php endforeach ;?>
															</select>
															<footer class="blockquote-footer">
																Pilih No Akte
												...
												<div class="row">
													...
													<div class="col-md-1">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked"
																	id="checkbox_11" value="1"
																	onclick="javascript:checkbox11()"
																	name="checkbox_11" />
																<span></span>
															</label>
														</span>
													...
													<div class="col-md-8">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get11()"
																	id="get_11" disabled="disabled"
																	class="btn btn-dark btn-ladda btn-ladda-spinner"
																	data-spinner-color="#333" data-style="zoom-in"><span
																		class="ladda-label">Submit</span></button>
															</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_83" value="1"
														name="checkbox_83" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_83" name="comment_83"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get83()" id="get_83"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
													...
													<div class="col-md-7">
														...
														<div class="form-group">
															...
															<select name="tahun" id="tahun" class="form-control">
																...
																<option value="<?php echo $row_neraca2['Tahun'] ;?>">
																	<?php echo $row_neraca2['Tahun'] ;?></option>
																<?php endforeach ;?>
															</select>
															<footer class="blockquote-footer">
																Pilih Tahun Neraca
												...
												<div class="row">
													...
													<div class="col-md-1">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked"
																	id="checkbox_16" value="1"
																	onclick="javascript:checkbox16()"
																	name="checkbox_16" />
																<span></span>
															</label>
														</span>
													...
													<div class="col-md-8">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get16()"
																	id="get_16" disabled="disabled"
																	class="btn btn-dark btn-ladda btn-ladda-spinner"
																	data-spinner-color="#333" data-style="zoom-in"><span
																		class="ladda-label">Submit</span></button>
															</div>
												...
												<div class="row">
													...
													<div class="col-md-1">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked"
																	id="checkbox_17" value="1"
																	onclick="javascript:checkbox17()"
																	name="checkbox_17" />
																<span></span>
															</label>
														</span>
													...
													<div class="col-md-8">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get17()"
																	id="get_17" disabled="disabled"
																	class="btn btn-dark btn-ladda btn-ladda-spinner"
																	data-spinner-color="#333" data-style="zoom-in"><span
																		class="ladda-label">Submit</span></button>
															</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_87" value="1"
														name="checkbox_87" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_87" name="comment_87"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get87()" id="get_87"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-1">
														...
														<span class="switch switch-outline switch-icon switch-primary">
															...
															<label>
																<input type="checkbox" checked="checked"
																	id="checkbox_20" value="1"
																	onclick="javascript:checkbox20()"
																	name="checkbox_20" />
																<span></span>
															</label>
														</span>
													...
													<div class="col-md-6">
														...
														<div class="input-group file-caption-main">
															...
															<div class="input-group-btn input-group-append">
																<button type="button" onclick="javascript:get_20()"
																	id="get_20" disabled="disabled"
																	class="btn btn-dark btn-ladda btn-ladda-spinner"
																	data-spinner-color="#333" data-style="zoom-in"><span
																		class="ladda-label">Submit</span></button>
															</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_85" value="1"
														name="checkbox_85" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_85" name="comment_85"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get85()" id="get_85"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_88" value="1"
														name="checkbox_88" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_88" name="comment_88"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get88()" id="get_88"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_77" value="1"
														name="checkbox_77" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_77" name="comment_77"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get77()" id="get_77"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
										...
										<div class="col-md-8">
											...
											<div class="form-group">
												<select name="nama_peralatan" id="id_peralatan" class="form-control">
													...
													<option data-text="<?php echo $row_peralatan['jenis_peralatan'] ;?>"
														value="<?php echo $row_peralatan['jenis_peralatan'] ;?>">
														<?php echo $row_peralatan['jenis_peralatan'] ;?></option>
													<?php endforeach ;?>
												</select>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_21" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get21()" id="get_21"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_27" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get27()" id="get_27"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_28" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get28()" id="get_28"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_29" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get29()" id="get_29"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_36" value="1"
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get36()" id="get_36"
														disabled="disabled"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_89" value="1"
														name="checkbox_89" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_89" name="comment_89"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get89()" id="get_89"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
											...
											<div class="panel-body">
												...
												<div class="row">
													...
													<div class="col-md-8">
														...
														<div class="form-group">
															<select name="nama_peralatan" id="klasifikasi_reg"
																class="form-control">
																<?php foreach ($klasifikasi as $row_klas) :?>
																<option
																	data-text="<?php echo $row_klas['id_sub_klasifikasi'] ;?>"
																	value="<?php echo $row_klas['id_sub_klasifikasi'] ;?>">
																	<?php echo $row_klas['id_sub_klasifikasi'] ;?>
																</option>
																<?php endforeach ;?>
															</select>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_90s" value="1"
														name="checkbox_90" />
													<span></span>
												</label>
											</span>
										...
										<div class="col-md-8">
											...
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<input type="text" id="comment_90" name="comment_90"
													class="form-control" placeholder="Comment...">
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get90()" id="get_90"
														class="btn btn-dark btn-ladda btn-ladda-spinner"
														data-spinner-color="#333" data-style="zoom-in"><span
															class="ladda-label">Submit</span></button>
												</div>
														...
														<div class="card card-custom gutter-b" style="height: 150px">
															...
															<div
																...
																<div class="mr-2">
																	...
																	<div class="text-dark-50 font-size-lg mt-2">Untuk
																		diberikan materai dan ditandatangani secara
																		elektronik</div>
																</div>
																<a type="button"
																	href="<?= base_url('sertifikasi/print_invoice/'.$nib_dec."/".$tgl_dec) ;?>"
																	target="_blank"
																	class="btn btn-dark font-weight-bolder my-1">Print
																	Invoice</a>
															</div>
															<!--end::Body-->
														</div>
														...
														<div class="card card-custom gutter-b" style="height: 150px">
															...
															<div
																...
																<div class="mr-2">
																	...
																	<div class="text-dark-50 font-size-lg mt-2">Upload
																		invoice yang telah di tandatangani secara
																		elektronik</div>
																</div>
																<button data-toggle="modal" data-target="#modal_upload"
																	type="button"
																	class="btn btn-warning font-weight-bolder my-1">Upload
																	Invoice</button>
															</div>
															<!--end::Body-->
														</div>
														...
														<div class="card card-custom gutter-b" style="height: 150px">
															...
															<div
																...
																<div class="mr-2">
																	...
																	<div class="text-dark-50 font-size-lg mt-2">Checking
																		untuk memastikan invoice telah ter-upload</div>
																</div>
																<a href="<?=base_url("get_file/get_invoice/".$nib_dec.'/'.$tgl_dec);?>"
																	target="_blank" type="button"
																	class="btn btn-dark font-weight-bolder my-1">Check
																	Upload Invoice</a>
															</div>
															<!--end::Body-->
														</div>
					...
					<?php if(!empty($cek)): ?>
					<a onclick="javascript:submit(this)" type="button" name="submit" style="float: right"
						class="open-delete btn btn-dark btn-labeled btn-rounded"><b></i></b>Verifikasi Final</a>
						<input type="hidden" name="subklasifikasi_pjt" id="subklasifikasi_pjt">
					<button id="submits" style="display:none;" target="_blank" type="submit" name="submit"
						style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded"><b><i
								class="icon-paperplane"></i></b> Submit</button>
					<?php endif; ?>
					<?php echo form_close() ;?>
				</div>
			</div>
...
<script>
	...
	function submit(sel) {
		...
		Swal.fire({
			title: "Pilih Subklasifikasi Untuk PJT",
			text: "Silahkan pilih subklasifikasi pada permohonan untuk kesesuaian PJT yang digunakan!",
			icon: "warning",
			input: 'select',
			inputOptions: {
				<?php 
					foreach($klasifikasi as $row){
						echo "'".$row['id_sub_klasifikasi']."': '".$row['id_sub_klasifikasi']."',";
					}
					;?>
			},
			inputPlaceholder: 'Pilih Subklasifikasi PJT',
			showCancelButton: true,
			...
			if (result.value) {
				...
				document.getElementById("subklasifikasi_pjt").value=result.value;
				Swal.fire({
					title: "Mohon Tunggu!",
					text: "Sedang Berjalan",
					onOpen: function () {
...
document.addEventListener("keydown", function(event) {
    if (event.key === "Enter") {
		...
		Swal.fire(
										"Mohon Perhatian!",
										"Untuk melanjutkan proses, harap menggunakan klik tombol yang tersedia. Jangan menekan tombol Enter pada keyboard, karena tindakan tersebut tidak akan diproses dengan benar.",
										"error"
								)
    }
});
