...
<hr>
  <section class="items">
    <div class="center">
    FORMULIR REKOMENDASI HASIL PENILAIAN KEMAMPUAN KEUANGAN BUJK <br>(FKK 04)
    </div>
...
<section class="items">
  <!-- Judul Header -->
  <div class="row">
    <div class="col-1-40-table" colspan="4">
  ...
  <div class="row">
    ...
    <div class="col-1-10-table" style="background-color: #fdeac6;">
  ...
  <div class="row">
    ...
    <div class="col-1-10-table"><div class="center">2</div></div>
    <div class="col-1-10-table"><div class="center">3</div></div>
    <div class="col-1-10-table"><div class="center">4</div></div>
  </div>
  <div class="row">
    <div class="col-1-5-table"><div class="center"><?=$neraca[0]['Tahun'];?></div></div>
    <div class="col-1-10-table"><div class="center"><?=$penilaian_fkk04[0]['hasil'];?></div></div>
    <div class="col-1-10-table"><div class="center"><?=$penilaian_fkk04[0]['persyaratan'];?></div></div>
    <div class="col-1-10-table"><div class="center"><?php if($penilaian_fkk04[0]['rekomendasi']=='1'){echo "SESUAI";}else{echo "TIDAK SESUAI";} ;?></div></div>
  </div>
</section>
...
<section class="items">
  ...
  <div class="row">
    <div class="col-1-40-table" colspan="2">
      <div class="center"><strong>Lembaga Sertifikasi Badan Usaha (LSBU)</strong></div>
    </div>
  </div>
  ...
  <div class="row">
    <!-- Kolom Kiri -->
    <div class="col-1-20-table" style="vertical-align: top;">
      <div class="left">
        <strong><?=$catatan_fkk04[0]['catatan'];?></strong>
      </div>
    </div>
