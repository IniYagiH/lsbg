    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex flex-column">
          <!--begin::Title-->
          <h2 class="text-white font-weight-bold my-2 mr-5">Pengajuan Permohonan</h2>
          <!--end::Title-->
          <!--begin::Breadcrumb-->
          <div class="d-flex align-items-center font-weight-bold my-2">
            ...
            <!--begin::Item-->
            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
            <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Pengajuan Permohonan</a>
            <!--end::Item-->
          </div>
          <!--end::Breadcrumb-->
        </div>
          ...
          <div class="col-md-9">
            <div class="row pb-26">
              <div class="col-md-4 border-right-md pr-md-10 py-md-10">
                ...
                <div class="text-dark-50 font-size-lg font-weight-bold mb-3">Pengajuan Permohonan</div>
              ...
              <div class="col-md-8 py-8 pl-md-4">
                <div class="content-group">
                <div class="list-group">

									<?php foreach($tgl_permohonan as $row) :?>
                  <a href="<?php echo base_url('sertifikasi/permohonan/'.encrypt_url($row['tgl_permohonan'])) ;?>" class="list-group-item ">
