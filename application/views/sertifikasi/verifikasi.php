															...
															<div class="table-responsive">
																...
																<table class="table table-lg">
																	...
																	<tbody>
																		...
																		<tr>
																			<td>Tgl Terbit ISO</td>
																			<td><span class="text-dark"><?php echo $smap[0]['penerbit_iso']; ?></span></td>
																		...
																		<tr>
																			<td>Tgl Habis Berlaku</td>
																			<td><span class="text-dark"><?php echo $smap[0]['tanggal_habis_berlaku']; ?></span></td>

																		</tr>
																		<tr>
																			<td>No Sertifikat ISO</td>
																			<td><span class="text-dark"><?php echo $smap[0]['nomor_sertifikat_iso']; ?></span></td>

																		</tr>

																		<tr>
																			<td>Jenis ISO</td>
																			<td><span class="text-dark"><?php echo $smap[0]['jenis_iso']; ?></span></td>
