			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-muted">Penunjukan Tinjauan Hasil Evaluasi</a>
						</li>
      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            ...
            <span class="d-block text-muted pt-2 font-size-sm">Daftar Keseluruhan Permohonan Penunjukan Tinjauan Hasil Evaluasi</span></h3>
          </div>
...
<div class="modal fade" id="modal_proses" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeXl" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-xl" role="document">
		<div class="modal-content">
				...
				<div class="card card-custom gutter-b">
					<div class="card-header">
						<div class="card-title">
							...
							<h3 class="card-label">Tinjauan hasil Evaluasi</h3>

						</div>
					</div>
          <?php echo form_open_multipart('sertifikasi/insert_penunjukan_the/', 'class="form-horizontal form-validate-jquery" id="form-upload-1x"');?>
          ...
          <div class="form-group row">
            <div class="col-lg-12">
                <label class="control-label">Tinjauan Hasil Evaluasi <span class="text-danger"></span></label>
                <select name="teknis_1" class="form-control" required="required">
                  <option value="">Pilih Tinjauan Hasil Evaluasi</option>
                  <?php $count=0 ;?>
