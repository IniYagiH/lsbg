...
-->
  ...
  <section class="items">
    <div class="row">
      <div class="col-1-20">
untuk melaksanakan Tinjauan hasil penilaian kelayakan dan Pemutusan Sertifikasi terhadap dokumen permohoman badan usaha jasa konstruksi sebagai berikut :      </div>
    </div>
  </section>
...
<div class="col-1-15">
        ...
        <?php
        $nama=$this->Bu_model->get_user_nama_asesor($pemutus[0]['komite_1']);
        ...
        <?php
                  // $path = base_url('assets/sertifikat/qrcodex/'.$qr_sps); sementara karena masalah server GCP
                 $nama=$this->Bu_model->get_user_nama_asesor($pemutus[0]['komite_2']);
                  $path = base_url("assets/assets2/".$nama[0]['Username'].".png");
                  $type = pathinfo($path, PATHINFO_EXTENSION);
                  $ch = curl_init();
        ...
        <?php
                  // $path = base_url('assets/sertifikat/qrcodex/'.$qr_sps); sementara karena masalah server GCP
                 $nama=$this->Bu_model->get_user_nama_asesor($pemutus[0]['komite_3']);
                  $path = base_url("assets/assets2/".$nama[0]['Username'].".png");
                  $type = pathinfo($path, PATHINFO_EXTENSION);
                  $ch = curl_init();
