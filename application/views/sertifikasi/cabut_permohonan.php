      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Cabut Permohonan
            <span class="d-block text-muted pt-2 font-size-sm">Searching Data Pencabutan</span></h3>
          </div>
...
$('#submit').click(function(){
      ...
      jQuery.ajax({
        url : "<?= base_url('sertifikasi/search_cabut')?>",
        type : "POST",
        data : {input:input_value,
          ...
          array.forEach(function(element) {
            ...
            var rowNode = table
              .row.add( [ element.NIB,status, element.id_izin, element.nama,element.id_sub_klasifikasi,element.tgl_permohonan,status2] )
              .draw()
              .node();
              $( rowNode )
  								.css( 'color', 'black' )
