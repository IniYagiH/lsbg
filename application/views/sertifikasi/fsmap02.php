...
<hr>
  <section class="items">
    <div class="center">
FORMULIR VERIFIKASI DAN VALIDASI DOKUMEN PENERAPAN SMAP<br>

BADAN USAHA JASA KONSTRUKSI YANG BERUPA LEMBAR KONFIRMASI PANCEK KPK <br>(FSMAP-02)   </div>
    ...
    <div class="row">
     ...
     <div class="row">
        ...
        <div class="col-1-10">
          : <?=$klasifikasi[0]['id_sub_klasifikasi'];?>
        </div>
     ...
     <div class="row">
        ...
        <div class="col-1-10">
          : Jasa Konsultansi/Pekerjaan Konstruksi/Pekerjaan Terintegrasi
        </div>
     ...
     <div class="row">
       ...
       <div class="row">
        ...
        <div class="col-1-10">
          ...
          if($klasifikasi[0]['perpanjangan']=='1'){
            $data=$this->Bu_model->check_permohonan($nib,$tgl_perm);
          }else if($klasifikasi[0]['perpanjangan']=='0'){
            $data=$this->Bu_model->check_permohonan($nib,$tgl_perm);
          }else{
            $data=$this->Bu_model->check_permohonan_perubahan($klasifikasi[0]['id_izin'],$tgl_perm);
          }
          ;?>
...
$total_saham=0;
 ...
 <div class="row">
    <div class="col-1-5-table"><div class="center"><?=$row_smap02['no'];?></div></div>
    <div class="col-1-30-table"><div class="left"><?=$row_smap02['indikator'];?></div></div>
    <div class="col-1-5-table"><?php if(${"data_kelengkapan" . $id}=='1') :?><div class="center">&#10004; </div> <?php endif ;?></div>
    <div class="col-1-5-table"><?php if(${"data_kelengkapan" . $id}=='0') :?><div class="center">&#10004; </div> <?php endif ;?></div>
    <div class="col-1-5-table"><?php if(${"data_verifikasi" . $id}=='1') :?><div class="center">&#10004; </div> <?php endif ;?></div>
    <div class="col-1-5-table"><?php if(${"data_verifikasi" . $id}=='0') :?><div class="center">&#10004; </div> <?php endif ;?></div>
    <div class="col-1-5-table"><?php if(${"data_validasi" . $id}=='1') :?><div class="center">&#10004; </div> <?php endif ;?></div>
    <div class="col-1-5-table"><?php if(${"data_validasi" . $id}=='0') :?><div class="center">&#10004; </div> <?php endif ;?></div>
    <div class="col-1-20-table"><?= ${"data_keterangan" . $id} ;?></div>
  </div>
    <?php endforeach ;?>
  </section>
  ...
  <div class="row">
    ...
    <div class="col-1-60-table" style="border: 1px solid black;">
      <div class="left">
        <strong><?=$catatan_fsmap02[0]['catatan'];?></strong>
      </div>
    </div>
    ...
    <div class="col-1-20-table" style="border: 1px solid black;">
       <div class="center">
             <?php
        $tgl_penilaian=$catatan_fsmap02[0]['log'];
        $bulan =  date("m", strtotime($tgl_penilaian));
        $tanggal =  date("d", strtotime($tgl_penilaian));
        $tahun =  date("Y", strtotime($tgl_penilaian));
        ;?>
