        	...
        	<div class="card card-custom bg-gray-100 card-stretch gutter-b">
                            ...
                            <div class="col text-center bg-white px-6 py-8 rounded-xl mr-7 mb-7">
                                <?php if($status=="TRUE") :?>
                                    <h5>Sudah Dinilai</h5>
                                <?php endif; ?>
                             <a href="<?=base_url("sertifikasi/asesor_skema37/".$id1."/".encrypt_url($row_klasifikasi['id_sub_klasifikasi'])."/".$id3);?>" target="_blank" class="btn <?php if($status=='FALSE') :?> btn-light-dark<?php else :?>btn-light-info<?php endif ;?> font-weight-bold"><?=$row_klasifikasi['id_sub_klasifikasi'];?></a>
                            </div>
