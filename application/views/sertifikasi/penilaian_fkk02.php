			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('sertifikasi/fkk02/'.$nib_dec.'/'.$tgl_dec.'/'.$user_dec) ;?>"
							target="_blank" style="margin:5px;" class="btn btn-warning font-weight-bolder">
							<i class="flaticon2-chart"></i>FKK02</a>
											...
											<span class="switch switch-outline switch-icon switch-dark">
												...
												<label>
													<input type="checkbox" <?php if(!empty($ceklis_2)):?>
														...
														<?php else :?><?php endif ;?> <?php else :?> checked="checked"
														<?php endif ;?> id="checkbox_86" value="1"
														name="checkbox_86_2" />
													<span></span>
												</label>
											</span>
...
<?php echo form_open_multipart(base_url('sertifikasi/insert_penilaian_fkk02'), 'method="POST"');?>
 ...
 foreach($pemegang_saham as $row_saham){
      $total_saham+=$row_saham['modal_disetor'];
									...
									<section class="items">
										<table style="width:100%; border-collapse:collapse; font-family:Arial, sans-serif; font-size:13px;" border="1">
											<tr style="text-align:center; font-weight:bold;">
												<td colspan="6" style="padding:6px;">BADAN USAHA BERSIFAT SPESIALIS</td>
											</tr>
											<tr style="text-align:center; font-weight:bold;">
												<td rowspan="2" style="background:#fce9c8;">Modal Perusahaan</td>
												<td colspan="2" style="background:#fce9c8;">Dasar</td>
												<td colspan="2" style="background:#fce9c8;">Disetor</td>
												<td rowspan="2" style="background:#fce9c8;">%</td>
											</tr>
											<tr style="text-align:center; font-weight:bold;">
												<td style="background:#fce9c8;"></td>
												<td style="background:#fce9c8;">Rp.</td>
												<td style="background:#fce9c8;">Rp.</td>
												<td style="background:#fce9c8;"></td>
											</tr>
											<tr style="text-align:center; font-weight:bold;">
												<td style="background:#fce9c8;">Pemilik Saham</td>
												<td style="background:#fce9c8;">Jumlah</td>
												<td style="background:#fce9c8;">Nilai (Rp)</td>
												<td colspan="2" style="background:#fce9c8;">Total (Rp)</td>
												<td style="background:#fce9c8;">%</td>
											</tr>
												<?php
							  $count=0;
								if(!empty($penilaian_fkk02)){
									foreach($penilaian_fkk02 as $row_ceklis){
	 							  $count+=1;
	 							  for ($i=0; $i < count($penilaian_fkk02); $i++) {
	 							    if($row_ceklis['nik']==$penilaian_fkk02[$i]['nik']){
									  ...
									  ${"data_aset".$row_ceklis['nik']}=$row_ceklis['aset'];
	 							    }
	 							  }
	 							}
								}
							  ...
							  ;?>
											...
											<?php foreach($pemegang_saham as $row) :?>
										<?php $id_sahamx=$row['no_ktp'] ;?>
											...
											<tr>
												...
												<td style="text-align:center;">
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" name="<?=$id_sahamx;?>_jumlah" value="<?=${"data_jumlah" . $id_sahamx};?>" class="form-control"
															placeholder="Isian Asesor...">
												...
												<td style="text-align:right;">
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" name="<?=$id_sahamx;?>_nilai" value="<?=${"data_nilai" . $id_sahamx}?>" class="form-control"
															placeholder="Isian Asesor...">
												...
												<td colspan="2" style="text-align:right;">
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" name="<?=$id_sahamx;?>_total" value="<?=$row['modal_disetor'];?>" class="form-control"
															placeholder="Isian Asesor...">
												...
												<td style="text-align:center;">
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"name="<?=$id_sahamx;?>_persen"value="<?=${"data_persen" . $id_sahamx}?>"  class="form-control"
															placeholder="Isian Asesor...">
											...
											<tr style="font-weight:bold;">
												<td style="text-align:left;" colspan="6">Total saham</td>
											</tr>
											<!-- Total Ekuitas -->
											<tr style="font-weight:bold;">
												<td colspan="5">Total Aset : <div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" value="<?=${"data_aset" . $id_sahamx}?>" name="ekuitas"  class="form-control"
															placeholder="Isian Asesor...">


													</div></td>
												<td style="text-align:center;">Spesialis</td>
											</tr>
										</table>
									</section>
									...
									<section class="items">
										...
										<div class="row">
											<div class="col-1-40-table" colspan="2">
												<div class="center"><strong>Comment Penilaian Kesuaian Asesor</strong>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<textarea id="comment_res" name="catatan_fkk02"
													class="form-control form-control-solid" rows="5"
													placeholder="Catatan resuma...">
													<?php if(!empty($catatan_fkk02)): ?>
													<?= $catatan_fkk02[0]['catatan']; ?>
													<?php else :?>1.	Berdasarkan Ketentuan Keputusan DJBK No. ……………..
2.	SubKlasifikasi yang sudah dimiliki dan atau sedang dimohon sebanyak …….. (buah) dengan rincian Kode Subklasifikasi:
(data dari API atau web LPJK)
3.	Persyaratan Kemampuan keuangan : Rp ... (persyaratan kemampuan keuangan)
4.	Rekomendasi penilaian kemampuan keuangan: SESUAI / TIDAK SESUAI  (hapus yang tidak diperlukan)
<?php endif ;?>
</textarea>
												...
												<br>
								<br>
								<button type="submit" name="submit" style="float: right" class="open-delete btn btn-primary btn-labeled btn-rounded"><b><i class="icon-paperplane"></i></b> Submit Penilaian FKK02</button>
