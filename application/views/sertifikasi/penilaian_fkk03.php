			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('sertifikasi/fkk03/'.$nib_dec.'/'.$tgl_dec.'/'.$user_dec) ;?>"
							target="_blank" style="margin:5px;" class="btn btn-warning font-weight-bolder">
							<i class="flaticon2-chart"></i>FKK03</a>
...
<?php echo form_open_multipart(base_url('sertifikasi/insert_penilaian_fkk03'), 'method="POST"');?>
 ...
 foreach($pemegang_saham as $row_saham){
      $total_saham+=$row_saham['modal_disetor'];
									...
									<section class="items">
										<table style="width:100%; border-collapse:collapse; font-family:Arial, sans-serif; font-size:13px;" border="1">
											<tr style="text-align:center; font-weight:bold;">
												<td colspan="6" style="padding:6px;">BADAN USAHA BERSIFAT UMUM</td>
											</tr>
											<tr style="text-align:center; font-weight:bold;">
		...
		<input type="hidden" value="<?php echo $user_dec ;?>" name="id3">
											...
											<!-- Total Ekuitas -->
											<tr style="font-weight:bold;">
												<td colspan="5">Total Ekuitas : <div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" value="<?=${"data_ekuitas" . $id_sahamx}?>" name="ekuitas"  class="form-control"
															placeholder="Isian Asesor...">


													</div></td>
												<td style="text-align:center;"><?php if($klasifikasi[0]['Kualifikasi']=="K"){
													echo "Kecil";
									...
									<section class="items">
										...
										<div class="row">
											<div class="input-group file-caption-main">
												<span class="file-caption-icon"></span>
												<textarea id="comment_res" name="catatan_fkk03"
													class="form-control form-control-solid" rows="5"
													placeholder="Catatan resuma...">
													<?php if(!empty($catatan_fkk03)) :?>
														<?=$catatan_fkk03[0]['catatan'];?>
														<?php else :?>
Catatan :
1.	Berdasarkan Ketentuan Keputusan DJBK No. ……………..
...
<?php endif ;?>
												...
												<br>
								<br>
								<button type="submit" name="submit" style="float: right" class="open-delete btn btn-primary btn-labeled btn-rounded"><b><i class="icon-paperplane"></i></b> Submit Penilaian FKK03</button>
