...
<hr>
  <section class="items">
    <div class="center">
      FORMULIR PENILAIAN KEMAMPUAN KEUANGAN BADAN USAHA
  ...
  <b>Modal Perusahaan</b>
    <section class="items">
      ...
      <div class="row">
        <div class="col-1-5-table">
          <div class="center">
            Rp. <?= number_format(($neraca_asesor[0]['modal_dasar']), 2, '.', ',');?>
          </div>
        </div>

          <div class="col-1-5-table">
            <div class="center">
              Rp. <?= number_format(($neraca_asesor[0]['modal_disetor']), 2, '.', ',');?>
            </div>
          </div>
          <div class="col-1-10-table">
            <div class="center">
              <?=$neraca_asesor[0]['presentase'];?> %
            </div>
          </div>
        ...
        <?php foreach($pemegang_saham as $row_saham) :?>
          ...
          <div class="row">
            ...
            <div class="col-1-20-table">
                ...
                <?= $row_saham['nama_pemilik'] ;?>

            </div>
              <div class="col-1-20-table">

                  <?= $row_saham['jumlah_lembar'] ;?>

              </div>
              <div class="col-1-20-table">
                Rp. <?= number_format(($row_saham['nilai_perlembar']), 2, '.', ',');?>


              </div>
              <div class="col-1-20-table">
                Rp. <?= number_format((($row_saham['modal_disetor'])), 2, '.', ',');?>
              ...
              <div class="col-1-10-table">
                  ...
                  <?php
                  $saham_total=$row_saham['modal_disetor'];
                  echo round(($saham_total/$total_saham)*100,3);
                  ;?>
                  %
              </div>
...
<div class="row">
    ...
    <div class="col-1-40-table">
      <b>Rekomendasi Kelayakan Keuangan</b>
