    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex flex-column">
          <!--begin::Title-->
          <h2 class="text-white font-weight-bold my-2 mr-5">Invoice & Surat Perjanjian</h2>
          <!--end::Title-->
          <!--begin::Breadcrumb-->
          <div class="d-flex align-items-center font-weight-bold my-2">
            ...
            <!--begin::Item-->
            <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
            <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Biaya Permohonan</a>
            <!--end::Item-->
          </div>
          <!--end::Breadcrumb-->
        </div>
          ...
          <div class="col-md-9">
            <div class="row pb-26">
              <div class="col-md-4 border-right-md pr-md-10 py-md-10">
                ...
                <div class="text-dark-50 font-size-lg font-weight-bold mb-3">Biaya Pengajuan Permohonan</div>
                ...
                <br/></div>
								<hr>
								<span class="text-danger">Invoice dan Surat Perjanjian bisa diupload setelah melewati tahapan verifikasi & validasi</span>
              ...
              <div class="col-md-8 py-10 pl-md-10">
                ...
                <div class="list-group">
									...
									<a href="<?php echo base_url('sertifikasi/biaya/'.encrypt_url($row['tgl_permohonan'])) ;?>" class="list-group-item ">
								<div class="bg-primary rounded d-flex align-items-center justify-content-between text-white max-w-600px position-relative ml-auto p-7">
									...
									<div class="text-right d-flex flex-column">
										<span class="font-weight-boldest font-size-h4 line-height-sm"><?= $row['concat_klasifikasi'] ;?></span>
