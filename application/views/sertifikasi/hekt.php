...
<hr>
  <section class="items">
    <div class="center">
HEKT-01<br>
FORMULIR HASIL EVALUASI DAN REKOMENDASI KOMITE TEKNIS/TIM PEMUTUS
...
<section class="items">
  <!-- Header Baris 1 -->
    <div class="row">
      ...
      <div class="col-1-10-table" style="background-color: #2e64a7;color: #fff;" colspan="1"><div class="center">Keputusan Asesor 1</div></div>
      <?php if(count($asesor)==2) :?>
      <div class="col-1-10-table" style="background-color: #2e64a7;color: #fff;" colspan="1"><div class="center">Keputusan Asesor 2</div></div>

      <?php endif ;?>
      <div class="col-1-30-table" style="background-color: #2e64a7;color: #fff;" colspan="1"><div class="center">Hasil Penilaian Tim Teknis</div></div>
    ...
    <div class="row">
        ...
        <?php endif ;?>
        <div class="col-1-30-table"><div class="left"><b><?=$penilaian_hekt[0]['catatan_penjualan_tahunan']?></b></div></div>
       ...
       <div class="row">
        ...
        <?php if(count($asesor)==2) :?>
          ...
          echo "TIDAK MEMENUHI";
           ...
           <?php endif ;?>
                <div class="col-1-30-table"><div class="left"><b><?=$penilaian_hekt[0]['catatan_aset']?></b></div></div>
      ...
      <div class="row">
        ...
        <?php endif ;?>
                <div class="col-1-30-table"><div class="left"><b><?=$penilaian_hekt[0]['catatan_tk']?></b></div></div>
       ...
       <div class="row">
        ...
        <div class="col-1-10-table"><div class="center">MEMENUHI</div></div>
         <?php if(count($asesor)==2) :?>
          <div class="col-1-10-table"><div class="center">MEMENUHI</div></div>
        <?php endif ;?>
        <div class="col-1-30-table"><div class="left"><b><?=$penilaian_hekt[0]['catatan_peralatan']?></b></div></div>
      </div>
      <div class="row">
        <div class="col-1-5-table"><div class="center">A.</div></div>
     ...
     <div class="row">
        <div class="col-1-5-table"><div class="center">B.</div></div>
        <div class="col-1-30-table" ><div class="left">Komitemen: <b><?=$penilaian_hekt[0]['komitmen_sewa'];?></b></div></div>
        <div class="col-1-30-table"><div class="left"></div></div>
        <div class="col-1-10-table"><div class="center"></div></div>
        <?php if(count($asesor)==2) :?>
          <div class="col-1-10-table"><div class="center"></div></div>
       ...
       <div class="row">
        ...
        <?php if(count($asesor)==2) :?>
         ...
         <?php endif ;?>
                <div class="col-1-30-table"><div class="left"><b><?=$penilaian_hekt[0]['catatan_smap']?></b></div></div>
 ...
 <section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-20-table" style="border: 1px solid black;">
      <div class="left">
        <strong><?=$penilaian_hekt[0]['comment'];?></strong>
      </div>
    </div>
