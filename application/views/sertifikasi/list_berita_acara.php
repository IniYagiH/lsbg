          ...
          <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
            <thead>
              ...
              <tr>
                ...
                <th>Tgl_Status_31</th>
                <th>Penunjukan Pemutus</th>
                <th>Penilaian Pemutus</th>
                <th>Daftar Asesor</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?=$row['tgl_biaya'];?></td>
                <td><?=$row['id_pemutus_penunjukan'];?></td>
                <td><?=$row['id_pemutus_penilaian'];?></td>
                <td><?=$row['asesor'];?></td>
		...
		<div class="modal-content">
          ...
          <div class="form-group row">
            <div class="col-lg-4">
                ...
                <input type="text" readonly id="teknis_1" name="teknis_1" class="form-control" placeholder="Nama...">

            </div>
            <div class="col-lg-4">
                <label class="control-label">Pemutus 2 <span class="text-danger"></span></label>
                <input type="text" readonly id="teknis_2" name="teknis_2" class="form-control" placeholder="Nama...">

            </div>
            <div class="col-lg-4">
                <label class="control-label">Pemutus 3 <span class="text-danger"></span></label>
                <input type="text" readonly id="teknis_3" name="teknis_3" class="form-control" placeholder="Nama...">
...
$("#proses_data").click(function () {
  ...
  counter1=0;
    ...
    jQuery.ajax({
      url : "<?= base_url('sertifikasi/get_subklasi2x')?>",
      type : "POST",
      data : {nib:sub,
        ...
        var counter=1;
        var nama_komtek=response.komite;
        console.log(response);
        document.getElementById("teknis_1").value=nama_komtek[0].Nama;
        document.getElementById("teknis_2").value=nama_komtek[1].Nama;
        document.getElementById("teknis_3").value=nama_komtek[2].Nama;
        ...
        if(typeof array != "undefined" && array != null && array.length != null && array.length > 0){
          array.forEach(function(element) {
            ...
            cell5.innerHTML = '<select name="keuangan'+element.id_sub_klasifikasi+'" class="form-control" required="required"><option value="1">Terpenuhi</option><option value="0">Belum Terpenuhi</option></select>';
