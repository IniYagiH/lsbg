			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-dark">List Asesor</a>
						</li>
      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Permohonan Asesment Asesor
            <span class="d-block text-muted pt-2 font-size-sm">Daftar Keseluruhan Permohonan Untuk Dilakukan Asesment Asesor</span></h3>
          </div>
                ...
                <td>
                  <div class="dropdown dropdown-inline">
                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown">
                      ...
                      -->
                        <li class="nav-item"><a class="nav-link" target="_blank"href="<?= base_url("sertifikasi/asesor_new/".encrypt_url($row['NIB']).'/'.encrypt_url($row['tgl_permohonan'])) ;?>"><i class="nav-icon la la-leaf"></i><span class="nav-text">Lembar Kerja Asesor</span></a></li>
                    </ul>
                      </div>
                  </div>
                  <!--
          ...
          <div class="table-responsive">
            <table class="table table-lg">
              ...
              <tbody>
                ...
                <tr>
                  <td>Evaluator / Pemutus 1</td>
                  <td>


                  <div class="form-group">
                        <select id="teknis_1" name="teknis_1" class="form-control">
                          <?php foreach ($pemutus as $row) :?>
                ...
                <tr>
                  ...
                  <div class="form-group">
                          <select id="teknis_2" name="teknis_2" class="form-control">
                            <?php foreach ($pemutus as $row) :?>
                            <option value="<?php echo $row['Nama'];?>"><?php echo $row['Nama'];?></option>
                            <?php endforeach ;?>
                          </select>
                ...
                <tr>
                  ...
                  <div class="form-group">
                    ...
                    <select id="teknis_3" name="teknis_3" class="form-control">
                          <?php foreach ($pemutus as $row) :?>
                            <option value="<?php echo $row['Nama'];?>"><?php echo $row['Nama'];?></option>
                            <?php endforeach ;?>
                          </select>
...
$("#submit").click(function () {
  ...
  var pemutus1_value=document.querySelector('#teknis_1').value;
  var pemutus2_value=document.querySelector('#teknis_2').value;
  var pemutus3_value=document.querySelector('#teknis_3').value;
  console.log(cek11);
  console.log(cek22);
  $.ajax({
      ...
      data : {asesor1 : asesor1_value,
              ...
              status : status_value,
            pemutus1 : pemutus1_value,
          pemutus2 : pemutus2_value,
        pemutus3 : pemutus3_value},
      success : function(data) {
        response = jQuery.parseJSON(data);
        record=response.record;
       // console.log( JSON.parse(data) );
