    ...
    <div class="container">
			<div class="card card-custom gutter-b">
				...
				<div class="card-body">
					...
					<div class="row">
							...
							<div class="card card-custom bgi-no-repeat gutter-b" style="height: 100px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 75% auto; background-image: url(<?=base_url();?>assets/media/svg/patterns/taieri.svg)">
								...
								<div class="card-body d-flex align-items-center">
									<div>
										...
										<h3 class="text-white font-weight-bolder line-height-lg mb-5">Checking PJT & PJSK</h3>
						...
						<div class="input-group file-caption-main">
							...
							<input type="text" name="copy" id="copy" value="<?= base_url('sertifikasi/biaya_sertifikasi/'.$nib_dec."/".$tgl_dec) ;?>" class="form-control" readonly>


						<div class="input-group-btn input-group-append">
							<button type="button" onclick="copy()" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Copy Link Pembayaran</span></button>
								</div>
						</div>
						</div>
					</div>
							...
							<ul class="nav nav-pills" id="myTab1" role="tablist">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a class="dropdown-item" data-toggle="tab" href="#kepemilikan_peralatan">Kepemilikan Peralatan</a>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_80" value="1" name="checkbox_80" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_80" name="comment_80"   class="form-control"  placeholder="Comment...">


														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get80()" id="get_80" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
														</div>
													</div>
												</div>
										</div>
										...
										<div class="table-responsive">
											...
											<table class="table table-lg">
												...
												<tbody>
													<tr>
														<td>SPTJM</td>
														<td><a <?php if($biodata[0]['sptjm']!='') :?>href="<?= $biodata[0]['sptjm'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_11"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
</td>

													</tr>
													<tr>
														<td>Nama Badan Usaha</td>
														<td><span class="text-dark"><?php echo $biodata[0]['nama'] ;?></span></td>

													</tr>
													<tr>
														<td>NIB</td>
														<td><span class="text-dark"><?php echo $biodata[0]['NIB'] ;?></span></td>

													</tr>
													<tr>
														<td>NPWP</td>
														<td><span class="text-dark"><?php echo $biodata[0]['npwp'] ;?></span></td>

													</tr>
													<tr>
														<td>Bentuk Usaha</td>
														<td><span class="text-dark"><?php echo $biodata[0]['bentuk_usaha'] ;?></span></td>

													</tr>

													<tr>
														<td>Klasifikasi Jenis Usaha</td>
														<td><span class="text-dark"><?php echo $biodata[0]['jenis_usaha'] ;?></span></td>
													</tr>
													<tr>
														<td>Alamat Domisili Hukum</td>
														<td><span class="text-dark"><?php echo $biodata[0]['alamat_bu'] ;?></span></td>
													</tr>
													...
													<tr>
														<tr>
															<td>Propinsi</td>
															<td><span class="text-dark"><?php echo $biodata[0]['id_propinsi'] ;?></span></td>
														</tr>
														<tr>
														<td>Kabupaten/Kota</td>
														<td><span class="text-dark"><?php echo $biodata[0]['id_kabupaten'] ;?></span></td>
													</tr>
													<tr>
														<td>Telepon</td>
														<td><span class="text-dark"><?php echo $biodata[0]['telepon'] ;?></span></td>
													</tr>
													<tr>
														<td>Hp</td>
														<td><span class="text-dark"><?php echo $biodata[0]['hp'] ;?></span></td>
													</tr>

													<tr>
														<td>Kodepos</td>
														<td><span class="text-dark"><?php echo $biodata[0]['kodepos'] ;?></span></td>
													</tr>
													<tr>
														<td>Email</td>
														<td><span class="text-dark"><?php echo $biodata[0]['email'] ;?></span></td>
													</tr>
													...
													<tr>
														<td>Website</td>
														<td><span class="text-dark"><?php echo $biodata[0]['web'] ;?></span></td>
													</tr>
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-lg">
                        ...
                        <tbody>
													<tr>
														<td>SPTJM</td>
														<td><a <?php if($biodata_perubahan[0]['sptjm']!='') :?>href="<?= $biodata_perubahan[0]['sptjm'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_11"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
</td>

													</tr>
                          <tr>
                            <td>Nama Badan Usaha</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['nama'] ;?></span></td>

                          </tr>
                          <tr>
                            <td>NIB</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['NIB'] ;?></span></td>

                          </tr>
                          <tr>
                            <td>NPWP</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['npwp'] ;?></span></td>

                          </tr>
                          <tr>
                            <td>Bentuk Usaha</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['bentuk_usaha'] ;?></span></td>

                          </tr>

                          <tr>
                            <td>Klasifikasi Jenis Usaha</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['jenis_usaha'] ;?></span></td>
                          </tr>
                          <tr>
                            <td>Alamat Domisili Hukum</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['alamat_bu'] ;?></span></td>
                          </tr>
                          ...
                          <tr>
                            <tr>
                              <td>Propinsi</td>
                              <td><span class="text-dark"><?php echo $biodata_perubahan[0]['id_propinsi'] ;?></span></td>
                            </tr>
                            <tr>
                            <td>Kabupaten/Kota</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['id_kabupaten'] ;?></span></td>
                          </tr>
                          <tr>
                            <td>Telepon</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['telepon'] ;?></span></td>
                          </tr>
                          <tr>
                            <td>Hp</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['hp'] ;?></span></td>
                          </tr>

                          <tr>
                            <td>Kodepos</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['kodepos'] ;?></span></td>
                          </tr>
                          <tr>
                            <td>Email</td>
                            <td><span class="text-dark"><?php echo $biodata_perubahan[0]['email'] ;?></span></td>
                          </tr>
                          <input type="hidden" name="email" value="<?=$klasifikasi[0]['user_email'] ;?>" >
												...
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a <?php if($smm[0]['file_surat_pernyataan']!='') :?>href="<?= $smm[0]['file_surat_pernyataan'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_11"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get4()" id="get_4"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
														<div class="row">
															...
															<div class="col-md-1">
																...
																<span class="switch switch-outline switch-icon switch-primary">
																	...
																	<label>
																		<input type="checkbox" checked="checked" id="checkbox_30" value="1" onclick="javascript:checkbox30()" name="checkbox_30" />
																		<span></span>
																	</label>
																</span>
															...
															<div class="col-md-2">
																...
																<div class="col-md-6">
																	...
																	<div class="input-group file-caption-main">
																		<span class="file-caption-icon"></span>
																		<input type="text" id="comment_30" name="comment_30"   class="form-control" disabled="disabled" placeholder="Comment...">


																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get30()" id="get_30"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
														<div class="row">
															...
															<div class="col-md-1">
																...
																<span class="switch switch-outline switch-icon switch-primary">
																	...
																	<label>
																		<input type="checkbox" checked="checked" id="checkbox_31" value="1" onclick="javascript:checkbox31()" name="checkbox_31" />
																		<span></span>
																	</label>
																</span>
															...
															<div class="col-md-2">
																<br>
																<a <?php if($smm[0]['sertifikat_iso']!='') :?>href="<?= $smm[0]['sertifikat_iso'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_31"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																		<span class="file-caption-icon"></span>
																		<input type="text" id="comment_31" name="comment_31"   class="form-control" disabled="disabled" placeholder="Comment...">


																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get31()" id="get_31"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_79" value="1" name="checkbox_79" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_79" name="comment_79"   class="form-control"  placeholder="Comment...">


														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get79()" id="get_79" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
											...
											<table class="table table-lg">
												...
												<tbody>
													<tr>
														...
														<td><span class="text-dark"><?php echo $smm[0]['nomor_sertifikat'] ;?></span></td>

													</tr>
													<tr>
														<td>Tipe Dokumen SMM </td>
														<td><span class="text-dark"><?php echo $smm[0]['dokumen_smm'] ;?></span></td>
												...
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a <?php if($smap[0]['file_surat_pernyataan']!='') :?>href="<?= $smap[0]['file_surat_pernyataan'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get5()" id="get_5"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a <?php if($smap[0]['sertifikat_iso']!='') :?>href="<?= $smap[0]['sertifikat_iso'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get34()" id="get_34"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a <?php if($smap[0]['file_surat_pernyataan']!='') :?>href="<?= $smap[0]['file_surat_pernyataan'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_35"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get35()" id="get_35"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_78" value="1" name="checkbox_smap" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_78" name="comment_78"   class="form-control"  placeholder="Comment...">


														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get78()" id="get_78"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
										...
										<div class="table-responsive">
											...
											<table class="table table-lg">
												...
												<tbody>
													<tr>
														<td>Nomor Sertifikat</td>
														<td><span class="text-dark"><?php echo $smap[0]['nomor_sertifikat'] ;?></span></td>

													</tr>
													<tr>
														<td>Tipe Dokumen SMAP</td>
														<td><span class="text-dark"><?php echo $smap[0]['persyaratan_smap'] ;?></span></td>
											...
											<div class="col-md-6">
												<div class="table-responsive">
													...
													<table class="table table-lg">
														...
														<tr>
															<td>File SMAP </td>
															<td><a href="<?=$smap_perubahan[0]['file_surat_pernyataan'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
</td>
														</tr>
															<tr>
																<td>Nomor Sertifikat</td>
																<td><span class="text-dark"><?php echo $smap_perubahan[0]['nomor_sertifikat'] ;?></span></td>
		
															</tr>
															<tr>
																<td>Tipe Dokumen SMAP</td>
																<td><span class="text-dark"><?php echo $smap_perubahan[0]['persyaratan_smap'] ;?></span></td>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_81" value="1" name="checkbox_81" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_81" name="comment_81"  class="form-control"  placeholder="Comment...">

														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get81()" id="get_81" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
              ...
              <div class="accordion accordion-toggle-arrow" id="accordionExample1">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title collapsed" data-toggle="collapse" data-target="#data-pengurus-perubahan-<?php echo $counter_pengurus ;?>">
                          <?= $row_pengurus['nama'] ?>
                        </div>
                    </div>
                    <div id="data-pengurus-perubahan-<?php echo $counter_pengurus ;?>" class="collapse show" data-parent="#accordionExample1">
                        <div class="card-body">
            ...
            <?php endif ;?>
											...
											<div class="col-md-4">
												<br>
													...
													<div class="form-group">
															...
															<select name="nama_paket" id="nomor_kontrak_pengalaman" class="form-control">
																<?php foreach ($penjualan_tahunan as $row_pengalaman2) :?>
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<div class="col-md-8">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get24()" id="get_24"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
														</div>
												</div>
											</div>
									</div>
									<div class="row">
										...
										<div class="col-md-1">
											...
											<span class="switch switch-outline switch-icon switch-primary">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_25" value="1" onclick="javascript:checkbox25()" name="checkbox_25" />
													<span></span>
												</label>
											</span>
											...
											<div class="col-md-8">
												...
												<div class="input-group file-caption-main">
													<span class="file-caption-icon"></span>
													<input type="text" id="comment_25" name="comment_25"   class="form-control" disabled="disabled" placeholder="Comment...">


												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get25()" id="get_25"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
														</div>
												</div>
											</div>
									</div>
									<input type="hidden" id="id_izin_dex" name="id_izin_dex" value="<?php echo $id_izin ;?>">
									...
									<div class="row">
										...
										<div class="col-md-1">
											...
											<div class="col-md-8">
												...
												<div class="input-group-btn input-group-append">
													<button type="button" onclick="javascript:get26()" id="get_26"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
														</div>
												</div>
											</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-md-2">
											...
											<span class="switch switch-outline switch-icon switch-danger">
												...
												<label>
													<input type="checkbox" checked="checked" id="checkbox_82" value="1" name="checkbox_82" />
													<span></span>
												</label>
											</span>
											...
											<div class="col-md-8">
												...
												<div class="input-group file-caption-main">
													<span class="file-caption-icon"></span>
													<input type="text"  id="comment_82" name="comment_82"  class="form-control"  placeholder="Comment...">
													<div class="input-group-btn input-group-append">
														<button type="button" onclick="javascript:get82()" id="get_82"  class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
															</div>
												</div>
											</div>
									</div>
															...
															<div class="table-responsive">
																...
																<table class="table table-lg">
																	...
																	<tbody>
																		...
																		<tr>
																			<td>Nilai Kontrak</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nilai_kontrak'] ;?></span></td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			...
																			<td><span class="text-dark"><?php echo $row_pengalaman['nilai_kontrak_adendum'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Nilai Kontrak Sesuai Porsi</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nilai_kontrak_sesuai_porsi'] ;?></span></td>
																		</tr>
																		<tr>
              ...
              <div class="accordion accordion-toggle-arrow" id="accordionExample1">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title collapsed" data-toggle="collapse" data-target="#data-pengalaman-perubahan-<?php echo $counter_pengalaman ;?>">
                          <?php echo $row_pengalaman['id_sub_klasifikasi'].'-'.$row_pengalaman['nama_pengalaman'] ;?>
                        </div>
                    </div>
                    <div id="data-pengalaman-perubahan-<?php echo $counter_pengalaman ;?>" class="collapse show" data-parent="#accordionExample1">
          ...
          <?php endif ;?>
								...
								<div class="tab-pane fade" id="akte" role="tabpanel" aria-labelledby="home-tab-1">
														...
														<div class="col-md-5">
															...
															<div class="col-md-7">
																...
																<div class="form-group">
																		...
																		<select name="tahun" id="no_akte_pilihan" class="form-control">
																			<?php foreach ($akte as $row_akte) :?>
																				 <option value="<?php echo $row_akte['no'] ;?>"><?php echo $row_akte['no'] ;?></option>
																			<?php endforeach ;?>
																		 </select>
																		 <footer class="blockquote-footer">
																			 Pilih No Akte
													...
													<div class="row">
														...
														<div class="col-md-1">
															...
															<div class="col-md-8">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get11()" id="get_11"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
										...
										<div class="row">
											<div class="col-md-2">
												<div class="content-group-lg">
													<h6 class="text-semibold"><span class="text-danger">#CEKLIS</span></h6>
													<p class="content-group"><span class="text-danger">Akte</span></p>
												</div>
											</div>
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_83" value="1" name="checkbox_83" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_83" name="comment_83"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get83()" id="get_83" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
																...
																<div class="table-responsive">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				<td>Modal Dasar</td>
																				<td><span class="text-dark"><?=$row_akte['modaldasar'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Modal Disetor</td>
																				<td><span class="text-dark"><?=$row_akte['modalsetor'] ;?></span></td>
																			</tr>
																			<tr>
            ...
            <div class="accordion accordion-toggle-arrow" id="accordionExample1">
              ...
              <div class="card">
                  <div class="card-header">
                      <div class="card-title collapsed" data-toggle="collapse" data-target="#data-akte-perubahan-<?php echo $counter_akte ;?>">
                        <?php echo $row_akte['no'] ;?>
                      </div>
                  </div>
                  <div id="data-akte-perubahan-<?php echo $counter_akte ;?>" class="collapse show" data-parent="#accordionExample1">
            ...
            <?php endforeach;?>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_86" value="1" name="checkbox_86" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_86" name="comment_86"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get86()" id="get_86"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
                        ...
                        <div class="col-md-6">
													...
													<div id="data-saham-<?php echo $counter_saham ;?>" class="collapse show" data-parent="#accordionExample1">
															...
															<div class="card-body">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_saham['persyaratan_ktp']!='') :?>href="<?= $row_saham['persyaratan_ktp'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_36"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="col-md-4">
																	<br>
																	<a <?php if($row_saham['persyaratan_npwp']!='') :?>href="<?= $row_saham['persyaratan_npwp'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_36"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																</div>
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_saham['persyaratan_doc']!='') :?>href="<?= $row_saham['persyaratan_doc'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_36"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="table-responsive">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				<td>Modal Dasar</td>
																				<td><span class="text-dark"><?php echo $row_saham['modal_dasar'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Modal Disetor</td>
																				<td><span class="text-dark"><?php echo $row_saham['modal_disetor'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>No Akte</td>
									...
									<div class="accordion accordion-toggle-arrow" id="accordionExample1">
										...
										<div class="card">
												<div class="card-header">
														<div class="card-title collapsed" data-toggle="collapse" data-target="#data-saham-perubahan-<?php echo $counter_saham ;?>">
															<?php echo $row_saham['nama_pemilik'] ;?>
														</div>
												</div>
												<div id="data-saham-perubahan-<?php echo $counter_saham ;?>" class="collapse show" data-parent="#accordionExample1">
													...
													<div class="row">
														...
														<div class="col-md-1">
															...
															<div class="col-md-8">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get16()" id="get_16"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
													<div class="row">
														...
														<div class="col-md-1">
															...
															<div class="col-md-8">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get17()" id="get_17"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_87" value="1" name="checkbox_87" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_87" name="comment_87"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get87()" id="get_87"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
																...
																<div class="table-responsive">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				<td>Aktiva Lancar</td>
																				<td><span class="text-dark"><?=$row_neraca['aktiva_lancar'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Aktiva Tidak Lancar</td>
																				<td><span class="text-dark"><?=$row_neraca['aktiva_tdk_lancar'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Aktiva Lain-lain</td>
																				<td><span class="text-dark"><?=$row_neraca['aktiva_lain_lain'] ;?></span></td>
																			</tr>

																			<tr>
																				<td>Kewajiban lancar</td>
																				<td><span class="text-dark"><?=$row_neraca['kewajiban_lancar'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Kewajiban tidak lancar</td>
																				<td><span class="text-dark"><?=$row_neraca['kewajiban_tdk_lancar'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Ekuitas</td>
																				<td><span class="text-dark"><?=$row_neraca['total_ekuitas'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Total Modal</td>
																				<td><span class="text-dark"><?=$row_neraca['total_modal'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Total Kewajiban Ekuitas</td>
																				<td><span class="text-dark"><?=$row_neraca['total_kewajiban_ekuitas'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Total Kewajiban</td>
																				<td><span class="text-dark"><?=$row_neraca['total_kewajiban'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Total Aset</td>
																				<td><span class="text-dark"><?=$row_neraca['total_aset'] ;?></span></td>
																			</tr>
							...
							<div class="accordion accordion-toggle-arrow" id="accordionExample1">
								...
								<div class="card">
										<div class="card-header">
												<div class="card-title collapsed" data-toggle="collapse" data-target="#data-neraca-perubahan-<?php echo $counter_neraca ;?>">
													<?php echo $row_neraca['Tahun'] ;?>
												</div>
										</div>
										<div id="data-neraca-perubahan-<?php echo $counter_neraca ;?>" class="collapse show" data-parent="#accordionExample1">
												...
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a href="<?=$pjbu[0]['foto'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get_20()" id="get_20"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_85" value="1" name="checkbox_85" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_85" name="comment_85"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get85()" id="get_85"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
                        ...
                        <div class="col-md-6">
											<div class="table-responsive">
												...
												<table class="table table-lg">
													...
													<tbody>
														<tr>
															<td>Foto</td>
															<td><a href="<?=$pjbu[0]['foto'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
</td>
														</tr>
														<tr>
															<td>Nama</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['nama'] ;?></span></td>
														</tr>
														<tr>
															<td>Jabatan</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['jabatan'] ;?></span></td>
														</tr>
														<tr>
															<td>Alamat</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['alamat'] ;?></span></td>
														</tr>
														<tr>
															<td>Email</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['email'] ;?></span></td>
														</tr>
														<tr>
															<td>HP</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['hp'] ;?></span></td>
														</tr>
														<tr>
															<td>NIK</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['nik'] ;?></span></td>
														</tr>
														<tr>
															<td>NPWP</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['npwp'] ;?></span></td>
														</tr>
														<tr>
															<td>STK</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['stk'] ;?></span></td>
														</tr>
														<tr>
															<td>Tgl Lahir</td>
															<td><span class="text-dark"><?php echo $pjbu[0]['tgl_lahir'] ;?></span></td>
														</tr>
									...
									<div class="table-responsive">
										...
										<table class="table table-lg">
											...
											<tbody>
												<tr>
													<td>Foto</td>
													<td><a href="<?=$pjbu_perubahan[0]['foto'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
</td>
												</tr>
												<tr>
													<td>Nama</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['nama'] ;?></span></td>
												</tr>
												<tr>
													<td>Jabatan</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['jabatan'] ;?></span></td>
												</tr>
												<tr>
													<td>Alamat</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['alamat'] ;?></span></td>
												</tr>
												<tr>
													<td>Email</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['email'] ;?></span></td>
												</tr>
												<tr>
													<td>HP</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['hp'] ;?></span></td>
												</tr>
												<tr>
													<td>NIK</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['nik'] ;?></span></td>
												</tr>
												<tr>
													<td>NPWP</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['npwp'] ;?></span></td>
												</tr>
												<tr>
													<td>STK</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['stk'] ;?></span></td>
												</tr>
												<tr>
													<td>Tgl Lahir</td>
													<td><span class="text-dark"><?php echo $pjbu_perubahan[0]['tgl_lahir'] ;?></span></td>
												</tr>
								...
								<div class="tab-pane fade" id="pjtbu" role="tabpanel" aria-labelledby="home-tab-1">
										...
										<div class="row">
											...
											<div class="col-md-2">
												<font class="text-semibold" style="font-size: 12px;">Tidak/Lenkap</font>
												<span class="switch switch-outline switch-icon switch-danger">

													<label>
														<input type="checkbox" checked="checked" id="checkbox_88" value="1" name="checkbox_88" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_88" name="comment_88"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get88()" id="get_88"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
                        ...
                        <div class="col-md-6">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				...
																				<td><span class="text-dark"><?php echo $row_pjtbu['klasifikasi_skk'] ?></span></td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				<td>Alamat</td>
																				<td><span class="text-dark"><?php echo $row_pjtbu['alamat'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Noreg SKK</td>
																			...
																			<tr>
																				<td>Klasifikasi</td>
																				<td><span class="text-dark"><?php echo $row_pjtbu['klasifikasi'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Sub Klasifikasi</td>
																				<td><span class="text-dark"><?php echo $row_pjtbu['sub_klasifikasi'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>NIK</td>
								...
								<div class="accordion accordion-toggle-arrow" id="accordionExample1">
									...
									<div class="card">
											<div class="card-header">
													<div class="card-title collapsed" data-toggle="collapse" data-target="#data-pjtbu-perubahan-<?php echo $counter_pjtbu ;?>">
														<?= $row_pjtbu['sub_klasifikasi'].' - '.$row_pjtbu['nama'] ?>
													</div>
											</div>
											<div id="data-pjtbu-perubahan-<?php echo $counter_pjtbu ;?>" class="collapse show" data-parent="#accordionExample1">
													<div class="card-body">
								...
								<div class="tab-pane fade" id="pjskbu" role="tabpanel" aria-labelledby="profile-tab-1">
										...
										<div class="row">
											...
											<div class="col-md-2">
												<font class="text-semibold" style="font-size: 11px;">Tidak/Lengkap</font>
												<span class="switch switch-outline switch-icon switch-danger">

													<label>
														<input type="checkbox" checked="checked" id="checkbox_77" value="1" name="checkbox_77" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_77" name="comment_77"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get77()" id="get_77"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
                        ...
                        <div class="col-md-6">
																...
																class="open-delete btn btn-dark btn-labeled btn-rounded"><b><i
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				<td>Klasifikasi</td>
																				<td><span class="text-dark"><?php echo $row_pjskbu['klasifikasi'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Sub Klasifikasi</td>
																				<td><span class="text-dark"><?php echo $row_pjskbu['sub_klasifikasi'] ?></span></td>
																			</tr>

																			<tr>
																				<td>Jenis Tenaga Kerja</td>
																				<td><span class="text-dark"><?php echo $row_pjskbu['jenis_tenaga'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Jenjang SKK</td>
																			...
																			<tr>
																				...
																				<td><span class="text-dark"><?php echo $row_pjskbu['klasifikasi_skk'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Kualifikasi SKK</td>
								...
								<div class="accordion accordion-toggle-arrow" id="accordionExample1">
									...
									<div class="card">
											<div class="card-header">
													<div class="card-title collapsed" data-toggle="collapse" data-target="#data-pjskbu-perubahan-<?php echo $counter_pjskbu ;?>">
														<?= $row_pjskbu['id_sub_klasifikasi_pjsk'].' - '.$row_pjskbu['nama'] ?>
													</div>
											</div>
											<div id="data-pjskbu-perubahan-<?php echo $counter_pjskbu ;?>" class="collapse show" data-parent="#accordionExample1">
													<div class="card-body">
								...
								<div class="tab-pane fade" id="peralatan" role="tabpanel" aria-labelledby="profile-tab-1">
											...
											<div class="col-md-4">
												...
												<div class="col-md-8">
													<br>
														...
														<div class="form-group">
																<select name="nama_peralatan" id="id_peralatan" class="form-control">
																	<?php foreach ($peralatan as $row_peralatan) :?>
																		 <option data-text="<?php echo $row_peralatan['jenis_peralatan'] ;?>" value="<?php echo $row_peralatan['jenis_peralatan'] ;?>"><?php echo $row_peralatan['jenis_peralatan'] ;?></option>
																	<?php endforeach ;?>
																 </select>
																 <input type="hidden" id="nama_peralatan" >
																 <footer class="blockquote-footer">
										...
										<div class="row">
											...
											<div class="col-md-1">
												...
												<div class="col-md-8">
													...
													<div class="input-group-btn input-group-append">
														<button type="button" onclick="javascript:get21()" id="get_21"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
															</div>
													</div>
												</div>
										</div>
										<div class="row">
											...
											<div class="col-md-1">
												...
												<div class="col-md-8">
													...
													<div class="input-group-btn input-group-append">
														<button type="button" onclick="javascript:get27()" id="get_27"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
															</div>
													</div>
												</div>
										</div>
										<div class="row">
											...
											<div class="col-md-1">
												...
												<div class="col-md-8">
													...
													<div class="input-group-btn input-group-append">
														<button type="button" onclick="javascript:get28()" id="get_28"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
															</div>
													</div>
												</div>
										</div>
										<div class="row">
											...
											<div class="col-md-1">
												...
												<span class="switch switch-outline switch-icon switch-primary">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_29" value="1" onclick="javascript:checkbox29()" name="checkbox_29" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" id="comment_29" name="comment_29"   class="form-control" disabled="disabled" placeholder="Comment...">


													<div class="input-group-btn input-group-append">
														<button type="button" onclick="javascript:get29()" id="get_29"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
															</div>
													</div>
												</div>
										</div>
										<div class="row">
											...
											<div class="col-md-1">
												...
												<div class="col-md-8">
													...
													<div class="input-group-btn input-group-append">
														<button type="button" onclick="javascript:get36()" id="get_36"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
															</div>
													</div>
												</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_89" value="1" name="checkbox_89" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_89" name="comment_89"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get89()" id="get_89"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
										...
										<div class="accordion accordion-toggle-arrow" id="accordionExample1">
											...
											<div class="card">
													<div class="card-header">
															<div class="card-title collapsed" data-toggle="collapse" data-target="#data-peralatan-<?php echo $counter_peralatan ;?>">
																<?= $row_peralatan['sub_klasifikasi'].' - '.$row_peralatan['jenis_peralatan'] ?>
															</div>
													</div>
													<div id="data-peralatan-<?php echo $counter_peralatan ;?>" class="collapse show" data-parent="#accordionExample1">
															<div class="card-body">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_peralatan['kepemilikan_peralatan']!='') :?>href="<?= $row_peralatan['kepemilikan_peralatan'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_14"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	<div class="col-md-2">
																		<div class="content-group-lg">
																			<h6 class="text-semibold">#2</h6>
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_peralatan['foto_plat_nama']!='') :?>href="<?= $row_peralatan['foto_plat_nama'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_14"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_peralatan['foto_tampak_depan_peralatan']!='') :?>href="<?= $row_peralatan['foto_tampak_depan_peralatan'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_14"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	<div class="col-md-2">
																		<div class="content-group-lg">
																			<h6 class="text-semibold">#4</h6>
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_peralatan['foto_tampak_samping_peralatan']!='') :?>href="<?= $row_peralatan['foto_tampak_samping_peralatan'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_14"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_peralatan['hasil_pemeriksaan_pengujian']!='') :?>href="<?= $row_peralatan['hasil_pemeriksaan_pengujian'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_14"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			<tr>
																				...
																				<td><span class="text-dark"><?php echo $row_peralatan['jenis_peralatan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Hasil Pemeriksaan Pengujian</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['hasil_pemeriksaan_pengujian'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Jenis Bukti Kepemilikan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['jenis_bukti_kepemilikan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Kab Kota</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['kab_kota'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Kapasitas Hasil Uji</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['kapasitas_hasil_uji'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Model Type</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['model_type'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Memiliki Peralatan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['memiliki_peralatan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Nomor Registrasi Peralatan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['nomor_registrasi_peralatan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Provinsi</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['provinsi'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Sub Varian</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['subvarian'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Tahun Pembuatan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['tahun_pembuatan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Unit Satuan Kapasitas</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['unit_satuan_kapasitas'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Tipe Peralatan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['tipe_peralatan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Tahun Pembuatan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['tahun_pembuatan'] ?></span></td>
																			...
																			<tr>
																				<td>Kapasitas</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['kapasitas'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Kondisi</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['kondisi'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Harga</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['harga'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Merek</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['merek'] ?></span></td>
																			</tr>
																			<tr>
																				<td>SEQ</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['seq'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Lokasi</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['lokasi'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Kepemilikan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['kepemilikan_peralatan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Keterangan</td>
																				<td><span class="text-dark"><?php echo $row_peralatan['keterangan'] ?></span></td>
																			</tr>
								...
								<div class="tab-pane fade" id="kepemilikan_peralatan" role="tabpanel" aria-labelledby="profile-tab-1">
										...
										<div class="row">
											...
											<div class="col-md-1">
												...
												<div class="col-md-8">
													...
													<div class="input-group-btn input-group-append">
														<button type="button" onclick="javascript:get37()" id="get_37"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
															</div>
													</div>
												</div>
										</div>
										...
										<div class="accordion accordion-toggle-arrow" id="accordionExample1">
											...
											<div class="card">
													<div class="card-header">
															<div class="card-title collapsed" data-toggle="collapse" data-target="#data-peralatan-<?php echo $counter_kepemilikan_peralatan ;?>">
																<?= $row_kepemilikan_peralatan['sub_klasifikasi'] ?>
															</div>
													</div>
													<div id="data-peralatan-<?php echo $counter_kepemilikan_peralatan ;?>" class="collapse show" data-parent="#accordionExample1">
															<div class="card-body">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a <?php if($row_kepemilikan_peralatan['surat_pernyataan']!='') :?>href="<?= $row_kepemilikan_peralatan['surat_pernyataan'] ;?>"<?php else :?>href="<?= base_url('not_found') ;?>"<?php endif ;?> target="_blank" type="button" name="btn_cek_14"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			<tr>
																				...
																				<td><span class="text-dark"><?php echo $row_kepemilikan_peralatan['memiliki_peralatan'] ?></span></td>
																			</tr>
								...
								<div class="tab-pane fade show active" id="klasifikasi_kualifikasi" role="tabpanel" aria-labelledby="home-tab-1">
														...
														<div class="col-md-4">
															...
															<div class="col-md-8">
																<br>
																	...
																	<div class="form-group">
																			<select name="nama_peralatan" id="klasifikasi_reg" class="form-control">
																				<?php foreach ($klasifikasi as $row_klas) :?>
																					 <option data-text="<?php echo $row_klas['id_sub_klasifikasi'] ;?>" value="<?php echo $row_klas['id_sub_klasifikasi'] ;?>"><?php echo $row_klas['id_sub_klasifikasi'] ;?></option>
																				<?php endforeach ;?>
																			 </select>
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<span class="switch switch-outline switch-icon switch-danger">
													...
													<label>
														<input type="checkbox" checked="checked" id="checkbox_90s" value="1" name="checkbox_90" />
														<span></span>
													</label>
												</span>
												...
												<div class="col-md-8">
													...
													<div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text"  id="comment_90" name="comment_90"  class="form-control"  placeholder="Comment...">
														<div class="input-group-btn input-group-append">
															<button type="button" onclick="javascript:get90()" id="get_90"   class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																</div>
													</div>
												</div>
										</div>
                                  ...
                                  <div class="col-md-2">
                                    <div class="content-group-lg">
                                      <h6 class="text-semibold">#</h6>
                                      <p class="content-group">Pengecekan SKA SKT PJT Per-sub klasifikasi</p>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-2">
                                    <div class="content-group-lg">
                                      <h6 class="text-semibold">#</h6>
                                      <p class="content-group">Pengecekan SKA SKT PJSK Per-sub klasifikasi</p>
                                    </div>
                                  </div>
																...
																<div class="table-responsive">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				<td>Klasifikasi</td>
																				<td><span class="text-dark"><?php echo $row_klasifikasi['id_klasifikasi'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Sub Klasifikasi</td>
																			...
																			<tr>
																				<td>Permohonan</td>
																				<td><span class="text-dark"><?php echo $row_klasifikasi['id_permohonan'] ;?></span></td>
																			</tr>
																			...
																			<tr>
																				<td>Jenis Usaha</td>
																				<td><span class="text-dark"><?php echo $row_klasifikasi['jenis_usaha'] ;?></span></td>
																			</tr>
																			<tr>
					...
					<?php if(!empty($cek)) :?>
						<a onclick="javascript:submit(this)" type="button" name="submit"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b></i></b>Verifikasi Final</a>
						<?php endif ;?>
	...
	function kembalikan(sel) {
	  var id_izin_value=sel.name;
		...
		Swal.fire({
					...
					text: "Proses akan mengembalikan berkas dan mengirimkan notifikasi bahwa permohonan "+sub_klasifikasi_value+" dikembalikan karena PJSK sudah dipakai BUJK lain",
					icon: "warning",
					 ...
					 jQuery.ajax({
						 ...
						 data : {id_izin:id_izin_value,
							 ...
							 if(response.status=='FALSE'){
								 ...
								 window.location.replace("<?= base_url('sertifikasi/list_tinjauan_permohonan');?>");
