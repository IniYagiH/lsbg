...
<hr>
  <section class="items">
    <div class="center">
FORMULIR REKOMENDASI HASIL PENILAIAN KETERSEDIAAN TENAGA KERJA

BADAN USAHA KONSTRUKSI<br> (FTKK 03)
    </div>
  </section>
    <section class="items">
 ...
 <section class="items">
  ...
  <tr style="text-align:center; font-weight:bold;">
    ...
    <th colspan="2" style="background:#fce9c8;">HASIL PENILAIAN KELAYAKAN BADAN USAHA</th>
    <th rowspan="2" style="padding:6px;">REKOMENDASI</th>
  </tr>
  <tr style="text-align:center; font-weight:bold;">
    <th style="background:#fce9c8;">Hasil Penilaian Ketersediaan Tenaga Kerja</th>
  ...
  <tr>
    ...
    <td style="text-align:center;"><?=$penilaian_ftkk03[0]['pjbu_nilai'];?></td>
    <td style="text-align:center;"><?=$penilaian_ftkk03[0]['pjbu_persyaratan'];?></td>
    <td style="text-align:center;"><?php if($penilaian_ftkk03[0]['pjbu_rekomendasi']=='1'){echo "Sesuai";}else{echo "Tidak Sesuai";};?></td>
  </tr>

  <tr>
    <td style="text-align:center;">2</td>
    <td>PJTBU (Klasifikasi, subkalifikasi, jenjang)</td>
    <td style="text-align:center;"><?=$penilaian_ftkk03[0]['pjtbu_nilai'];?></td>
    <td style="text-align:center;"><?=$penilaian_ftkk03[0]['pjtbu_persyaratan'];?></td>
    <td style="text-align:center;"><?php if($penilaian_ftkk03[0]['pjtbu_rekomendasi']=='1'){echo "Sesuai";}else{echo "Tidak Sesuai";};?></td>
  </tr>

  <tr>
    <td style="text-align:center;">3</td>
    <td>PJ SKBU (Klasifikasi, subklafikasi, jenjang)</td>
       <td style="text-align:center;"><?=$penilaian_ftkk03[0]['pjskbu_nilai'];?></td>
    <td style="text-align:center;"><?=$penilaian_ftkk03[0]['pjskbu_persyaratan'];?></td>
    <td style="text-align:center;"><?php if($penilaian_ftkk03[0]['pjskbu_rekomendasi']=='1'){echo "Sesuai";}else{echo "Tidak Sesuai";};?></td>
  </tr>
</table>
</section>
  <section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-60-table" style="border: 1px solid black;">
      <div class="left">
        <strong><?=$catatan_ftkk03[0]['catatan'];?></strong>
      </div>
    </div>
