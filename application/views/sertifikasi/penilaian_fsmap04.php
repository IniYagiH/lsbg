			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('sertifikasi/fsmap04/'.$nib_dec.'/'.$tgl_dec.'/'.$user_dec) ;?>"
							target="_blank" style="margin:5px;" class="btn btn-primary font-weight-bolder">
							<i class="flaticon-customer"></i>FSMAP04</a>
...
<div class="tab-pane fade show" id="smap" role="tabpanel" aria-labelledby="home-tab-1">
								...
								<?php echo form_open_multipart(base_url('sertifikasi/insert_penilaian_fsmap04'), 'method="POST"');?>
    ...
    <table style="width:100%; border-collapse:collapse; font-family:Arial, sans-serif; font-size:13px;" border="1">
        ...
        <tr style="text-align:center; font-weight:bold; background:#fce9c8;">
            ...
            <td>Valid</td>
            <td>Tidak Valid</td>
            <td>MEMENUHI/TIDAK MEMENUHI</td>
        </tr>
        <!-- Sub-header keterangan kolom -->
        <tr style="text-align:center; font-weight:bold;">
		 ...
		 <?php
								...
								if(!empty($penilaian_fsmap04)){
									foreach($penilaian_fsmap04 as $row_ceklis){
	 							  $count+=1;
	 							  for ($i=0; $i < count($penilaian_fsmap04); $i++) {
	 							    if($row_ceklis['id']==$penilaian_fsmap04[$i]['id']){
        ...
        <tr>
			...
			<div class="row">
				...
				<div class="col-md-9">
					 <div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" value="<?=${"data_item_1"};?>" name="item1" value="" class="form-control"
			...
			<div class="form-group" style="display: flex; justify-content: center; align-items: center; height: 50px;">
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_1"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radios1" />
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_1"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radios1" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_1"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radioss1" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_1"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radioss1" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td><div class="form-group" style="display: flex; justify-content: center; align-items: center; height: 50px;">
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_1"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radiosss1" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div></td>
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_1"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radiosss1" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="rekomendasi1" required="required">
        ...
        <tr>
            ...
            <td><div class="row">
				...
				<div class="col-md-9">
					 <div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" value="<?=${"data_item_2"};?>" name="item2" class="form-control"
															placeholder="Isian Asesor...">
													</div>
				</div>
			</div></td>
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_2"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radios2" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_2"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radios2" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_2"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radioss2" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_2"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radioss2" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_2"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radiosss2" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_2"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radiosss2" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="rekomendasi2" required="required">
															<option value="1">SESUAI</option>
															<option value="0">TIDAK SESUAI</option>
														</select>
        ...
        <tr>
            ...
            <td><div class="row">
				...
				<div class="col-md-9">
					 <div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" value="<?=${"data_item_3"};?>" name="item3" class="form-control"
															placeholder="Isian Asesor...">
													</div>
				</div>
			</div></td>
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_3"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radios3" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_3"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radios3" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_3"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radioss3" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_3"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radioss3" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_3"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radiosss3" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_3"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radiosss3" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="rekomendasi3" required="required">
															<option value="1">SESUAI</option>
															<option value="0">TIDAK SESUAI</option>
														</select>
        ...
        <tr>
            ...
            <td>
				...
				<div class="col-md-9">
					 <div class="input-group file-caption-main">
														<span class="file-caption-icon"></span>
														<input type="text" value="<?=${"data_item_4"};?>" name="item4" class="form-control"
															placeholder="Isian Asesor...">
													</div>
				</div>
			</div>
            ...
            <td>
				...
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_4"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radios4" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div>
            ...
            <td><div class="form-group" style="display: flex; justify-content: center; align-items: center; height: 50px;">
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_kelengkapan_4"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radios4" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div></td>
            <td><div class="form-group" style="display: flex; justify-content: center; align-items: center; height: 50px;">
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_4"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radioss4" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div></td>
            <td><div class="form-group" style="display: flex; justify-content: center; align-items: center; height: 50px;">
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_verifikasi_4"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radioss4" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div></td>
            <td><div class="form-group" style="display: flex; justify-content: center; align-items: center; height: 50px;">
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_4"}=='1') :?> checked="checked" <?php endif ;?> value="1" name="radiosss4" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div></td>
            <td><div class="form-group" style="display: flex; justify-content: center; align-items: center; height: 50px;">
				<div class="radio-inline">
					<label class="radio" style="display: flex; align-items: center;">
						<input type="radio" <?php if(${"data_validasi_4"}=='0') :?> checked="checked" <?php endif ;?> value="0" name="radiosss4" />
						<span style="margin-left: 5px;"></span>
					</label>
				</div>
			</div></td>
          <td style="text-align:center;">
													<div class="center">
														<select class="form-control" name="rekomendasi4" required="required">
															<option value="1">SESUAI</option>
															<option value="0">TIDAK SESUAI</option>
														</select>
		...
		<input type="hidden" value="<?php echo $user_dec ;?>" name="id3">
									...
									<div class="row">
										...
										<div class="input-group file-caption-main">
											<span class="file-caption-icon"></span>
											<textarea id="comment_res" name="catatan_fsmap04"
												class="form-control form-control-solid" rows="5"
												placeholder="Catatan resuma...">
											
												<?php if(!empty($catatan_fsmap04)) :?>
												<?=$catatan_fsmap04[0]['catatan'];?>	
												<?php else :?>
Catatan : 1. Berdasarkan Ketentuan Keputusan DJBK No. …………………… (diisi peraturan yang berlaku) 
2. Kesesuaian Jenis dokumen yang diupload dengan pilihan pemenuhan yang dipilih (ya / tidak) (hapus yang tidak diperlukan) 
3. Hasil CEK KELENGKAPAN, VERIFIKASI DAN VALIDASI Dokumen permohonan BUJK <?=$biodata[0]['nama'];?> : SESUAI / TIDAK SESUAI (hapus yang tidak diperlukan)
												<?php endif ;?>
											</textarea>
									...
									<br>
								<br>
								<button type="submit" name="submit" style="float: right" class="open-delete btn btn-primary btn-labeled btn-rounded"><b><i class="icon-paperplane"></i></b> Submit Penilaian FTP04</button>
