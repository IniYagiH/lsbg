			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-muted">API LPJK</a>
						</li>
			...
			<div class="card card-custom">
				<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label">Data API LPJK</h3>
					</div>

					<div class="card-toolbar">


						<a onclick="javascript:get_simpk(this)" class="btn btn-danger font-weight-bolder">
						<i class="la la-plus"></i>Perbarui Token</a>
						<!--end::Button-->
					</div>
				</div>
				<div class="card-body">
...
function get_simpk(sel) {
  Swal.fire({
        title: "Anda ingin memperbarui token API?",
        text: "Setelah menperbarui token, token lama akan di hapus dan diperbarui dengan token terbaru!",
        icon: "warning",
        ...
        if (result.value) {
          ...
          $.ajax({
              url : "<?php echo base_url('sertifikasi/get_api_lpjk'); ?>",
              type : "POST",
              data : {nib : 'aa'},
              success : function(data) {
                response = jQuery.parseJSON(data);
				              ...
				              icon: "success",
				              title: "Perbarui Token API berhasil",
				              ...
				              icon: "error",
				              title: "Perbarui Token API gagal",
				              showConfirmButton: false,
				              timer: 1500
				          });
								}
