          ...
          <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <?php if ($row['perbedaan']<=3):?>
                    <a type="button" id="<?=$row['id_izin'];?>" onclick="javascript:cek_detail(this)" class="pulse pulse-black"><span class="label label-black label-inline mr-2"><?=$row['perbedaan'];?> Hari<span class="pulse-ring"></span> </span></a>
                  <?php else :?>
                    <a type="button" id="<?=$row['id_izin'];?>" onclick="javascript:cek_detail(this)" class="pulse pulse-danger"><span class="label label-danger label-inline mr-2"><?=$row['perbedaan'];?> Hari<span class="pulse-ring"></span> </span></a>
