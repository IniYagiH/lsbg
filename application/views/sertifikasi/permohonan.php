			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-dark">Pengajuan</a>
						</li>
			...
			<div class="card card-custom gutter-b">
				<div class="card-header">
					<div class="card-title">
						<h3 class="card-label">Pengajuan Permohonan</h3>
				...
				<div class="card-body">
					...
					<div class="example mb-10">
						<input type="hidden" id="base_url" value="<?php echo base_url('sertifikasi/insert_permohonan') ;?>" >
						...
						<div class="example-preview">
							<ul class="nav nav-pills" id="myTab1" role="tablist">
								...
								<li class="nav-item dropdown">
									<a class="nav-link active dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
										...
										<span class="nav-text">Admin & SMM SMAP</span>
									</a>
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" data-toggle="tab" href="#administrasi">Administrasi</a>
										<a class="dropdown-item" data-toggle="tab" href="#smm">SMM</a>
										<a class="dropdown-item" data-toggle="tab" href="#smap">SMAP</a>
									</div>
								</li>
								...
								<li class="nav-item">
									<a class="nav-link" id="contact-tab-1" data-toggle="tab" href="#pengalaman" aria-controls="contact">
										...
										<span class="nav-text">PenjualanTahunan</span>
									</a>
								</li>
								<li class="nav-item dropdown">
								...
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" data-toggle="tab" href="#pengurus">Komisarin & Direksi</a>
										<a class="dropdown-item" data-toggle="tab" href="#pemegang_saham">Pemegang Saham</a>
										<a class="dropdown-item" data-toggle="tab" href="#neraca">Modal</a>
							...
							<?php if(empty($cek)) :?>
							<?php echo form_open_multipart(base_url('sertifikasi/insert_permohonan'), 'method="POST"');?>
						<?php endif ;?>
							<div class="tab-content mt-5" id="myTabContent1">
												...
												<input type="hidden" id="tgl" name="tgl" value="<?php echo $tgl ;?>">
													<div class="panel-body" >
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_13/').$biodata[0]['persyaratan_13'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_9/').$biodata[0]['persyaratan_9'] ;?>" target="_blank" type="button" name="btn_cek_11"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
										...
										<div class="table-responsive">
											...
											<table class="table table-lg">
												...
												<tbody>
													...
													<tr>
														<td>Sifat Usaha</td>
														<td><span class="text-dark"><?php echo $biodata[0]['sifat_usaha'] ;?></span></td>
													...
													<tr>
														...
														<td><span class="text-dark"><?php echo $biodata[0]['klasifikasi_jenis_usaha'] ;?></span></td>
													...
													<tr>
														<td>Faximili</td>
														<td><span class="text-dark"><?php echo $biodata[0]['fax'] ;?></span></td>
													</tr>
													<tr>
														<td>Kodepos</td>
													...
													<tr>
														<td>Email PIC</td>
														<td><span class="text-dark"><?php echo $biodata[0]['email_pic'] ;?></span></td>
													</tr>
													<tr>
														<td>Website</td>
								...
								<div class="tab-pane fade" id="smm" role="tabpanel" aria-labelledby="home-tab-1">
									<?php if(!empty($smm)) :?>
										<div class="col-md-12">
											<div class="panel panel-flat panel-collapsed">
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															<div class="col-md-3">
																<div class="content-group-lg">
																	<h6 class="text-semibold">#1</h6>
																	<p class="content-group">Rekaman ISO 9001 </p>
																</div>
															</div>
															...
															<div class="col-md-1">
																...
																<span class="switch switch-outline switch-icon switch-dark">
																	...
																	<label>
																		<input type="checkbox" checked="checked" id="checkbox_61" value="1" onclick="javascript:checkbox61()" name="checkbox_61" />
																		<span></span>
																	</label>
																</span>
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_61/').$smm[0]['persyaratan_61'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																		<span class="file-caption-icon"></span>
																		<input type="text" id="comment_61" name="comment_61"   class="form-control" disabled="disabled" placeholder="Comment...">


																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get61()" id="get_61"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
											...
											<div class="table-responsive">
												...
												<table class="table table-lg">
													...
													<tbody>
														...
														<tr>
															<td>Tgl Terbit</td>
															<td><span class="text-dark"><?php echo $smm[0]['tgl_terbit'] ;?></span></td>
														</tr>
														<tr>
															<td>Berlaku Sampai</td>
															<td><span class="text-dark"><?php echo $smm[0]['berlaku_sampai'] ;?></span></td>
														</tr>
														<tr>
								...
								<div class="tab-pane fade" id="smap" role="tabpanel" aria-labelledby="home-tab-1">
									<?php if(!empty($smap)) :?>
										<div class="col-md-12">
											<div class="panel panel-flat panel-collapsed">
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															<div class="col-md-3">
																<div class="content-group-lg">
																	<h6 class="text-semibold">#1</h6>
																	<p class="content-group">Rekaman ISO 37001 </p>
																</div>
															</div>
															...
															<div class="col-md-1">
																...
																<span class="switch switch-outline switch-icon switch-dark">
																	...
																	<label>
																		<input type="checkbox" checked="checked" id="checkbox_62" value="1" onclick="javascript:checkbox62()" name="checkbox_62" />
																		<span></span>
																	</label>
																</span>
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_62/').$smap[0]['persyaratan_62'] ;?>" target="_blank" type="button" name="btn_cek_62"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																		<span class="file-caption-icon"></span>
																		<input type="text" id="comment_62" name="comment_62"   class="form-control" disabled="disabled" placeholder="Comment...">


																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get62()" id="get_62"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
														<div class="row">
															...
															<div class="col-md-1">
																...
																<span class="switch switch-outline switch-icon switch-dark">
																	...
																	<label>
																		<input type="checkbox" checked="checked" id="checkbox_63" value="1" onclick="javascript:checkbox63()" name="checkbox_63" />
																		<span></span>
																	</label>
																</span>
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_63/').$smap[0]['persyaratan_63'] ;?>" target="_blank" type="button" name="btn_cek_63"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get63()" id="get_63"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
													...
													<div id="data-pengurus-<?php echo $counter_pengurus ;?>" class="collapse show" data-parent="#accordionExample1">
															<div class="card-body">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_14/').$row_pengurus['persyaratan_14'] ;?>" target="_blank" type="button" name="btn_cek_14"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	<div class="col-md-2">
																		<div class="content-group-lg">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_15/').$row_pengurus['persyaratan_15'] ;?>" target="_blank" type="button" name="btn_cek_15"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				...
																				<td><span class="text-dark"><?php echo $row_pengurus['id_jabatan'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Tempat Lahir</td>
																				<td><span class="text-dark"><?php echo $row_pengurus['tempat_lahir'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Tanggal Lahir</td>
																			...
																			<tr>
																				<td>Kodepos</td>
																				<td><span class="text-dark"><?php echo $row_pengurus['kodepos'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Propinsi</td>
																				<td><span class="text-dark"><?php echo $row_pengurus['id_propinsi'] ?></span></td>
																			</tr>
																			<tr>
																				<td>Kabupaten</td>
																				<td><span class="text-dark"><?php echo $row_pengurus['id_kabupaten'] ?></span></td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				<td>No Ijazah</td>
																				<td><span class="text-dark"><?php echo $row_pengurus['no_ijazah'] ?></span></td>
																			</tr>
																		</tbody>
																	</table>
																</div>
												...
												<div id="data-pengalaman-<?php echo $counter_pengalaman ;?>" class="collapse show" data-parent="#accordionExample1">
														...
														<div class="card-body">
															...
															<div class="row">
																...
																<div class="col-md-4">
																	<br>
																	<a href="<?php echo base_url('get_file/get_bu_36/').$row_pengalaman['persyaratan_36'] ;?>" target="_blank" type="button" name="btn_cek_36"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																</div>
															...
															<!--#2-->
																...
																<div class="col-md-4">
																	<br>
																	<a href="<?php echo base_url('get_file/get_bu_35/').$row_pengalaman['persyaratan_35'] ;?>" target="_blank" type="button" name="btn_cek_35"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																</div>
															...
															<div class="row">
																...
																<div class="col-md-4">
																	<br>
																	<a href="<?php echo base_url('get_file/get_bu_34/').$row_pengalaman['persyaratan_34'] ;?>" target="_blank" type="button" name="btn_cek_34"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																</div>
															...
															<!--#4-->
																...
																<div class="col-md-2">
																	<br>
																	<a href="<?php echo base_url('get_file/get_bu_32/').$row_pengalaman['persyaratan_32'] ;?>" target="_blank" type="button" name="btn_cek_32"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																</div>
															...
															<div class="table-responsive">
																...
																<table class="table table-lg">
																	...
																	<tbody>
																		...
																		<tr>
																			<td>Propinsi</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['id_propinsi'] ;?></span></td>
																		</tr>

																		<tr>
																			<td>Nomor BA Serah Terima</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nomor_ba_serah_terima'] ;?></span></td>
																		</tr>
																		...
																		<tr>
																			...
																			<td><span class="text-dark"><?php echo $row_pengalaman['id_sumber_dana'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Klasifikasi</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['id_klasifikasi'] ;?></span></td>
																		</tr>
																		<tr>
																		...
																		<tr>
																			<td>Tgl Terima</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['tgl_ba_serah_terima'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>No Addendum Kontrak</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['no_addendum_kontrak'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Tgl Addendum Kontrak</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['tgl_addendum_kontrak'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Nilai Addendum Kontrak</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nilai_addendum_kontrak'] ;?></span></td>
																		</tr>

																		<tr>
																			<td>Partner KSO/JO</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['partner'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Nama Sub Kontrak</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nama_sub_kontrak'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Nilai Sub Kontrak</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nilai_sub_kontrak'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Nomor PHO/BASH Pekerjaan</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nomor_pho'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Tanggal Serah Terima PHO</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['tgl_pho'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Nomor FHO/BASH Pekerjaan</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['nomor_fho'] ;?></span></td>
																		</tr>
																		<tr>
																			<td>Tanggal Serah Terima FHO</td>
																			<td><span class="text-dark"><?php echo $row_pengalaman['tgl_fho'] ;?></span></td>
																		</tr>
												...
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_7/').$akte_pendirian[0]['persyaratan'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
														...
														<div class="row">
															...
															<div class="col-md-1">
																...
																<span class="switch switch-outline switch-icon switch-dark">
																	...
																	<label>
																		<input type="checkbox" checked="checked" id="checkbox_55" value="1" onclick="javascript:checkbox55()" name="checkbox_7" />
																		<span></span>
																	</label>
																</span>
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_55/').$akte_pendirian[0]['persyaratan_55'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																	...
																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get55()" id="get_55"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
											...
											<div class="table-responsive">
												...
												<table class="table table-lg">
													...
													<tbody>
														<tr>
															<td>Nomor Akte</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['nomer_akte'] ;?></span></td>
														</tr>
														<tr>
															<td>Nama Notaris</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['nama_notaris'] ;?></span></td>
														</tr>
														<tr>
															<td>Alamat</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['alamat'] ;?></span></td>
														</tr>
														<tr>
															<td>Tanggal Akte</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['tgl_akte'] ;?></span></td>
														</tr>
														<tr>
															<td>Propinsi Registrasi</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['propinsi_akte'] ;?></span></td>
														</tr>
														<tr>
															<td>Kabupaten / Kota</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['kabupaten_akte'] ;?></span></td>
														</tr>
														<tr>
															<td>Nama Pengurus</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['nama_pengurus'] ;?></span></td>
														</tr>
														<tr>
															<td>Id Jabatan</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['id_jabatan'] ;?></span></td>
														</tr>
														<tr>
															<td>Menteri Kehakiman & HAM</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['no_pm'] ;?></span></td>
														</tr>
														<tr>
															<td>Tanggal Menteri</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['tgl_pm'] ;?></span></td>
														</tr>
														<tr>
															<td>Pengadilan Negeri</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['no_pn'] ;?></span></td>
														</tr>
														<tr>
															<td>Tanggal Pengadilan Negeri</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['tgl_pn'] ;?></span></td>
														</tr>
														<tr>
															<td>Lembar Negara</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['no_ln'] ;?></span></td>
														</tr>
														<tr>
															<td>Tanggal Lembar Negara</td>
															<td><span class="text-dark"><?php echo $akte_pendirian[0]['tgl_ln'] ;?></span></td>
														</tr>
													...
													<div class="row">
														...
														<div class="col-md-1">
															...
															<div class="col-md-8">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get56()" id="get_56"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
													...
													<div id="data-perubahan-<?php echo $counter_perubahan ;?>" class="collapse show" data-parent="#accordionExample1">
															...
															<div class="card-body">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_8/').$row_perubahan['persyaratan'] ;?>" target="_blank" type="button" name="btn_cek_36"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="col-md-4">
																	<br>
																	<a href="<?php echo base_url('get_file/get_bu_56/').$row_perubahan['persyaratan_56'] ;?>" target="_blank" type="button" name="btn_cek_36"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																</div>
																</div>
																<hr>
																<div class="table-responsive">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			<tr>
																				<td>Nomor Akte</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['nomer_akte'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Nama Notaris</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['nama_notaris'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Alamat</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['alamat'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Tanggal Akte</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['tgl_akte'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Propinsi Registrasi</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['propinsi_akte'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Kabupaten / Kota</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['kabupaten_akte'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Nama Pengurus</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['nama_pengurus'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Id Jabatan</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['id_jabatan'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Menteri Kehakiman & HAM</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['no_pm'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Tanggal Menteri</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['tgl_pm'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Pengadilan Negeri</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['no_pn'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Tanggal Pengadilan Negeri</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['tgl_pn'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Lembar Negara</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['no_ln'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Tanggal Lembar Negara</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['tgl_ln'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Perubahan Tentang</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['perubahan'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Modal Dasar</td>
																				<td><span class="text-dark"><?php echo $row_perubahan['modal_dasar'] ;?></span></td>
																			</tr>
											...
											<div class="panel-heading">
												...
												<div class="panel-body" >
													...
													<div class="row">
														...
														<div class="col-md-2">
															<br>
															<a href="<?php echo base_url('get_file/get_bu_2/').$pph_omset[0]['persyaratan'] ;?>" target="_blank" type="button" name="btn_cek_22"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
														</div>
															<div class="col-md-6">
																<br>
																<div class="input-group file-caption-main">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get22()" id="get_22"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
										...
										<div class="table-responsive">
											...
											<table class="table table-lg">
												...
												<tbody>
													<tr>
														<td>SPT PPH th 1</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['thn_spt1'] ;?></span></td>
													</tr>
													<tr>
														<td>Pembayaran Kewajiban Pajak</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['spt1'] ;?></span></td>
													</tr>
													<tr>
														<td>SPT PPH th 2</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['thn_spt2'] ;?></span></td>
													</tr>
													<tr>
														<td>Pembayaran Kewajiban Pajak</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['spt1'] ;?></span></td>
													...
													<tr>
														<td>Omset th 1</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['thn_omset1'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['omset1'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset th 2</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['thn_omset2'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['omset2'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset th 3</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['thn_omset3'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['omset3'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset th 4</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['thn_omset4'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['omset4'] ;?></span></td>
													</tr>
													<tr>
														<td>Omset th 5</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['thn_omset5'] ;?></span></td>
													</tr>
													<tr>
														<td>TOmset</td>
														<td><span class="text-dark"><?php echo $pph_omset[0]['omset5'] ;?></span></td>
													</tr>
													...
													<div class="row">
														...
														<div class="col-md-1">
															...
															<div class="col-md-8">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get41()" id="get_41"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
													...
													<div id="data-saham-<?php echo $counter_saham ;?>" class="collapse show" data-parent="#accordionExample1">
															...
															<div class="card-body">
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_41/').$row_pengalaman['persyaratan_36'] ;?>" target="_blank" type="button" name="btn_cek_36"  style="float: left" class=" btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="table-responsive">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			...
																			<tr>
																				<td>Kodepos</td>
																				<td><span class="text-dark"><?php echo $row_saham['kd_pos'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Jenis Saham</td>
													...
													<div class="row">
														...
														<div class="col-md-1">
															...
															<span class="switch switch-outline switch-icon switch-primary">
																...
																<label>
																	<input type="checkbox" checked="checked" id="checkbox_57" value="1" onclick="javascript:checkbox57()" name="checkbox_21" />
																	<span></span>
																</label>
															</span>
													...
													<div id="data-tk-<?php echo $counter_tk ;?>" class="collapse show" data-parent="#accordionExample1">
															...
															<div class="card-body">
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_23/').$row_tk['persyaratan_23'] ;?>" target="_blank" type="button" name="btn_cek_23"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_28/').$row_tk['persyaratan_28'] ;?>" target="_blank" type="button" name="btn_cek_23"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			<tr>
																				...
																				<td><span class="text-dark"><?php echo $row_tk['noreg'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Nama</td>
																				<td><span class="text-dark"><?php echo $row_tk['nama'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>KTP</td>
																				<td><span class="text-dark"><?php echo $row_tk['no_ktp'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Tanggal Lahir</td>
																				<td><span class="text-dark"><?php echo $row_tk['tgl_lahir'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Kodepos</td>
																				<td><span class="text-dark"><?php echo $row_tk['kodepos'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Pendidikan Akhir</td>
																				<td><span class="text-dark"><?php echo $row_tk['pendidikan_akhir'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>No. Ijazah</td>
																				<td><span class="text-dark"><?php echo $row_tk['no_ijazah'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Tahun Lulus</td>
																				<td><span class="text-dark"><?php echo $row_tk['thn_lulus'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>NPWP</td>
																				<td><span class="text-dark"><?php echo $row_tk['npwp'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Alamat</td>
																				<td><span class="text-dark"><?php echo $row_tk['alamat'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Sub Bidang</td>
																				<td><span class="text-dark"><?php echo $row_tk['id_sub_bidang'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Jenis Tenaga Kerja</td>
																				<td><span class="text-dark"><?php echo $row_tk['tenaga_kerja'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Kualifikasi</td>
																				<td><span class="text-dark"><?php echo $row_tk['id_kualifikasi'] ;?></span></td>
																			</tr>
												...
												<div class="panel-heading">
													...
													<div class="panel-body" >
														...
														<div class="row">
															...
															<div class="col-md-2">
																<br>
																<a href="<?php echo base_url('get_file/get_bu_peralatan/').$peralatan[0]['persyaratan'] ;?>" target="_blank" type="button" name="btn_cek_13"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
															</div>
																<div class="col-md-6">
																	<br>
																	<div class="input-group file-caption-main">
																		<span class="file-caption-icon"></span>
																		<input type="text" id="comment_peralatan" name="comment_7"   class="form-control" disabled="disabled" placeholder="Comment...">


																	<div class="input-group-btn input-group-append">
																		<button type="button" onclick="javascript:get_peralatan()" id="get_7"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																			</div>
																	</div>
																</div>
														</div>
												...
												<table class="table table-lg">
													...
													<tbody>
														<tr>
															...
															<td><span class="text-dark"><?php echo $peralatan[0]['jenis_peralatan'] ;?></span></td>
														</tr>
														<tr>
															<td>Tipe Peralatan</td>
															<td><span class="text-dark"><?php echo $peralatan[0]['tipe_peralatan'] ;?></span></td>
														</tr>
														<tr>
															<td>Tahun Pembuatan</td>
															<td><span class="text-dark"><?php echo $peralatan[0]['tahun_pembuatan'] ;?></span></td>
														</tr>
														<tr>
															<td>Kapasitas</td>
															<td><span class="text-dark"><?php echo $peralatan[0]['kapasitas'] ;?></span></td>
														</tr>
														<tr>
															<td>Kondisi %</td>
															<td><span class="text-dark"><?php echo $peralatan[0]['kondisi'] ;?></span></td>
														</tr>
														<tr>
															<td>Harga</td>
															<td><span class="text-dark"><?php echo $peralatan[0]['harga'] ;?></span></td>
														</tr>
														<tr>
															<td>Propinsi</td>
															<td><span class="text-dark"><?php echo $peralatan[0]['propinsi'] ;?></span></td>
														</tr>
													...
													<div class="row">
														...
														<div class="col-md-1">
															...
															<div class="col-md-8">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get3()" id="get_3"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-1">
															...
															<div class="col-md-8">
																...
																<div class="input-group-btn input-group-append">
																	<button type="button" onclick="javascript:get12()" id="get_12"  disabled="disabled" class="btn btn-dark btn-ladda btn-ladda-spinner" data-spinner-color="#333" data-style="zoom-in"><span class="ladda-label">Submit</span></button>
																		</div>
																</div>
															</div>
													</div>
													...
													<div id="data-klasifikasi-<?php echo $counter_klasifikasi ;?>" class="collapse show" data-parent="#accordionExample1">
															...
															<div class="card-body">
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_1/').$row_klasifikasi['persyaratan_1'] ;?>" target="_blank" type="button" name="btn_cek"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<!--#2-->
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_2/').$row_klasifikasi['persyaratan_2'] ;?>" target="_blank" type="button" name="btn_cek_2"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_3/').$row_klasifikasi['persyaratan_3'] ;?>" target="_blank" type="button" name="btn_cek_3"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<!--#4-->
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_4/').$row_klasifikasi['persyaratan_4'] ;?>" target="_blank" type="button" name="btn_cek_4"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<div class="row">
																	...
																	<div class="col-md-4">
																		<br>
																		<a href="<?php echo base_url('get_file/get_bu_5/').$row_klasifikasi['persyaratan_5'] ;?>" target="_blank" type="button" name="btn_cek_5"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																	</div>
																...
																<!--#6-->
																 ...
																 <div class="col-md-4">
																	 <br>
																	 <a href="<?php echo base_url('get_file/get_bu_12/').$row_klasifikasi['persyaratan_12'] ;?>" target="_blank" type="button" name="btn_cek_12"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																 </div>
															 ...
															 <div class="row">
																 ...
																 <div class="col-md-4">
																	 <br>
																	 <a href="<?php echo base_url('get_file/get_bu_10/').$row_klasifikasi['persyaratan_10'] ;?>" target="_blank" type="button" name="btn_cek_5"  style="float: left" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>
																 </div>
																...
																<div class="table-responsive">
																	...
																	<table class="table table-lg">
																		...
																		<tbody>
																			<tr>
																				<td>Tahun</td>
																				<td><span class="text-dark"><?php echo $row_klasifikasi['tahun'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Klasifikasi</td>
																			...
																			<tr>
																				...
																				<td><span class="text-dark"><?php echo $row_klasifikasi['no_ba_asosiasi'] ;?></span></td>
																			</tr>

																			<tr>
																				<td>Propinsi Registrasi</td>
																				<td><span class="text-dark"><?php echo $row_klasifikasi['propinsi'] ;?></span></td>
																			</tr>
																			<tr>
																				<td>Jenis Permohonan</td>
																				<td><span class="text-dark"><?php if($row_klasifikasi['id_permohonan']=='1'){
																					echo "Baru";
					...
					<?php if(empty($cek)): ?>
						<button  target="_blank" type="submit" name="submit"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-paperplane" ></i></b> Submit</button>
					<?php endif; ?>
					<?php echo form_close() ;?>
				</div>
			</div>
