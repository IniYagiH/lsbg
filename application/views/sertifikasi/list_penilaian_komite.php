      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            ...
            <span class="d-block text-muted pt-2 font-size-sm">Daftar Keseluruhan Permohonan Penilaian Tim Pemutus</span></h3>
          </div>
                  ...
                  <div class="dropdown dropdown-inline">
                    <a href="javascript:;" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown">
                      ...
                      <ul class="nav nav-hoverable flex-column">
                       <li class="nav-item"><a class="nav-link" target="_blank" href="<?= base_url("sertifikasi/form_hekt_pemutus/".encrypt_url($row['NIB']).'/'.encrypt_url($row['tgl_permohonan'])) ;?>"><i class="nav-icon la la-chalkboard-teacher"></i><span class="nav-text">Form HRKT Pemutus</span></a></li>
