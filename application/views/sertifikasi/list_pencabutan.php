      ...
      <div class="d-flex align-items-center mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
            ...
            <li class="breadcrumb-item text-muted">
              <a href="" class="text-dark">List Permohonan Yang Telah Dilakukan Pencabutan</a>
            </li>
      ...
      <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
          <div class="card-title">
            <h3 class="card-label">Permohonan Yang Telah Dilakukan Pencabutan
          ...
          <table class="table table-bordered table-hover table-checkable mt-10" id="kt_datatable2">
            <thead>
              ...
              <tr>
                ...
                <th>NIB</th>
                <th>Alasan_Pencabutan</th>
                <th>File Pencabutan</th>
                <th>User Hapus</th>
                <th>Tgl Hapus</th>
                <th>IdIzin</th>
...
<script>
  $('#submit').click(function() {
    ...
    jQuery.ajax({
      url: "<?= base_url('sertifikasi/search_pencabutan') ?>",
      type: "POST",
      data: {
        input: input_value,
        option: options
      ...
      success: function(data) {
        ...
        var file_bukti='<a href="https://sertifikasi.lsbugapeknas.com/assets/bukti/badan_usaha/bukti_penolakan/'+element.bukti_hapus+'" target="_blank" type="button" name="btn_cek_11"  style="float: right" class="open-delete btn btn-dark btn-labeled btn-rounded" ><b><i class="icon-file-check" ></i></b> Softcopy</a>'
          var rowNode = table
            .row.add([element.NIB, element.reason, file_bukti,element.user_hapus,element.tgl_penghapusan, element.id_izin, element.nama, element.id_sub_klasifikasi, element.tgl_permohonan])
            .draw()
            .node();
          $(rowNode)
            .css('color', 'black')
