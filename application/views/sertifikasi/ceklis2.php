                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="<?= base_url('sertifikasi/cetak_smm/'.$nib_dec.'/'.$tgl_dec.'/'.$user_dec) ;?>"
                                    target="_blank" style="margin:5px;" class="btn btn-dark font-weight-bolder">
                                    <i class="flaticon2-crisp-icons"></i>SMM</a>
                    ...
                    <div class="example mb-11">
                        ...
                        <div class="example-preview">
                            <ul class="nav nav-pills" id="myTab1" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab-1" data-toggle="tab" href="#smm"
                                        aria-controls="contact">
                                        <span class="nav-icon">
                                            <i class="flaticon2-rocket-1"></i>
                                        </span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <span class="switch switch-outline switch-icon switch-dark">
                                                            ...
                                                            <label>
                                                                <input type="checkbox" <?php if(!empty($ceklis)):?>
                                                                    <?php if($data_ceklis5=='1') :?>checked="checked"
                                                                    <?php else :?><?php endif ;?> <?php else :?>
                                                                    checked="checked" <?php endif ;?> id="checkbox_5"
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <span class="switch switch-outline switch-icon switch-dark">
                                                            ...
                                                            <label>
                                                                <input type="checkbox" <?php if(!empty($ceklis_2)):?>
                                                                    <?php if($data_ceklis5_2=='1') :?>checked="checked"
                                                                    <?php else :?><?php endif ;?> <?php else :?>
                                                                    checked="checked" <?php endif ;?>id="checkbox_5_2"
                                                                    value="1" onclick="javascript:checkbox5()"
                                                                    name="checkbox_5_2" />
                                                                <span></span>
                                                            </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <span class="switch switch-outline switch-icon switch-dark">
                                                            ...
                                                            <label>
                                                                <input type="checkbox" <?php if(!empty($ceklis)):?>
                                                                    <?php if($data_ceklis34=='1') :?>checked="checked"
                                                                    <?php else :?><?php endif ;?> <?php else :?>
                                                                    checked="checked" <?php endif ;?> id="checkbox_34"
                                                                    value="1" onclick="javascript:checkbox34()"
                                                                    name="checkbox_34" />
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <span class="switch switch-outline switch-icon switch-dark">
                                                            ...
                                                            <label>
                                                                <input type="checkbox" <?php if(!empty($ceklis_2)):?>
                                                                    <?php if($data_ceklis34_2=='1') :?>checked="checked"
                                                                    <?php else :?><?php endif ;?> <?php else :?>
                                                                    checked="checked" <?php endif ;?>id="checkbox_34_2"
                                                                    value="1" onclick="javascript:checkbox34()"
                                                                    name="checkbox_34_2" />
                                                                <span></span>
                                                            </label>
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="input-group file-caption-main">
                                                            ...
                                                            <input type="text" id="comment_34" name="comment_34"
                                                                <?php if(!empty($ceklis)):?>
                                                                value="<?=$data_comment34;?>" <?php endif ;?>
                                                                class="form-control" placeholder="Comment...">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <span class="switch switch-outline switch-icon switch-dark">
                                                            ...
                                                            <label>
                                                                <input type="checkbox" <?php if(!empty($ceklis)):?>
                                                                    <?php if($data_ceklis35=='1') :?>checked="checked"
                                                                    <?php else :?><?php endif ;?> <?php else :?>
                                                                    checked="checked" <?php endif ;?> id="checkbox_35"
                                                                    value="1" onclick="javascript:checkbox35()"
                                                                    name="checkbox_35" />
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <span class="switch switch-outline switch-icon switch-dark">
                                                            ...
                                                            <label>
                                                                <input type="checkbox" <?php if(!empty($ceklis_2)):?>
                                                                    <?php if($data_ceklis35_2=='1') :?>checked="checked"
                                                                    <?php else :?><?php endif ;?> <?php else :?>
                                                                    checked="checked" <?php endif ;?>id="checkbox_35_2"
                                                                    value="1" onclick="javascript:checkbox35()"
                                                                    name="checkbox_35_2" />
                                                                <span></span>
                                                            </label>
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="input-group file-caption-main">
                                                            ...
                                                            <input type="text" id="comment_35" name="comment_35"
                                                                <?php if(!empty($ceklis)):?>
                                                                value="<?=$data_comment35;?>" <?php endif ;?>
                                                                class="form-control" placeholder="Comment...">
    ...
    function check_pjsk(sel) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                var array2 = record2;
                if (typeof array2 != "undefined" && array2 != null && array2.length != null && array2
                    .length > 0) {
    ...
    function check_pjt(sel) {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (typeof array2 != "undefined" && array2 != null && array.length != null && array2
                    .length > 0) {
                    array2.forEach(function (element) {
                        var row2 = table2.insertRow(counter2);
                        var cell1 = row2.insertCell(0);
