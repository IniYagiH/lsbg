...
<hr>
  <section class="items">
    <div class="center">
FOMULIR PENILAIAN DAN REKOMENDASI KESESUAI DOKUMEN PENERAPAN SMAP BADAN USAHA JASA KONSTRUKSI<br> (FSMAP 05)    </div>
...
<section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-5-table">
      DOKUMEN PENERAPAN SMAP<br>
      (Nomor, tanggal, yang menandatangani, nilai penerapan SMAP)
    </div>
    <div class="col-1-5-table">
      DOKUMEN PENERAPAN SMAP<br>
      (Lembar Konfirmasi Pancek Tanggal dibuat,<br>
      tanggal diunduh, Terjawab,<br>
      Indikator, Revisi)
    </div>
    <div class="col-1-5-table">
      SURAT PERNYATAAN MEMENUHI DOK. SMAP<br>
      (nomor, tanggal dan yang menandatangani)
    </div>
    <div class="col-1-5-table">
      REKOMENDASI
    </div>
  ...
  <div class="row">
    ...
    <div class="col-1-5-table">(4)</div>
    <div class="col-1-5-table">(5)</div>
  </div>

  <!-- Baris Data -->
  <div class="row">
    <div class="col-1-5-table"><?=$penilaian_fsmap05[0]['iso']?></div>
    <div class="col-1-5-table"><?=$penilaian_fsmap05[0]['penerapan']?></div>
    <div class="col-1-5-table"><?=$penilaian_fsmap05[0]['pancek']?></div>
    <div class="col-1-5-table"><?=$penilaian_fsmap05[0]['pernyataan']?></div>
    <div class="col-1-5-table"><?php if($penilaian_fsmap05[0]['rekomendasi']=='1'){
      echo "MEMENUHI";
    }else{
echo "TIDAK MEMENUHI";
    } ;?></div>
...
<section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-20-table" style="vertical-align: top;">
      <div class="left">
      <strong><?=$catatan_fsmap05[0]['catatan'];?></strong>
      </div>
    </div>
