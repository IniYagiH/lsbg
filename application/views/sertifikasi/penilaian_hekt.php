...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="<?= base_url('sertifikasi/hekt/'.$nib_dec.'/'.encrypt_url($row_klasifikasi['id_sub_klasifikasi']).'/'.$user_dec) ;?>"
							target="_blank" style="margin:5px;" class="btn btn-warning font-weight-bolder">
							<i class="flaticon2-cup"></i>HEKT - <?=$row_klasifikasi['id_sub_klasifikasi']?></a>
						<?php endforeach ;?>
						...
						<div class="example-preview">
							...
							<div class="tab-pane fade" id="administrasi" role="tabpanel"
								...
								<div class="tab-pane fade" id="penilaian" role="tabpanel" aria-labelledby="home-tab-1">
									<?php echo form_open_multipart(base_url('sertifikasi/insert_penilaian_hekt'), 'method="POST"');?>
   ...
   <b3 style="font-size:20px; font-weight:bold; color:#2e64a7; background:#f0f0f0; padding:8px 12px; border-radius:6px; display:inline-block;"><?=$row_frpkp['Nama'].'-'.$row_klasifikasi['id_sub_klasifikasi']; ?></b3>
											<?php $penilaian_fthep=$this->Bu_model->penilaian_hekt($row_klasifikasi['id_izin'],$this->session->userdata('id_user')) ;?>
										<table>
											<colgroup>
												<col>
												<col>
											...
											<thead>
												<tr>
													...
													<th>Hasil Penilaian Tim Pemutus</th>
												</tr>
											</thead>
											...
											<tbody>
												...
												<tr>
													...
													<td rowspan="2"><div class="input-group file-caption-main">
															<span class="file-caption-icon"></span>
												...
												<tr>
													...
													<td><div class="input-group file-caption-main">
															<span class="file-caption-icon"></span>
