  ...
  <div class="d-flex flex-column-fluid">
    ...
    <div class="container">
      ...
      <div class="card card-custom position-relative overflow-hidden">
        ...
        <div class="row justify-content-center py-8 px-8 py-md-5 px-md-0 bg-primary">
          <div class="col-md-9">
              ...
              <div class="d-flex flex-column px-0 order-2 order-md-1">
                ...
                <a href="#" class="mb-5 max-w-115px">
                  <div class="header-logo">
  									<a href="index.html">
  										<img alt="Logo" src="<?= base_url('assets/media/logos/Logo_ski_2.png') ;?>" class="logo-default max-h-75px" />
  									</a>
  								</div>
                </a>
                <!--end::Logo-->
                <span class="d-flex flex-column font-size-h5 font-weight-bold text-white">
                  <span>Wijaya Grand Centre Blok D-1, Lantai 3</span>
                  <span>Jalan Dharmawangsa Raya No. 2, Kebayoran Baru</span>
                </span>
              </div>
          ...
          <div class="col-md-9">
            ...
            <div class="row pb-26">
              <div class="col-md-3 border-right-md pr-md-10 py-md-10">
                ...
                <div class="font-size-lg font-weight-bold mb-10"><?= $biodata[0]['nama'] ;?>,
                <br /><?= $biodata[0]['alamat_bu'] ;?></div>
                <!--end::Invoice To-->
                <!--begin::Invoice No-->
                ...
                <div class="font-size-lg font-weight-bold"><?= $tgl ;?></div>
                <!--end::Invoice Date-->
              </div>
              <div class="col-md-9 py-10 pl-md-10">
                <div class="table-responsive">
                  <table class="table">
                    <thead>
                      <tr>
                        <th class="pt-1 pb-9 pl-0 pl-md-5 font-weight-bolder text-muted font-size-lg text-uppercase">Klasifikasi</th>
                        <th class="pt-1 pb-9 text-right font-weight-bolder text-muted font-size-lg text-uppercase">Sub Klasifikasi</th>
                        <th class="pt-1 pb-9 text-right font-weight-bolder text-muted font-size-lg text-uppercase">Kualifikasi</th>
                        <th class="pt-1 pb-9 text-right pr-0 font-weight-bolder text-muted font-size-lg text-uppercase">Biaya</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php $jumlah=0 ;?>
                      ...
                      <tr class="font-weight-bolder font-size-lg">
                        ...
                        </span><?= $row['id_klasifikasi'] ;?></td>
                        <td class="text-right pt-7"><?= $row['id_sub_klasifikasi'] ;?></td>
                        <td class="text-right pt-7"><?= $row['kualifikasi'] ;?></td>
                        <td class="pr-0 pt-7 font-size-h6 font-weight-boldest text-right">Rp. <?= number_format(($row['biaya']*1000), 2, '.', ',');?></td>
              ...
              <div class="col-md-7 pt-md-25">
                <div class="bg-primary rounded d-flex align-items-center justify-content-between text-white max-w-350px position-relative ml-auto p-7">
                  ...
                  <div class="text-right d-flex flex-column">
                    <span class="font-weight-boldest font-size-h3 line-height-sm">Rp.<?= number_format(($jumlah*1000), 2, '.', ',');?></span>
