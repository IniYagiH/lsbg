...
<hr>
  <section class="items">
    <div class="center">
FORMULIR REKOMENDASI HASIL EVALUASI/PENILAIAN KEMAMPUAN PENYEDIAAN PERALATAN BADAN USAHA KONSTRUKSI<br>
(FALT 03)
    </div>
  </section>
    <section class="items">
 ...
 <section class="items">
  ...
  <tr style="text-align:center; font-weight:bold;">
    ...
    <th colspan="2" style="background:#fce9c8;">Hasil Penilaian Kemampuan Penyediaan Peralatan</th>
    <th rowspan="2" style="padding:6px;">REKOMENDASI</th>
  </tr>
  <tr style="text-align:center; font-weight:bold;">
    <th style="background:#fce9c8;">Hasil Penilaian</th>
    <th style="background:#fce9c8;">Persyaratan</th>
  </tr>

  <tr>
    <td style="text-align:center;">1</td>
    <td style="background:#fce9c8;">	Jumlah Peralatan</td>
    <td style="text-align:center;"><?=$data_hasil1;?></td>
    <td style="text-align:center;"><?=$data_persyaratan1;?></td>
    <td style="text-align:center;"><?php if($data_rekomendasi1=='1'){echo "Sesuai";}else{echo "Tidak Sesuai";};?></td>
  </tr>
 <?php $count=2 ;?>
  ...
  <tr>
    ...
    <td> Peralatan –><?=$count-1?>,  Jenis, Milik/Sewa, Noreg SIMPK</td>
    <td style="text-align:center;"><?=${'data_hasil'.$id_peralatan} ;?></td>
    <td style="text-align:center;"><?=${'data_persyaratan'.$id_peralatan} ;?></td>
    <td style="text-align:center;"><?php if(${'data_rekomendasi'.$id_peralatan}=='1'){echo "Sesuai";}else{echo "Tidak Sesuai";};?></td>
  </tr>
  <?php $count+=1 ;?>
  <?php endforeach ;?>
 ...
 <section class="items">
  ...
  <div class="row">
    ...
    <div class="col-1-60-table" style="border: 1px solid black;">
      <div class="left">
        <strong><?=$catatan_falt03[0]['catatan'];?></strong>
      </div>
    </div>
