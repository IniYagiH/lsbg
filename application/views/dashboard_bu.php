      ...
      <div class="col-xl-4">
        <div class="card card-custom bgi-no-repeat gutter-b" style="height: 175px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(<?= base_url(); ?>assets/media/svg/patterns/taieri.svg)">
          ...
          <div class="card-body d-flex align-items-center">
            <div>
              <h3 class="text-white font-weight-bolder line-height-lg mb-5">Import Data SIKI
              <br /></h3>
              <a href='<?= base_url('dashboard_bu/import') ;?>' class="btn btn-success font-weight-bold px-6 py-3">Import Data</a>
            </div>
          </div>
          <!--end::Body-->
        </div>
          ...
          <div class="card card-custom card-stretch">
            ...
            <div class="card-body px-5">
              ...
              <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                ...
                <div class="navi-item my-2">
                  <a href="#" class="navi-link active">
                    ...
                    <span class="navi-label">
                      <span class="label label-rounded label-light-success font-weight-bolder"><?php if(!empty($jumlah)){echo $jumlah[0]['jumlah'];}else{echo"0";}  ?></span>
                    </span>
                  </a>
                </div>
                <!--end::Item-->
                ...
                <!--begin::Item-->
                <div class="navi-item my-2">
                  <a href="<?= base_url('dashboard_bu/message_bu') ;?>" class="navi-link">
                    <span class="navi-icon mr-4">
                      <i class="fa fa-genderless text-danger"></i>
                    </span>
                    <span class="navi-text">Message</span>
                    <span class="navi-label">
                      <span class="label label-rounded label-light-danger font-weight-bolder"><?php if(!empty($jumlah_message)){echo $jumlah_message[0]['jumlah'];}else{echo"0";}  ?></span>
                    </span>
                  </a>
                </div>
                <!--end::Item-->
            ...
            <div class="card-header row row-marginless align-items-center flex-wrap py-5 h-auto">
              ...
              <div class="col-12 col-sm-6 col-xxl-4 order-2 order-xxl-3 d-flex align-items-center justify-content-sm-end text-right my-2">
                ...
                <div class="d-flex align-items-center mr-2" data-toggle="tooltip" title="Records per page">
                  <span class="text-muted font-weight-bold mr-2" data-toggle="dropdown"><?=$start.'-'.number_format($start+10) ;?> of <?php if(!empty($jumlah)){echo $jumlah[0]['jumlah'];}else{echo"0";}  ?></span>
                  ...
                  <div class="d-flex align-items-start list-item card-spacer-x py-3" data-inbox="message">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="d-flex align-items-center flex-wrap w-xxl-200px mr-3" data-toggle="view">
                        <?php if($row['id_upload']==9  OR $row['id_upload']==11 OR $row['id_upload']==13 OR $row['id_upload']==37 OR $row['id_upload']==39):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/administrasi_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==32 OR $row['id_upload']==34 OR $row['id_upload']==35 OR $row['id_upload']==36):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/pengalaman_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==14 OR $row['id_upload']==15 OR $row['id_upload']==16 OR $row['id_upload']==17 OR $row['id_upload']==18):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/pengurus_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==23 OR $row['id_upload']==24 OR $row['id_upload']==25 OR $row['id_upload']==26 OR $row['id_upload']==27 OR $row['id_upload']==28 OR $row['id_upload']==29 OR $row['id_upload']==30):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/tk_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==1 OR $row['id_upload']==2 OR $row['id_upload']==3 OR $row['id_upload']==4 OR $row['id_upload']==5 OR $row['id_upload']==12 OR $row['id_upload']==10):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/klasifikasi_kualifikasi_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==20 OR $row['id_upload']==21 OR $row['id_upload']==57):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/neraca_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==7 OR $row['id_upload']==55):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/akte_pendirian_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==8 OR $row['id_upload']==56):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/akte_perubahan_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==41):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/pemegang_saham_bu/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==22):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/pph_omset_bu/').encrypt_url($row['id_record']) ;?>">

                        <?php elseif($row['id_upload']==58):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/peralatan/').encrypt_url($row['id_record']) ;?>">
                        <?php elseif($row['id_upload']==49):?>
                          <a style="color: #363636" href="<?php echo base_url('inbox/bukti_pembayaran/').encrypt_url($row['id_record']) ;?>">
                        <?php endif ;?>
                        <div class="symbol symbol-light-danger symbol-40 mr-3">
                          <span class="symbol-label font-weight-bolder">Revisi</span>
                        </div>
                        <span class="label label-dark label-inline mr-2">
                          <?php if($row['id_upload']==9 OR $row['id_upload']==11 OR $row['id_upload']==13 OR $row['id_upload']==37 OR $row['id_upload']==39){
                            echo "Administrasi";
                          }elseif($row['id_upload']==32 OR $row['id_upload']==34 OR $row['id_upload']==35 OR $row['id_upload']==36){
                            echo "Pengalaman";
                          }elseif($row['id_upload']==14 OR $row['id_upload']==15 OR $row['id_upload']==16 OR $row['id_upload']==17 OR $row['id_upload']==18){
                            echo "Pengurus";
                          }elseif($row['id_upload']==23 OR $row['id_upload']==24 OR $row['id_upload']==25 OR $row['id_upload']==26 OR $row['id_upload']==27 OR $row['id_upload']==28 OR $row['id_upload']==29 OR $row['id_upload']==30){
                            echo "Tenaga Kerja";
                          }elseif($row['id_upload']==1 OR $row['id_upload']==2 OR $row['id_upload']==3 OR $row['id_upload']==4 OR $row['id_upload']==5 OR $row['id_upload']==12 OR $row['id_upload']==10){
                            echo "Klasifikasi Dan Kualifikasi";
                          }elseif($row['id_upload']==20 OR $row['id_upload']==21 OR $row['id_upload']==57){
                            echo "Neraca";
                          }elseif($row['id_upload']==7 OR $row['id_upload']==55){
                            echo "Akte Pendirian";
                          }elseif($row['id_upload']==8 OR $row['id_upload']==56){
                            echo "Akte Perubahan";
                          }elseif($row['id_upload']==41){
                            echo "Pemegang Saham";
                          }elseif($row['id_upload']==22){
                            echo "PPH & Omset";
                          }elseif($row['id_upload']==49){
                            echo "Bukti Pembayaran";
                          }
                          elseif($row['id_upload']==58){
                            echo "Peralatan";
                          } ;?>
                          </span>
                    ...
                    <?php
                    $x = new DateTime($row['tgl_record']);
                    $y = new DateTime();

                    $perbedaan = $x->diff($y);

                    if($perbedaan->y!=0):?>
                      <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view"><?php echo $perbedaan->y.' years ago';?></div>

                    <?php elseif($perbedaan->m!=0):?>
                      <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view"><?php echo $perbedaan->m.' mounth ago';?></div>

                    <?php elseif($perbedaan->d!=0):?>
                      <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view"><?php echo $perbedaan->d.' days ago';?></div>

                    <?php elseif($perbedaan->h!=0):?>
                      <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view"><?php echo $perbedaan->h.' hours ago';?></div>

                    <?php elseif($perbedaan->i!=0):?>
                      <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view"><?php echo $perbedaan->i.' min ago';?></div>
                    <?php elseif($perbedaan->s!=0):?>
                      <div class="mt-2 mr-3 font-weight-bolder w-100px text-right" data-toggle="view"><?php echo $perbedaan->s.' sec ago';?></div>
