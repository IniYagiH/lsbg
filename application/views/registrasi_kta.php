				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?= base_url() ;?>assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>Sign Up</h3>
								<div class="text-muted font-weight-bold">Pendaftaran KTA</div>
							</div>
							<?php echo form_open_multipart('registrasi_kta/signup/', 'class="form text-center" id="kt_login_signup_form"');?>
							<div class="form-group mb-5">
								<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Nama Badan Usaha" id="nama" name="nama"/>
							</div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="NPWP"  id="npwp" name="npwp" />
								</div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Nama Penanggung Jawab Badan Usaha"  id="pjbu" name="pjbu" />
								</div>
	                    ...
	                    <option value="">Pilih Propinsi</option>
								...
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Fax"  id="fax" name="fax" />
								</div>
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8" type="text" placeholder="Kode Pos"  id="kodepos" name="kodepos" />
								</div>
								<div class="form-group mb-5">

									<select id="sub_klas" name="sub_klas"  class="form-control h-auto form-control-solid py-4 px-8" required="required">
	                    <option value="">Pilih Sub Klasifikasi</option>
											<?php foreach ($klasifikasi as $row2) :?>
												<option value="<?php echo $row2['id_sub_klasifikasi'] ;?>"><?php echo $row2['deskripsi_subklasifikasi'] ;?></option>
											<?php endforeach ;?>
	                </select>
								</div>
								...
								<div class="form-group mb-5">
									...
									<span class="help-block">
										File Foto PJBU: jpg Max file size 20Mb
									</span>
  		...
  		$(function () {
  			...
  			$("form#kt_login_signup_form").submit(function () {
  				...
  				var npwp_value=document.querySelector('#npwp').value;
					var pjbu_value=document.querySelector('#npwp').value;
					var alamat_value=document.querySelector('#alamat').value;
					var telepon_value=document.querySelector('#telepon').value;
					var fax_value=document.querySelector('#fax').value;
					var kodepos_value=document.querySelector('#kodepos').value;
												if(kodepos_value!='' && fax_value!='' && pjbu_value!='' && telepon_value!='' && alamat_value!='' && email_value!='' && npwp_value!='' && nama_value!=''){



  												// make sure there is file to upload
  												if (document.getElementById("file_ktp").files.length) {
