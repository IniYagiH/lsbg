			...
			<div class="d-flex align-items-center mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					...
					<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
						...
						<li class="breadcrumb-item text-muted">
							<a href="" class="text-muted">Asesor</a>
						</li>
			...
			<div class="card card-custom">
				<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label">Data Akun Asesor</h3>
					</div>
				...
				<div class="card card-custom gutter-b">
					<div class="card-header">
						<div class="card-title">
							...
							<h3 class="card-label">Tambah Data Akun Asesor</h3>
						</div>
					</div>

					<?php echo form_open_multipart('akun/insert_asesor/', 'class="form-horizontal form-validate-jquery" id="form-upload-1"');?>
						<div class="card-body">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="card card-custom gutter-b">
					...
					<?php echo form_open_multipart('akun/update_asesor/', 'class="form-horizontal form-validate-jquery" id="form-upload-1"');?>
					<div class="card-body">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="card card-custom gutter-b">
					...
					<?php echo form_open_multipart('akun/delete_asesor/', 'class="form-horizontal form-validate-jquery" id="form-upload-1"');?>
					<div class="card-body">
