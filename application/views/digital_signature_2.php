...
<html lang="en">
    ...
    <link href="<?=base_url('assets/css/pages/login/classic/login-4.css') ;?>" rel="stylesheet" type="text/css" />
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="<?=base_url('assets/sertifikat/GAPEKNAS_LOGO.png') ;?>" />
						...
						<div class="d-flex">
							...
							<div class="flex-grow-1">
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
									...
									<div class="mr-3">
										<!--begin::Name-->
										<a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">PT LSBU GAPEKNAS INFRASTRUKTUR
										</a>
										<!--end::Name-->
										<!--begin::Contacts-->
										<div class="d-flex flex-wrap my-2">
											...
											<span class="svg-icon svg-icon-md svg-icon-gray-500 mr-1">
												...
												<!--end::Svg Icon-->
											</span>Ruko Graha Mas Pemuda Blok AD No. 21 Jl. Pemuda, Rawamangun,
Jakarta Timur
</a>
						...
						<div class="card card-custom gutter-b">
							...
							<div class="card-body py-10">
								...
								<div class="form-group row my-2">
									<label class="col-4 col-form-label">Nama LSBU:</label>
									<div class="col-8">
									<span class="form-control-plaintext font-weight-bolder">LSBU GAPEKNAS</span>
										
									</div>
								</div>

								<div class="form-group row my-2">
									<label class="col-4 col-form-label">PIHAK PERTAMA:</label>
									<div class="col-8">
										
										<div class="d-flex">
											<!--begin::Pic-->
											<div class="flex-shrink-0 mr-7">
												<div class="symbol symbol-80 symbol-lg-120">
													<img alt="Pic" src="assets/media/ttd_g.jpeg" />
												</div>
											</div>
											<!--end::Pic-->
											<!--begin: Info-->
											...
											<div class="flex-grow-1">
												...
												<div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
													...
													<div class="mr-6">
														...
														<a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3">Ronald Togu, ST., MBA.,
