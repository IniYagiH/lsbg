...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="<?=base_url('assets/media/logos/logo_lsbu.png') ;?>" />
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(<?= base_url() ;?>assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" style="background-image: url(<?= base_url() ;?>assets/media/error/bg1.jpg);">
				...
				<p class="font-size-h3 text-muted font-weight-normal">FIle Tidak Ditemukan</p>
				<!--end::Content-->
			</div>
			<!--end::Error-->
		</div>
