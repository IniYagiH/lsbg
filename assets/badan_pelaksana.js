...
function get49(){
  var comment_value=document.getElementById('comment_49').value;
  var base_url=document.getElementById('base_url2').value;
  var option1_value='';
  var option2_value='';
  ...
  jQuery.ajax({
    ...
    data : {comment:comment_value,
      ...
      new PNotify({
          title: 'Success',
          text: 'Permintaan Bukti Pembayaran berhasil di kirim.',
          addclass: 'bg-primary'
      });
    },
...
function checkbox49(){
  var check = document.getElementById("checkbox_49");
  if(check.checked==false){
    document.querySelector('#comment_49').removeAttribute('disabled');
    document.querySelector('#get_49').removeAttribute('disabled');
  }else{
    document.querySelector('#comment_49').value='';
    document.querySelector('#comment_49').setAttribute('disabled','true');
    document.querySelector('#get_49').setAttribute('disabled','true');
  }
}
  ...
  function get13(){
    ...
    jQuery.ajax({
      url : base_url,
        ...
        new PNotify({
    				title: 'Success',
    				text: 'Revisi dan Comment berhasil di kirim.',
    				addclass: 'bg-primary'
    		});
  		},
  		error: function(xhr, status, error) {
  ...
  function get8(){
    ...
    var option1_value=document.getElementById('nomer').value;
    var option2_value=document.getElementById('tgl_akte').value;
    var asosiasi_value=document.getElementById('email_bu').value;
    jQuery.ajax({
      url : base_url,
      type : "POST",
  ...
  function get1(){
    ...
    var option1_value=document.getElementById('sub_klas').value;
    var option2_value='';
    var asosiasi_value=document.getElementById('email_bu').value;
    jQuery.ajax({
      url : base_url,
  ...
  function get26(){
    ...
    var option1_value=document.getElementById('noreg').value;
    var option2_value='';
    var asosiasi_value=document.getElementById('email_bu').value;
    jQuery.ajax({
      url : base_url,
